...
public interface Spliterator<T> {
    ...
    public final /* synthetic */ class Wrapper implements java.util.Spliterator {
        ...
        public static /* synthetic */ java.util.Spliterator convert(Spliterator spliterator) {
            ...
            if (spliterator instanceof M) {
                return ((M) spliterator).a;
            }
            return spliterator instanceof L ? K.a((L) spliterator) : new Wrapper();
        }
        ...
        public final /* synthetic */ void forEachRemaining(Consumer consumer) {
            Spliterator.this.forEachRemaining(j$.util.function.Consumer.VivifiedWrapper.convert(consumer));
        }
        ...
        public final /* synthetic */ boolean tryAdvance(Consumer consumer) {
            return Spliterator.this.a(j$.util.function.Consumer.VivifiedWrapper.convert(consumer));
        }
