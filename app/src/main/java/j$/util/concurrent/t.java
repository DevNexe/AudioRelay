...
final class t extends c implements Collection {
    ...
    public final boolean remove(Object obj) {
        AbstractC1464b abstractC1464b;
        if (obj == null) {
            return false;
        }
        Object it = iterator();
        do {
            abstractC1464b = (AbstractC1464b) it;
            if (!abstractC1464b.hasNext()) {
                return false;
            }
        } while (!obj.equals(((i) it).next()));
        abstractC1464b.remove();
        return true;
    }
    ...
    public final Spliterator spliterator() {
        ...
        m[] mVarArr = concurrentHashMap.a;
        int length = mVarArr == null ? 0 : mVarArr.length;
        return new k(mVarArr, length, 0, length, jL >= 0 ? jL : 0L, 1);
    }
