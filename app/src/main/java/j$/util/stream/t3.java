...
abstract class t3 {
    ...
    t3(Spliterator spliterator, long j, long j2, long j3, long j4) {
        this.c = spliterator;
        this.a = j;
        this.b = j2;
        this.d = j3;
    ...
    public /* bridge */ /* synthetic */ j$.util.C trySplit() {
        return (j$.util.C) m41trySplit();
    }

    /* JADX INFO: renamed from: trySplit, reason: collision with other method in class */
    public /* bridge */ /* synthetic */ j$.util.F m38trySplit() {
        return (j$.util.F) m41trySplit();
    }

    /* JADX INFO: renamed from: trySplit, reason: collision with other method in class */
    public /* bridge */ /* synthetic */ j$.util.I m39trySplit() {
        return (j$.util.I) m41trySplit();
    }

    /* JADX INFO: renamed from: trySplit, reason: collision with other method in class */
    public /* bridge */ /* synthetic */ j$.util.L m40trySplit() {
        return (j$.util.L) m41trySplit();
    }
            ...
            if (j2 >= jMin) {
                ...
                if (jMin < j3) {
                    ...
                    if (j4 < j2 || jEstimateSize > j3) {
                        this.d = jMin;
                        return f(spliteratorTrySplit, j2, j3, j4, jMin);
                    }
                    this.d = jMin;
