...
public final class PurchaserInfo$nonSubscriptionTransactions$2 extends cx1 implements h81<List<? extends Transaction>> {
    ...
    public final List<? extends Transaction> invoke() throws JSONException {
        ...
        return wu.Z0(arrayList, new Comparator() { // from class: com.revenuecat.purchases.PurchaserInfo$nonSubscriptionTransactions$2$invoke$$inlined$sortedBy$1
