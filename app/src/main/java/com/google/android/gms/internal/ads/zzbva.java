...
public final class zzbva {
    ...
    public zzbva(JSONObject jSONObject) throws JSONException {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            try {
                zzbuz zzbuzVar = new zzbuz(jSONArray.getJSONObject(i2));
        ...
        this.zzb = zzbvb.zza(jSONObjectOptJSONObject, "click_urls");
        com.google.android.gms.ads.internal.zzt.zzg();
        this.zzc = zzbvb.zza(jSONObjectOptJSONObject, "imp_urls");
        com.google.android.gms.ads.internal.zzt.zzg();
        this.zzd = zzbvb.zza(jSONObjectOptJSONObject, "downloaded_imp_urls");
        com.google.android.gms.ads.internal.zzt.zzg();
        this.zze = zzbvb.zza(jSONObjectOptJSONObject, "nofill_urls");
        com.google.android.gms.ads.internal.zzt.zzg();
        this.zzf = zzbvb.zza(jSONObjectOptJSONObject, "remote_ping_urls");
        jSONObjectOptJSONObject.optBoolean("render_in_browser", false);
        jSONObjectOptJSONObject.optLong("refresh", -1L);
        zzccc zzcccVarZza = zzccc.zza(jSONObjectOptJSONObject.optJSONArray("rewards"));
        if (zzcccVarZza == null) {
            this.zzh = null;
        } else {
            this.zzh = zzcccVarZza.zza;
        }
