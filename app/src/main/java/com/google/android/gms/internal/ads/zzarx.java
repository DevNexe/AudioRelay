...
public final class zzarx {
    public static final ClassLoader a = zzarx.class.getClassLoader();
    ...
    public static void zzc(Parcel parcel) {
        ...
        if (iDataAvail > 0) {
            throw new BadParcelableException(GM.a("Parcel data not fully consumed, unread size: ", iDataAvail));
        }
    }
