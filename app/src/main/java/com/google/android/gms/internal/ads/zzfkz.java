...
public final class zzfkz implements zzfkw {
    ...
    public final JSONObject zza(View view) {
        ...
        return zzfle.zza(iArr[0], iArr[1], width, height);
    }
        ...
        if (view instanceof ViewGroup) {
            ...
            if (!z) {
                for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                    zzfkvVar.zza(viewGroup.getChildAt(i2), this, jSONObject, z2);
                }
                return;
            }
            ...
            while (i4 < size) {
                ...
                while (true) {
                    i = i4 + 1;
                    if (i5 < size2) {
                        zzfkvVar.zza((View) arrayList3.get(i5), this, jSONObject, z2);
                        i5++;
                    }
                }
                i4 = i;
