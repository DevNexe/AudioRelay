...
public final class AdSize {
    ...
    public static AdSize getCurrentOrientationInterscrollerAdSize(Context context, int i) {
        return a(i, zzcgg.zza(context, 0));
    }
    ...
    public static AdSize getInlineAdaptiveBannerAdSize(int i, int i2) {
        ...
        adSize.e = true;
        if (i2 < 32) {
            zzcgn.zzj("The maximum height set for the inline adaptive ad size was " + i2 + " dp, which is below the minimum recommended value of 32 dp.");
        }
        return adSize;
    }

    public static AdSize getLandscapeAnchoredAdaptiveBannerAdSize(Context context, int i) {
        AdSize adSizeZzc = zzcgg.zzc(context, i, 50, 2);
        adSizeZzc.d = true;
        return adSizeZzc;
    }

    public static AdSize getLandscapeInlineAdaptiveBannerAdSize(Context context, int i) {
        int iZza = zzcgg.zza(context, 2);
        AdSize adSize = new AdSize(i, 0);
        if (iZza == -1) {
            return INVALID;
        }
    ...
    public static AdSize getPortraitInterscrollerAdSize(Context context, int i) {
        return a(i, zzcgg.zza(context, 1));
    }
    ...
    public AdSize(int i, int i2, String str) {
        if (i < 0 && i != -1 && i != -3) {
            throw new IllegalArgumentException(GM.a("Invalid width for AdSize: ", i));
        }
        if (i2 < 0 && i2 != -2 && i2 != -4) {
            throw new IllegalArgumentException(GM.a("Invalid height for AdSize: ", i2));
        }
        this.a = i;
        this.b = i2;
        this.c = str;
