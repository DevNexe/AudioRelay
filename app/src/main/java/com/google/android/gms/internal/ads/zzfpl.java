...
public final class zzfpl {
    ...
    public static PendingIntent zza(Context context, int i, Intent intent, int i2, int i3) {
        boolean z = true;
        zzfsf.zzf((i2 & 95) == 0, "Cannot set any dangerous parts of intent to be mutable.");
        zzfsf.zzf(intent.getComponent() != null, "Must set component on Intent.");
        if (a(0, 1)) {
            zzfsf.zzf(!a(i2, 67108864), "Cannot set mutability flags if PendingIntent.FLAG_IMMUTABLE is set.");
        } else {
