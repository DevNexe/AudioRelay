...
public final class zzeif implements zzgur {
    ...
    public final zzeie zzb() {
        zzcxx zzcxxVar = (zzcxx) this.a.zzb();
        zzehl zzehlVarZzb = ((zzehm) this.b).zzb();
        zzdda zzddaVar = (zzdda) this.c.zzb();
        ScheduledExecutorService scheduledExecutorService = (ScheduledExecutorService) this.d.zzb();
        zzfyy zzfyyVar = zzcha.zza;
        zzguz.zzb(zzfyyVar);
        return new zzeie(zzcxxVar, zzehlVarZzb, zzddaVar, scheduledExecutorService, zzfyyVar);
    }
}
