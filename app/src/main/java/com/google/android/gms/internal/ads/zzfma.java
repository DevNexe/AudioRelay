...
public final class zzfma {
    ...
    public static final byte[] d = {16, 57, 56, -18, 69, 55, -27, -98, -114, -25, -110, -10, 84, 80, 79, -72, 52, 111, -58, -77, 70, -48, -69, -60, 65, 95, -61, 57, -4, -4, -114, -63};
    public final byte[] a = d;
    public final byte[] b = c;

    public final boolean zza(File file) throws Throwable {
        try {
            X509Certificate[][] x509CertificateArrZza = zzajg.zza(file.getAbsolutePath());
