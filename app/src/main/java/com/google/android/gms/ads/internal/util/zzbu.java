...
public final class zzbu {
    public static final zzbt zza = new sy4((Object) null);
            ...
            if (objOpt != null) {
                if (objOpt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (objOpt2 == null) {
                            zzcgn.zzj("Expected JSONArray with at least 1 non-null element for key:".concat(String.valueOf(next)));
                            ...
                            zzcgn.zzj(String.format("JSONArray with unsupported type %s for key:%s", objOpt2.getClass().getCanonicalName(), next));
                        }
                    }
                } else if (objOpt instanceof JSONObject) {
                    bundle.putBundle(next, zza((JSONObject) objOpt));
                } else {
                    zzcgn.zzj("Unsupported type for key:".concat(String.valueOf(next)));
                }
            }
        }
        return bundle;
    ...
    public static String zzl(zzfcx zzfcxVar) {
        ...
        try {
            ...
            b(jsonWriter, zzfcxVar);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e) {
            zzcgn.zzh("Error when writing JSON.", e);
            return null;
        }
    }
}
