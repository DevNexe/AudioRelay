...
public final class zzfrj {
    public static final zzfqv a = new zzfqv("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (signatureArr.length) == 0) {
                    a.zze("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
                    for (Signature signature : signatureArr) {
                        String strZza = zzfri.zza(signature.toByteArray());
