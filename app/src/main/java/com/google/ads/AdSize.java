...
public final class AdSize {
    ...
    public static final AdSize SMART_BANNER = new AdSize(-1, -2, 0);
    public static final AdSize BANNER = new AdSize(320, 50, 0);
    public static final AdSize IAB_MRECT = new AdSize(RCHTTPStatusCodes.UNSUCCESSFUL, 250, 0);
    public static final AdSize IAB_BANNER = new AdSize(468, 60, 0);
    public static final AdSize IAB_LEADERBOARD = new AdSize(728, 90, 0);
    public static final AdSize IAB_WIDE_SKYSCRAPER = new AdSize(160, 600, 0);
