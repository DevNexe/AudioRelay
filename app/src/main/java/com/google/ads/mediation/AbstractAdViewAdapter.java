...
public abstract class AbstractAdViewAdapter implements MediationBannerAdapter, MediationNativeAdapter, OnImmersiveModeUpdatedListener, zzcoj, zzb {
    ...
    public void requestBannerAd(Context context, MediationBannerListener mediationBannerListener, Bundle bundle, AdSize adSize, MediationAdRequest mediationAdRequest, Bundle bundle2) {
        ...
        this.mAdView.setAdListener(new b36(this, mediationBannerListener));
    ...
    public void requestInterstitialAd(Context context, MediationInterstitialListener mediationInterstitialListener, Bundle bundle, MediationAdRequest mediationAdRequest, Bundle bundle2) {
        InterstitialAd.load(context, getAdUnitId(bundle), buildAdRequest(context, mediationAdRequest, bundle2, bundle), new QnHx(this, mediationInterstitialListener));
    }

    @Override // com.google.android.gms.ads.mediation.MediationNativeAdapter
    public void requestNativeAd(Context context, MediationNativeListener mediationNativeListener, Bundle bundle, NativeMediationAdRequest nativeMediationAdRequest, Bundle bundle2) {
        gg6 gg6Var = new gg6(this, mediationNativeListener);
        AdLoader.Builder builderWithAdListener = newAdLoader(context, bundle.getString("pubid")).withAdListener(gg6Var);
        ...
        if (nativeMediationAdRequest.isUnifiedNativeAdRequested()) {
            builderWithAdListener.forUnifiedNativeAd(gg6Var);
        }
        if (nativeMediationAdRequest.zzb()) {
            for (String str : nativeMediationAdRequest.zza().keySet()) {
                builderWithAdListener.forCustomTemplateAd(str, gg6Var, true != ((Boolean) nativeMediationAdRequest.zza().get(str)).booleanValue() ? null : gg6Var);
            }
        }
