...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public void calculateOffsets() {
        if (!this.mCustomViewPortEnabled) {
            ...
            if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
                ...
                float yOffset = xAxis.getYOffset() + xAxis.mLabelRotatedHeight;
            ...
            float extraRightOffset = getExtraRightOffset() + requiredWidthSpace2;
            float extraBottomOffset = getExtraBottomOffset() + f2;
            float extraLeftOffset = getExtraLeftOffset() + requiredWidthSpace;
    ...
    public void centerViewTo(float f, float f2, YAxis.AxisDependency axisDependency) {
        ...
        addViewportJob(MoveViewJob.getInstance(this.mViewPortHandler, f - ((getXAxis().mAxisRange / this.mViewPortHandler.getScaleX()) / 2.0f), (axisRange / 2.0f) + f2, getTransformer(axisDependency), this));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mLogEnabled) {
            ...
            this.drawCycles = j2;
            StringBuilder sbB = qc0.b("Drawtime: ", jCurrentTimeMillis2, " ms, average: ");
            sbB.append(j / j2);
            sbB.append(" ms, cycles: ");
            sbB.append(this.drawCycles);
            Log.i(Chart.LOG_TAG, sbB.toString());
        }
    }
