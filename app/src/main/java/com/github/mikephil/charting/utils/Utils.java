...
public abstract class Utils {
    ...
    private static final int[] POW_10 = {1, 10, 100, AdError.NETWORK_ERROR_CODE, 10000, 100000, UtilsKt.MICROS_MULTIPLIER, 10000000, 100000000, 1000000000};
    ...
    public static void velocityTrackerPointerUpCleanUpIfNecessary(MotionEvent motionEvent, VelocityTracker velocityTracker) {
        velocityTracker.computeCurrentVelocity(AdError.NETWORK_ERROR_CODE, mMaximumFlingVelocity);
