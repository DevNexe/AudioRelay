    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action == 1) {
                ...
                velocityTracker2.computeCurrentVelocity(AdError.NETWORK_ERROR_CODE, Utils.getMaximumFlingVelocity());
                ...
                } else if (i2 == 0 && Math.abs(ChartTouchListener.distance(motionEvent.getX(), this.mTouchStartPoint.x, motionEvent.getY(), this.mTouchStartPoint.y)) > this.mDragTriggerDist && ((BarLineChartBase) this.mChart).isDragEnabled()) {
