...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public float[] getMarkerPosition(Highlight highlight) {
        ...
        double d = f;
        float fCos = (float) ((Math.cos(Math.toRadians(this.mAnimator.getPhaseY() * ((this.mAbsoluteAngles[x] + rotationAngle) - f2))) * d) + ((double) centerCircleBox.x));
        float fSin = (float) ((Math.sin(Math.toRadians(this.mAnimator.getPhaseY() * ((rotationAngle + this.mAbsoluteAngles[x]) - f2))) * d) + ((double) centerCircleBox.y));
