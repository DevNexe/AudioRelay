...
public final class DefaultTrackSelector$Parameters implements Parcelable {
    ...
    public DefaultTrackSelector$Parameters(Parcel parcel) {
        ...
        this.A0E = C0695Iz.A0f(parcel);
        this.A00 = parcel.readInt();
        this.A0D = C0695Iz.A0f(parcel);
        this.A09 = C0695Iz.A0f(parcel);
        this.A0A = C0695Iz.A0f(parcel);
        this.A03 = parcel.readInt();
        this.A02 = parcel.readInt();
        this.A01 = parcel.readInt();
        this.A0C = C0695Iz.A0f(parcel);
        this.A0B = C0695Iz.A0f(parcel);
        this.A06 = parcel.readInt();
        this.A05 = parcel.readInt();
        this.A0F = C0695Iz.A0f(parcel);
    ...
    public DefaultTrackSelector$Parameters(SparseArray<Map<TrackGroupArray, DefaultTrackSelector$SelectionOverride>> sparseArray, SparseBooleanArray sparseBooleanArray, @Nullable String str, @Nullable String str2, boolean z, int i, boolean z2, boolean z3, boolean z4, int i2, int i3, int i4, boolean z5, boolean z6, int i5, int i6, boolean z7, int i7) {
        ...
        this.A07 = C0695Iz.A0L(str);
        this.A08 = C0695Iz.A0L(str2);
        this.A0E = z;
        this.A00 = i;
        this.A0D = z2;
        this.A09 = z3;
    ...
    public static void A01(Parcel parcel, SparseArray<Map<TrackGroupArray, DefaultTrackSelector$SelectionOverride>> sparseArray) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Iterator<Map.Entry<TrackGroupArray, DefaultTrackSelector$SelectionOverride>> it = mapValueAt.entrySet().iterator();
            while (true) {
                ...
                A0I[4] = "Yf5UDYoyCKDeBovWDXdmYX2icwRNMgWM";
                if (zHasNext) {
    ...
    public static boolean A04(Map<TrackGroupArray, DefaultTrackSelector$SelectionOverride> map, Map<TrackGroupArray, DefaultTrackSelector$SelectionOverride> map2) {
        ...
        for (Map.Entry<TrackGroupArray, DefaultTrackSelector$SelectionOverride> entry : map.entrySet()) {
            ...
            if (!map2.containsKey(key) || !C0695Iz.A0g(entry.getValue(), map2.get(key))) {
                return false;
            }
        }
        return true;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0695Iz.A0V(parcel, this.A0E);
        parcel.writeInt(this.A00);
        C0695Iz.A0V(parcel, this.A0D);
        C0695Iz.A0V(parcel, this.A09);
        C0695Iz.A0V(parcel, this.A0A);
        parcel.writeInt(this.A03);
        parcel.writeInt(this.A02);
        parcel.writeInt(this.A01);
        C0695Iz.A0V(parcel, this.A0C);
        C0695Iz.A0V(parcel, this.A0B);
        parcel.writeInt(this.A06);
        parcel.writeInt(this.A05);
        C0695Iz.A0V(parcel, this.A0F);
