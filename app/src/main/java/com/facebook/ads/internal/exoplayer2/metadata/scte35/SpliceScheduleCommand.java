...
import com.facebook.ads.redexgen.X.C0574Ec;
...
public final class SpliceScheduleCommand extends SpliceCommand {
    ...
    public static final Parcelable.Creator<SpliceScheduleCommand> CREATOR = new C0574Ec();
    ...
    public /* synthetic */ SpliceScheduleCommand(Parcel parcel, C0574Ec c0574Ec) {
        this(parcel);
    }
    ...
    public static SpliceScheduleCommand A00(C0679Ij c0679Ij) {
        int iA0E = c0679Ij.A0E();
        ArrayList arrayList = new ArrayList(iA0E);
        for (int i = 0; i < iA0E; i++) {
            arrayList.add(Ee.A02(c0679Ij));
