...
public final class Format implements Parcelable {
    ...
    public Format(Parcel parcel) {
        ...
        this.A0Q = C0695Iz.A0f(parcel) ? parcel.createByteArray() : null;
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (this.A04 == format.A04 && this.A09 == format.A09 && this.A0F == format.A0F && this.A08 == format.A08 && this.A01 == format.A01 && this.A0B == format.A0B && this.A02 == format.A02 && this.A0E == format.A0E && this.A05 == format.A05 && this.A0C == format.A0C && this.A0A == format.A0A && this.A06 == format.A06 && this.A07 == format.A07 && this.A0G == format.A0G && this.A0D == format.A0D && C0695Iz.A0g(this.A0M, format.A0M)) {
            String str = this.A0N;
            if (A0S[1].charAt(16) != 'L') {
                throw new RuntimeException();
            }
            A0S[6] = "OxllPOzEVfYZ4qffVVucen9spyCFBXaZ";
            if (C0695Iz.A0g(str, format.A0N) && this.A03 == format.A03 && C0695Iz.A0g(this.A0L, format.A0L) && C0695Iz.A0g(this.A0O, format.A0O) && C0695Iz.A0g(this.A0K, format.A0K)) {
                boolean zA0g = C0695Iz.A0g(this.A0H, format.A0H);
                if (A0S[3].length() == 2) {
                    A0S[1] = "3AW52F1sopS3WF7CLvtUPS7egIIfmwo6";
                    if (zA0g) {
                        if (!C0695Iz.A0g(this.A0I, format.A0I)) {
                        }
                    }
                } else if (zA0g) {
                    if (!C0695Iz.A0g(this.A0I, format.A0I) && C0695Iz.A0g(this.A0J, format.A0J) && Arrays.equals(this.A0Q, format.A0Q) && A0K(format)) {
                        return true;
                    }
                }
            }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0695Iz.A0V(parcel, this.A0Q != null);
        byte[] bArr = this.A0Q;
        if (bArr != null) {
