...
import com.facebook.ads.redexgen.X.C0572Ea;
...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public SpliceInsertCommand(long j, boolean z, boolean z2, boolean z3, boolean z4, long j2, long j3, List<C0572Ea> list, boolean z5, long j4, int i, int i2, int i3) {
        this.A06 = j;
        this.A0B = z;
        this.A09 = z2;
        this.A0A = z3;
    ...
    public SpliceInsertCommand(Parcel parcel) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(C0572Ea.A00(parcel));
        }
    ...
    public static SpliceInsertCommand A00(C0679Ij c0679Ij, long j, C0691Iv c0691Iv) {
        long jA0M = c0679Ij.A0M();
        boolean z = (c0679Ij.A0E() & 128) != 0;
        boolean z2 = false;
        ...
        if (!z) {
            ...
            if (autoReturn && !spliceImmediateFlag) {
                programSplicePts = TimeSignalCommand.A00(c0679Ij, j);
            }
            if (!autoReturn) {
                int iA0E4 = c0679Ij.A0E();
                listEmptyList = new ArrayList(iA0E4);
                for (int i = 0; i < iA0E4; i++) {
                    int iA0E5 = c0679Ij.A0E();
                    long jA00 = -9223372036854775807L;
                    if (!spliceImmediateFlag) {
                        jA00 = TimeSignalCommand.A00(c0679Ij, j);
                    }
                    long spliceEventId = jA00;
                    listEmptyList.add(new C0572Ea(iA0E5, spliceEventId, c0691Iv.A07(jA00), null));
                }
            }
            if (programSpliceFlag) {
                long jA0E = c0679Ij.A0E();
                z3 = (jA0E & 128) != 0;
                jA0M2 = (1000 * (((jA0E & 1) << 32) | c0679Ij.A0M())) / 90;
            }
            iA0I = c0679Ij.A0I();
            iA0E = c0679Ij.A0E();
            iA0E2 = c0679Ij.A0E();
        }
        return new SpliceInsertCommand(jA0M, z, z2, autoReturn, spliceImmediateFlag, programSplicePts, c0691Iv.A07(programSplicePts), listEmptyList, z3, jA0M2, iA0I, iA0E, iA0E2);
    }
