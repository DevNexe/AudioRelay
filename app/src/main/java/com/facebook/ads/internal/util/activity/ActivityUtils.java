...
import com.facebook.ads.redexgen.X.C04578z;
import com.facebook.ads.redexgen.X.C1074Xx;
    ...
    public static synchronized Activity A00() {
        ...
        for (Map.Entry<Activity, Integer> entry : A08.entrySet()) {
            if (entry.getValue().intValue() == 3) {
                Activity lastResumedActivity2 = entry.getKey();
        ...
        if (A02 != null && z && lastResumedActivity != activityA00) {
            AnonymousClass90 anonymousClass90 = new AnonymousClass90(A01(19, 23, 62), A01(203, 5, 20) + lastResumedActivity + A01(12, 7, 124) + activityA00);
            anonymousClass90.A03(1);
            A02.A06().A8y(A01(208, 8, 114), C04578z.A03, anonymousClass90);
        }
        return lastResumedActivity != null ? lastResumedActivity : activityA00;
    }

    public static void A03(@NonNull C1075Xy c1075Xy) {
        if (!JR.A19(c1075Xy) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        LO lo = new LO(c1075Xy);
        synchronized (A07) {
            A07.add(lo);
        }
        MM.A01.A01().postDelayed(lo, 2000L);
    }

    public static synchronized void A04(C1074Xx c1074Xx, Class<? extends Activity> cls) {
        A02 = c1074Xx;
        A01 = c1074Xx.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c1074Xx.A06().A8y(A01(208, 8, 114), C04578z.A02, new AnonymousClass90(A01(72, 80, 103)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c1074Xx);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c1074Xx.A06().A8y(A01(216, 3, 105), C04578z.A0d, new AnonymousClass90(A01(42, 30, 122)));
        }
    }
