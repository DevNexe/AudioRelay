...
public class AdView extends RelativeLayout implements Ad {
    ...
    public class QnHx implements AdViewParentApi {
        public QnHx() {
        }
    ...
    public AdView(Context context, String str, AdSize adSize) {
        super(context);
        QnHx qnHx = new QnHx();
        this.mAdViewParentApi = qnHx;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, adSize, qnHx, this);
    }
    ...
    public AdView(Context context, String str, String str2) {
        ...
        QnHx qnHx = new QnHx();
        this.mAdViewParentApi = qnHx;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, str2, qnHx, this);
    }
}
