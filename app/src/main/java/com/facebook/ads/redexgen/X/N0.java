...
public final class N0 {
    ...
    public static View A00(C1075Xy c1075Xy, Throwable th) {
        A03(c1075Xy, th);
        return new View(c1075Xy);
    }

    public static void A03(C1075Xy c1075Xy, Throwable th) {
        c1075Xy.A06().A8y(A01(85, 15, 44), C04578z.A1v, new AnonymousClass90(th));
