...
public final class AI extends SB {
    ...
    public AI(C2M c2m, int i, @Nullable List<C0847Pa> list, @Nullable C0895Qw c0895Qw, @Nullable Bundle bundle) {
        super(c2m, i, list, c0895Qw, bundle);
        c2m.A1j(this);
    ...
    public final void A0M(F9 f9, int i, int i2) {
        if (this.A0C.A27() != -1) {
            AbstractC0936Sl abstractC0936Sl = (AbstractC0936Sl) this.A0C.A1q(this.A0C.A27());
            if (A00[2].length() == 4) {
            ...
            if (abstractC0936Sl != null && abstractC0936Sl.A0i() && !abstractC0936Sl.A0h()) {
                abstractC0936Sl.A0f();
            }
            A01(i);
        }
    ...
    @Override // com.facebook.ads.redexgen.X.SB
    public final void A0a(AbstractC0936Sl abstractC0936Sl, boolean z) {
        A0Y(abstractC0936Sl, z);
        if (!z && abstractC0936Sl.A0h()) {
            abstractC0936Sl.A0e();
        }
    }
    ...
    public final void A0d(C0895Qw c0895Qw) {
        this.A04 = c0895Qw;
    }

    public final void A0e(List<C0847Pa> list) {
        this.A05 = list;
    }
}
