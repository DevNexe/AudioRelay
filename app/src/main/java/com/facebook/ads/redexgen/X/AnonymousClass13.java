...
public final class AnonymousClass13 {
    ...
    public static AnonymousClass11 A00(C1075Xy c1075Xy, JSONObject jSONObject, String str) {
        return A01(c1075Xy, jSONObject, str, false, -1, 0);
    }

    public static AnonymousClass11 A01(C1075Xy c1075Xy, JSONObject jSONObject, String str, boolean z, int i, int i2) {
        KA ka;
        ArrayList arrayList;
        ...
        C0751Lg.A02(c1075Xy, A02(0, 23, 77));
        String strOptString = jSONObject.optString(A02(409, 10, 21));
        int iOptInt = jSONObject.optInt(A02(116, 12, 73), 0);
        String strOptString2 = jSONObject.optString(A02(270, 13, 117));
        String encryptedCPM = C0766Lx.A02(jSONObject, A02(283, 12, 19));
        Uri uriA00 = TextUtils.isEmpty(encryptedCPM) ? null : C0745La.A00(encryptedCPM);
        String strA03 = C0766Lx.A02(jSONObject, A02(128, 4, 27));
        String strA01 = MC.A01(strA03);
        String adUntrimmedBodyText = A02(101, 15, 115);
        String strA04 = C0766Lx.A02(jSONObject, adUntrimmedBodyText);
        String adUntrimmedBodyText2 = A02(523, 5, 61);
        String requestId = C0766Lx.A02(jSONObject, adUntrimmedBodyText2);
        String adUntrimmedBodyText3 = A02(515, 8, 84);
        String adBodyText = C0766Lx.A02(jSONObject, adUntrimmedBodyText3);
        String adSubtitle = A02(295, 8, 64);
        String adSocialContext = C0766Lx.A02(jSONObject, adSubtitle);
        String adHeadline = A02(469, 14, 125);
        String adPlayTranslation = C0766Lx.A02(jSONObject, adHeadline);
        String adHeadline2 = A02(333, 16, 98);
        String strA05 = C0766Lx.A02(jSONObject, adHeadline2);
        String adHeadline3 = A02(483, 21, 5);
        String strA06 = C0766Lx.A02(jSONObject, adHeadline3);
        String adHeadline4 = A02(87, 14, 42);
        String strA07 = C0766Lx.A02(jSONObject, adHeadline4);
        String adTranslation = A02(389, 20, 112);
        String videoUrl = C0766Lx.A02(jSONObject, adTranslation);
        String adPromotedTranslation = A02(373, 16, 84);
        String strA08 = C0766Lx.A02(jSONObject, adPromotedTranslation);
        String adPromotedTranslation2 = A02(356, 17, 77);
        String strA09 = C0766Lx.A02(jSONObject, adPromotedTranslation2);
        String adPromotedTranslation3 = A02(132, 14, 22);
        String strA010 = C0766Lx.A02(jSONObject, adPromotedTranslation3);
        C1326dH c1326dHA01 = C1326dH.A01(jSONObject, c1075Xy);
        K5 k5A00 = K5.A00(jSONObject.optJSONObject(A02(303, 4, 93)));
        K5 k5A01 = K5.A00(jSONObject.optJSONObject(A02(307, 5, 116)));
        K6 k6A00 = K6.A00(jSONObject.optJSONObject(A02(504, 11, 93)));
        String strA011 = C0766Lx.A02(jSONObject, A02(528, 15, 77));
        ...
        int iOptInt3 = jSONObject.optInt(A02(419, 25, 38), 0);
        int iOptInt4 = jSONObject.optInt(A02(607, 31, 102), 0);
        int iOptInt5 = jSONObject.optInt(A02(638, 26, 67), AdError.NETWORK_ERROR_CODE);
        JSONObject adChoicesIconObject = jSONObject.optJSONObject(A02(53, 15, 6));
        K5 k5A02 = null;
        if (adChoicesIconObject != null) {
            k5A02 = K5.A00(adChoicesIconObject);
        }
        String strA012 = C0766Lx.A02(jSONObject, A02(68, 19, 17));
        EnumC02480h enumC02480hA00 = EnumC02480h.A00(jSONObject.optString(A02(312, 21, 91)));
        JSONArray jSONArray = null;
        try {
            jSONArray = new JSONArray(jSONObject.optString(A02(219, 17, 21)));
        } catch (JSONException e) {
            c1075Xy.A06().A8y(strA02, C04578z.A2B, new AnonymousClass90(e));
        }
        Collection<String> collectionA01 = C02500j.A01(jSONArray);
        String strA013 = C0766Lx.A02(jSONObject, A02(598, 9, 108));
        long jOptLong = jSONObject.optLong(A02(574, 24, 30), -1L);
        String strA014 = C0766Lx.A02(jSONObject, A02(565, 9, 56));
        ...
        String strA015 = A02(190, 29, 72);
        if (A01[7].charAt(29) != '9') {
            throw new RuntimeException();
        }
        A01[7] = "1dt4CnIt66xCnA4CbnpWbYAL0az2V9Kq";
        boolean zOptBoolean3 = jSONObject.optBoolean(strA015);
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
                ...
                for (int cardIndex = 0; cardIndex < length; cardIndex++) {
                    try {
                        arrayList.add(A01(c1075Xy, jSONArrayOptJSONArray.getJSONObject(cardIndex), str, true, cardIndex, length));
                    } catch (JSONException e2) {
                        e = e2;
                        arrayList2 = arrayList;
                        c1075Xy.A06().A8y(strA02, C04578z.A29, new AnonymousClass90(e));
                        Log.e(C1345da.A0C, A02(23, 30, 50), e);
                        return new AnonymousClass11(strA012, strA01, strA03, strA04, requestId, adBodyText, adSocialContext, adPlayTranslation, strA05, strA06, strA07, videoUrl, strA08, strA09, strA010, k5A02, c1326dHA01, k5A00, k5A01, k6A00, strA013, strA014, jOptLong, ka, z, i, i2, arrayList2, str, strOptString, iOptInt, strOptString2, uriA00, strA011, zOptBoolean, zOptBoolean2, iOptInt3, iOptInt2, iOptInt4, iOptInt5, enumC02480hA00, collectionA01, iOptInt6, zOptBoolean3);
                    }
                }
            } else {
                arrayList = null;
