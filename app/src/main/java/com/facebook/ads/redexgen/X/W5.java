...
public final class W5 implements InterfaceC0554Di {
    ...
    public long A0B;
    public Format A0C;
    public InterfaceC0545Co A0D;
    public String A0E;
    public boolean A0F;
    public boolean A0G;
    public final String A0J;
    public final C0679Ij A0I = new C0679Ij(1024);
    public final C0678Ii A0H = new C0678Ii(this.A0I.A00);
    ...
    private int A00(C0678Ii c0678Ii) throws C0488Af {
        int iA01 = c0678Ii.A01();
        Pair<Integer, Integer> pairA02 = IO.A02(c0678Ii, true);
        this.A05 = ((Integer) pairA02.first).intValue();
        this.A02 = ((Integer) pairA02.second).intValue();
        return iA01 - c0678Ii.A01();
    }

    private int A01(C0678Ii c0678Ii) throws C0488Af {
        int iA04;
        int i = 0;
        if (this.A03 == 0) {
            do {
    ...
    public static long A02(C0678Ii c0678Ii) {
        return c0678Ii.A04((c0678Ii.A04(2) + 1) * 8);
    }
    ...
    private void A06(C0678Ii c0678Ii) throws C0488Af {
        if (!c0678Ii.A0F()) {
            this.A0G = true;
            A08(c0678Ii);
        } else if (!this.A0G) {
        ...
        if (this.A00 == 0) {
            if (this.A04 == 0) {
                A09(c0678Ii, A01(c0678Ii));
                if (this.A0F) {
                    c0678Ii.A08((int) this.A09);
                    return;
                }
                return;
            }
    ...
    private void A07(C0678Ii c0678Ii) {
        this.A03 = c0678Ii.A04(3);
        int i = this.A03;
        if (i == 0) {
            c0678Ii.A08(8);
            return;
    ...
    private void A08(C0678Ii c0678Ii) throws C0488Af {
        boolean zA0F;
        int numProgram = c0678Ii.A04(1);
        int bitsRead = numProgram == 1 ? c0678Ii.A04(1) : 0;
        this.A00 = bitsRead;
        if (this.A00 == 0) {
            if (numProgram == 1) {
                A02(c0678Ii);
            ...
            if (c0678Ii.A0F()) {
                this.A04 = c0678Ii.A04(6);
                int iA04 = c0678Ii.A04(4);
                int iA05 = c0678Ii.A04(3);
                if (iA04 == 0 && iA05 == 0) {
                    if (numProgram == 0) {
                        int readBits = c0678Ii.A03();
                        int iA00 = A00(c0678Ii);
                        c0678Ii.A07(readBits);
                        int readBits2 = iA00 + 7;
                        byte[] initData = new byte[readBits2 / 8];
                        c0678Ii.A0D(initData, 0, iA00);
                        ...
                        int iA02 = (int) A02(c0678Ii);
                        int bitsRead2 = A00(c0678Ii);
                        c0678Ii.A08(iA02 - bitsRead2);
                    }
                    A07(c0678Ii);
                    this.A0F = c0678Ii.A0F();
                    this.A09 = 0L;
                    if (this.A0F) {
                        if (numProgram == 1) {
                            this.A09 = A02(c0678Ii);
                        } else {
                            do {
                                zA0F = c0678Ii.A0F();
                                this.A09 = (this.A09 << 8) + ((long) c0678Ii.A04(8));
                            } while (zA0F);
                        }
                    }
                    if (c0678Ii.A0F()) {
    ...
    private void A09(C0678Ii c0678Ii, int i) {
        int iA03 = c0678Ii.A03();
        if ((iA03 & 7) == 0) {
            this.A0I.A0Y(iA03 >> 3);
        } else {
            c0678Ii.A0D(this.A0I.A00, 0, i * 8);
            this.A0I.A0Y(0);
        }
    ...
    public final void A48(C0679Ij c0679Ij) throws C0488Af {
        while (c0679Ij.A04() > 0) {
            int i = this.A08;
            if (i != 0) {
                if (i == 1) {
                    ...
                    if (i == 2) {
                        this.A06 = ((this.A07 & (-225)) << 8) | c0679Ij.A0E();
                        ...
                        int iMin = Math.min(c0679Ij.A04(), this.A06 - this.A01);
                        c0679Ij.A0c(this.A0H.A00, this.A01, iMin);
                        this.A01 += iMin;
    ...
    public final void A4V(InterfaceC0537Ce interfaceC0537Ce, C0568Dw c0568Dw) {
        c0568Dw.A05();
        this.A0D = interfaceC0537Ce.AFD(c0568Dw.A03(), 1);
        this.A0E = c0568Dw.A04();
    }
