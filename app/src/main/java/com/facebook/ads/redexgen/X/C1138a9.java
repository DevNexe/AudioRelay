...
public class C1138a9 implements AnonymousClass71 {
    ...
    public C1138a9(BluetoothDevice bluetoothDevice) {
    ...
    public final boolean A8S(Object obj) {
        C1138a9 c1138a9 = (C1138a9) obj;
        if (((this.A05 == null && c1138a9.A05 == null) || this.A05.equals(c1138a9.A05)) && this.A03 == c1138a9.A03 && this.A04 == c1138a9.A04 && this.A00 == c1138a9.A00) {
            int i = this.A01;
            ...
            strArr[5] = "lCz1bJjVX";
            strArr[0] = "UsNKRzwfX";
            if (i == c1138a9.A01 && this.A02 == c1138a9.A02) {
                return true;
            }
        }
        return false;
