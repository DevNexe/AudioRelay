...
public class C4a {
    ...
    public final AbstractC03524l A03(int i) {
        C4Z c4z = this.A00.get(i);
        if (c4z != null && !c4z.A03.isEmpty()) {
            ArrayList<AbstractC03524l> arrayList = c4z.A03;
            if (A02[4].charAt(1) != 'T') {
                throw new RuntimeException();
            }
    ...
    public final void A09(AbstractC03524l abstractC03524l) {
        ...
        ArrayList<AbstractC03524l> arrayList = A01(iA0H).A03;
