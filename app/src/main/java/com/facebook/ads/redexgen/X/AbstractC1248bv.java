...
public abstract class AbstractC1248bv extends C4W {
    ...
    public F9 A00;
    public Scroller A01;
    public final C4Y A02 = new C1249bw(this);
    ...
    @Nullable
    private final AbstractC03474g A05(C4T c4t) {
        return A0E(c4t);
    }
    ...
    private boolean A0A(@NonNull C4T c4t, int i, int i2) {
        AbstractC03474g abstractC03474gA05;
        if (!(c4t instanceof InterfaceC03464f) || (abstractC03474gA05 = A05(c4t)) == null) {
            return false;
        }
        ...
        abstractC03474gA05.A0A(iA0C);
        c4t.A1L(abstractC03474gA05);
        return true;
    }
