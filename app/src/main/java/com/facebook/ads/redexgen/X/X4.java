...
public final class X4 implements BL {
    ...
    public final float A00(float f) {
        float fA00 = C0695Iz.A00(f, 0.1f, 8.0f);
        if (this.A00 != fA00) {
            this.A00 = fA00;
            this.A08 = null;
        }
    ...
    public final long A02(long j) {
        ...
        if (j2 >= 1024) {
            ...
            int i2 = this.A05;
            if (i == i2) {
                return C0695Iz.A0F(j, this.A06, j2);
            }
            return C0695Iz.A0F(j, this.A06 * ((long) i), j2 * ((long) i2));
        }
    ...
    public final boolean A8R() {
        C0524Bq c0524Bq;
        return this.A0C && ((c0524Bq = this.A08) == null || c0524Bq.A0H() == 0);
    }
    ...
    public final void flush() {
        if (A8N()) {
            C0524Bq c0524Bq = this.A08;
            if (c0524Bq == null) {
                this.A08 = new C0524Bq(this.A05, this.A02, this.A01, this.A00, this.A03);
            } else {
                c0524Bq.A0I();
            }
        }
