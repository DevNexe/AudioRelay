...
public final class C2D {
    ...
    public static Map<String, String> A05(@Nullable String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C04578z.A27, new AnonymousClass90(A02(239, 20, 101)));
                return null;
            }
            if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C04578z.A24, new AnonymousClass90(A02(221, 18, 10)));
                return null;
            }
            return map;
        } catch (JSONException e) {
            A08(C04578z.A26, new AnonymousClass90(e));
            return null;
        }
    }
    ...
    public static void A08(int i, AnonymousClass90 anonymousClass90) {
        ...
        if (c1074XxA00 != null) {
            c1074XxA00.A06().A8y(A02(687, 9, 5), i, anonymousClass90);
        }
    }
    ...
    public final C2H A0A() {
        C2H c2h = new C2H(A00());
        try {
            Iterator<C2H> it = A04(A03(A02(503, 15, 30), A02(0, 0, 94))).iterator();
            while (it.hasNext()) {
                c2h.A06(it.next());
            }
        } catch (JSONException e) {
            A07();
            A08(C04578z.A25, new AnonymousClass90(e));
        }
        return c2h;
    }
    ...
    public final C2H A0B() {
        ...
        try {
            ...
            A07();
            A08(C04578z.A28, new AnonymousClass90(e));
        }
        return c2h;
    }
    ...
    public final String A0J() {
        return A03(A02(540, 21, 23), A02(RCHTTPStatusCodes.SUCCESS, 21, 91));
    }
