...
public final class C1339dU implements InterfaceC02490i {
    ...
    public C1339dU(String str, String str2, EnumC02480h enumC02480h, Collection<String> detectionStrings, Map<String, String> metadata, String str3, String str4, @Nullable String str5) {
        this.A04 = str;
        this.A01 = str2;
        this.A00 = enumC02480h;
    ...
    @Nullable
    public static C1339dU A00(JSONObject jSONObject) {
        JSONArray jSONArray;
        if (jSONObject == null) {
            return null;
        }
        ...
        String strA02 = C0766Lx.A02(jSONObject, markup3);
        String markup4 = A01(50, 21, 57);
        EnumC02480h enumC02480hA00 = EnumC02480h.A00(jSONObject.optString(markup4));
        try {
        ...
        return new C1339dU(strOptString, activationCommand, enumC02480hA00, collectionA01, map, encryptedCPM, strA02, C0766Lx.A02(jSONObject, A01(37, 13, 95)));
    }
