...
public final class NA extends LinearLayout {
    ...
    public NA(C1075Xy c1075Xy, int i) {
        super(c1075Xy);
        this.A01 = false;
        ...
        setOrientation(0);
        this.A03 = new LinearLayout(c1075Xy);
        this.A00 = i;
        A00();
    }
    ...
    public void setToolbarActionMode(int i) {
        ...
        setVisibility(0);
        if (i == 0) {
            enumC0769Ma = EnumC0769Ma.CROSS;
        } else if (i == 1) {
            enumC0769Ma = EnumC0769Ma.SKIP_ARROW;
        } else if (i == 3) {
            enumC0769Ma = EnumC0769Ma.MINIMIZE_ARROW;
        } else if (i != 4) {
            enumC0769Ma = EnumC0769Ma.CROSS;
        } else {
            enumC0769Ma = EnumC0769Ma.CROSS;
        ...
        this.A02.setImageBitmap(C0770Mb.A01(enumC0769Ma));
        MS.A0G(AdError.LOAD_TOO_FREQUENTLY_ERROR_CODE, this.A02);
    }
