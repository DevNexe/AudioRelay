...
public final class OE extends Drawable {
    ...
    @Nullable
    public WeakReference<C0895Qw> A07;
    public boolean A08;
    ...
    public static void A04() {
        A0G = new byte[]{65, 73, 21, 42, 38, 52, 121, 99, 24, 87, 94, 24, 81, 93, 49, 18, 28, 25, 24, 25, 93, 117, 109, 114, 114, 109, 115, 55, 21, 6, 16, 84, 86, 113, 118, 107, 118, 126, 115, 118, 101, 118, 113, 120, 49, 49, 49, 60, 11, 4, 79, 68, 127, 122, 127, 126, 102, 127, 108, 83, 95, 77, 91, 88, 83, 86, 83, 78, 67, 26, 121, 82, 95, 89, 81, 95, 72, 26, 84, 85, 78, 26, 73, 95, 78, 32, 104, 48, 125, 51, 96, 33, 39, 47};
    }
    ...
    public void A03() {
        ...
        WeakReference<C0895Qw> weakReference = this.A07;
    ...
    public final void A0A(C0895Qw c0895Qw) {
        this.A07 = new WeakReference<>(c0895Qw);
        A03();
    }
