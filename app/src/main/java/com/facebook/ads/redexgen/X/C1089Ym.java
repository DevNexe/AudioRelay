...
public class C1089Ym implements AnonymousClass72<String> {
    ...
    public C1089Ym(Context context, String str, EnumC04096r enumC04096r) {
        this.A00 = str;
        this.A01 = A03(context, str, enumC04096r);
    }
    ...
    @Nullable
    public static String A03(Context context, String str, EnumC04096r enumC04096r) {
        int i = C04086q.A00[enumC04096r.ordinal()];
        if (i == 1) {
    ...
    public final boolean A8S(Object obj) {
        String str;
        String str2;
        C1089Ym c1089Ym = (C1089Ym) obj;
        boolean zEquals = this.A00 == null && c1089Ym.A00 == null;
        boolean zEquals2 = this.A01 == null && c1089Ym.A01 == null;
        String str3 = this.A00;
        if (str3 != null && (str2 = c1089Ym.A00) != null) {
            zEquals = str3.equals(str2);
        }
        String str4 = this.A01;
        if (str4 != null && (str = c1089Ym.A01) != null) {
