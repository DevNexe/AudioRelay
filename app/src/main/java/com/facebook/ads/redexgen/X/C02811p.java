...
public final class C02811p {
    ...
    public C02811p(String str, KM km, AdPlacementType adPlacementType, KK kk, int i) {
        this(str, km, adPlacementType, kk, i, EnumSet.of(CacheFlag.NONE));
    }

    public C02811p(String str, KM km, AdPlacementType adPlacementType, KK kk, int i, @Nullable EnumSet<CacheFlag> enumSet) {
        this.A09 = str;
    ...
    public final C0728Kh A01(C1075Xy c1075Xy, KR kr, @Nullable AdExperienceType adExperienceType) {
        M4 m4;
        String adTypeString;
        String str = this.A09;
        KK kk = this.A07;
        ...
        C0728Kh c0728Kh = new C0728Kh(c1075Xy, str, m4, km, adTypeString, this.A0B, AdSettings.isTestMode(c1075Xy), AdSettings.isMixedAudience(), kr, MA.A01(JR.A0H(c1075Xy)), this.A04, adExperienceType != null ? adExperienceType.getAdExperienceType() : null);
        String[] strArr = A0D;
    ...
    public final void A05(@Nullable EnumC0721Jz enumC0721Jz) {
        this.A03 = enumC0721Jz;
    }
