...
public class RunnableC0599Ff implements Runnable {
    ...
    public RunnableC0599Ff(C0605Fl c0605Fl, InterfaceC0608Fo interfaceC0608Fo, C0606Fm c0606Fm, C0607Fn c0607Fn) {
        this.A00 = c0605Fl;
