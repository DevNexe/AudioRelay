...
public final class C1386eL {
    ...
    @Nullable
    public InterfaceC1390eP A00;
    public boolean A01;
    public final Rect A02;
    public final Rect A03;
    public final Handler A04;
    public final SA A05;
    public final InterfaceC1397eW A06;
    public final C1388eN A07;
    public final GL A08;
    ...
    public C1386eL(InterfaceC1397eW interfaceC1397eW, SA sa, GL gl, C1388eN c1388eN, Handler handler) {
        this(interfaceC1397eW, sa, gl, c1388eN, handler, 100);
    }

    public C1386eL(InterfaceC1397eW interfaceC1397eW, SA sa, GL gl, C1388eN c1388eN, Handler handler, int i) {
        this.A03 = new Rect();
        this.A02 = new Rect();
        this.A0B = new ArrayList();
        this.A0A = new ArrayList();
        this.A01 = false;
        this.A06 = interfaceC1397eW;
        this.A05 = sa;
        this.A08 = gl;
        this.A07 = c1388eN;
        this.A04 = handler;
        this.A09 = new RunnableC1387eM(this, i);
    }
    ...
    public void A06(long j) {
        ...
        if (this.A0B.isEmpty()) {
            ...
            for (View view : this.A0B) {
                C1395eU c1395eUA00 = this.A07.A00(view);
                for (Rect rect : this.A0A) {
                    Rect rect2 = this.A03;
                    Rect containerRect = this.A02;
                    if (C1379eE.A00(view, rect2, containerRect, rect) && c1395eUA00 != C1395eU.A06) {
                        GL gl = this.A08;
                        Rect rect3 = this.A03;
                        Rect rect4 = this.A02;
    ...
    public final void A0B(@Nullable InterfaceC1392eR interfaceC1392eR) {
        this.A08.AEk(interfaceC1392eR);
    }

    public final void A0C(@Nullable InterfaceC1390eP interfaceC1390eP) {
        this.A00 = interfaceC1390eP;
    }
}
