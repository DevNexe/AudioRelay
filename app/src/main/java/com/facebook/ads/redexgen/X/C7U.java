...
public final class C7U {
    ...
    public C7U(C8U c8u) {
        ...
        this.A08 = JR.A1y(c8u);
        this.A09 = JR.A26(c8u, C0879Qg.A03());
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [com.facebook.ads.redexgen.X.07] */
    public static synchronized AnonymousClass00 A03(C1074Xx c1074Xx) {
        if (A0A == null) {
            A0A = AnonymousClass01.A00(c1074Xx, new Object() { // from class: com.facebook.ads.redexgen.X.07
                public int A00;
                public int A01;
                public boolean A02;
                public boolean A03;
            ...
            }.A00(JR.A04(c1074Xx)).A02(c1074Xx.A03().A8P()).A01(-1).A03(JR.A0j(c1074Xx)).A04(JR.A25(c1074Xx)).A05(), A05(c1074Xx));
        }
        return A0A;
    }
    ...
    public static C0L A05(C1074Xx c1074Xx) {
        return new Y1(c1074Xx);
    }
    ...
    public static void A0H(C8U c8u, String str) {
        ...
        if (C7X.A06(c8u) && !TextUtils.isEmpty(str) && (c7w = A0G.get(str)) != null) {
            ...
            C1074Xx c1074XxA00 = c8u.A00();
            C0883Qk c0883QkA05 = C0883Qk.A05(c1074XxA00);
            String cacheKey = C0883Qk.A08(c1074XxA00, C0745La.A00(str));
            if (cacheKey == null) {
                cacheKey = str;
            }
            C7X.A04(c8u, c7w, c0883QkA05.A0H(cacheKey));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0I(EnumC0710Jo enumC0710Jo) {
        if (this.A01 == null) {
            return;
        }
        HashMap map = new HashMap();
        map.put(A08(173, 12, 111), MJ.A04(this.A00));
        this.A01.A02(enumC0710Jo, map);
    }

    public static void A0J(List<String> list, C8U c8u) {
        A0K(list, C1372e2.A01(c8u));
    ...
    public final void A0d(C0711Jp c0711Jp) {
        this.A01 = c0711Jp;
    }
}
