...
public final class C1072Xv extends C8h {
    ...
    static {
        ...
        A03 = new C8b[]{A02, A01};
        A07 = C1072Xv.class.getSimpleName();
        C8b[] c8bArr = A03;
        String strA00 = A00(178, 6, 0);
        A05 = C8h.A02(strA00, c8bArr);
        A06 = C8h.A03(strA00, A03, A01);
        A04 = A00(5, 71, 76) + A02.A01 + A00(0, 3, 23) + A00(159, 6, 101) + A00(4, 1, 53) + C1073Xw.A09.A01 + A00(3, 1, 86);
    }

    public C1072Xv(C04398d c04398d) {
        super(c04398d);
    }
    ...
    public final void A0D(C1074Xx c1074Xx) {
        try {
            A05().execSQL(A04);
