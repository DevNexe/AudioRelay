...
public final class C1375e5 implements AnonymousClass03<Bitmap> {
    ...
    public final String A02 = C1375e5.class.getSimpleName();
    ...
    public C1375e5(int i, int i2, boolean z, boolean z2, boolean z3) {
        this.A01 = i;
        this.A00 = i2;
        this.A05 = z;
        this.A03 = z2;
    ...
    public final AnonymousClass02<Bitmap> A3A(File file, C0L c0l) {
        ...
        try {
            ...
            c0l.A8r(new C1369dz(A01(4, 14, 77)));
            return A00(null);
        } catch (Throwable th) {
            if (A07[6].length() == 26) {
                throw new RuntimeException();
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass03
    @SuppressLint({"CatchGeneralException"})
    public final void A4B(File file, C0L c0l) throws C1369dz {
        if (this.A03) {
            try {
                Bitmap bitmapA03 = C0M.A03(file.getCanonicalPath(), this.A01, this.A00, this.A05);
                if (bitmapA03 != null) {
                ...
                c0l.A92(th);
                throw new C1369dz(A01(18, 33, 49), th);
            }
        }
    }
}
