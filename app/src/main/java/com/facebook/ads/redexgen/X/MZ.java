...
public final class MZ {
    @TargetApi(18)
    public static Bitmap A00(C1075Xy c1075Xy, Bitmap bitmap, int i) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c1075Xy);
    ...
    @Nullable
    public static Bitmap A01(C1075Xy c1075Xy, Bitmap bitmap, int i, int i2) {
        ...
        try {
            Bitmap bitmapA00 = A00(c1075Xy, bitmapCreateBitmap, i);
            if (i2 != 1) {
            ...
            return new C0959Tj().A02(bitmapCreateBitmap, i);
        }
    }
}
