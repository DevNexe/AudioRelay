...
public final class WD implements InterfaceC0554Di {
    ...
    public InterfaceC0545Co A08;
    public InterfaceC0545Co A09;
    public String A0A;
    public boolean A0B;
    public boolean A0C;
    public final C0678Ii A0D;
    public final C0679Ij A0E;
    ...
    public WD(boolean z, String str) {
        this.A0D = new C0678Ii(new byte[7]);
        this.A0E = new C0679Ij(Arrays.copyOf(A0J, 10));
        A03();
        this.A0G = z;
        this.A0F = str;
    }

    private void A01() throws C0488Af {
        this.A0D.A07(0);
        if (!this.A0C) {
            ...
            byte[] bArrA07 = IO.A07(iA04, iA05, sampleRateIndex);
        ...
        InterfaceC0545Co interfaceC0545Co = this.A09;
        long j = this.A05;
        if (A0I[0].charAt(1) != 'g') {
            throw new RuntimeException();
        }
    ...
    private void A07(InterfaceC0545Co interfaceC0545Co, long j, int i, int i2) {
        this.A03 = 3;
        this.A00 = i;
        this.A07 = interfaceC0545Co;
        this.A04 = j;
        this.A02 = i2;
    }

    private void A08(C0679Ij c0679Ij) {
        byte[] bArr = c0679Ij.A00;
        int position = c0679Ij.A06();
        ...
        c0679Ij.A0Y(position);
    }

    private void A09(C0679Ij c0679Ij) {
        int iMin = Math.min(c0679Ij.A04(), this.A02 - this.A00);
    ...
    private boolean A0A(C0679Ij c0679Ij, byte[] bArr, int i) {
    ...
    public final void A48(C0679Ij c0679Ij) throws C0488Af {
        while (c0679Ij.A04() > 0) {
            ...
            if (i == 0) {
                ...
                if (i == 2) {
                    boolean zA0A = A0A(c0679Ij, this.A0D.A00, this.A0B ? 7 : 5);
                    if (A0I[0].charAt(1) == 'g') {
                        String[] strArr3 = A0I;
            ...
            } else if (A0A(c0679Ij, this.A0E.A00, 10)) {
                A02();
            }
        }
    }
    ...
    public final void A4V(InterfaceC0537Ce interfaceC0537Ce, C0568Dw c0568Dw) {
        c0568Dw.A05();
        this.A0A = c0568Dw.A04();
        this.A09 = interfaceC0537Ce.AFD(c0568Dw.A03(), 1);
        if (this.A0G) {
            c0568Dw.A05();
            this.A08 = interfaceC0537Ce.AFD(c0568Dw.A03(), 4);
            this.A08.A5V(Format.A0B(c0568Dw.A04(), A00(60, 15, 84), null, -1, null));
            return;
        }
        this.A08 = new C1043Ws();
    }
