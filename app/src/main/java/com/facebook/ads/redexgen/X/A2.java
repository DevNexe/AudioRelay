...
public final class A2 extends FrameLayout implements InterfaceC0786Mr, SW {
    ...
    public final C0711Jp A09;
    public final MF A0A;
    public final MK A0B;
    public final InterfaceC0785Mq A0C;
    public final NI A0D;
    ...
    @DoNotStrip
    public final AbstractC0894Qv A0G;
    public final C0895Qw A0H;
    ...
    public A2(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, InterfaceC0785Mq interfaceC0785Mq, AnonymousClass18 anonymousClass18, NI ni, @DynamicWebViewController$AdFormatType int i) {
        super(c1075Xy);
        this.A00 = new C0934Sj(this);
        this.A0G = new C0933Si(this);
        this.A03 = true;
        this.A07 = c1075Xy;
        this.A08 = interfaceC0703Jh;
        this.A0C = interfaceC0785Mq;
        this.A06 = anonymousClass18;
        this.A0D = ni;
        PA paA02 = PB.A02(anonymousClass18.A0Z());
        if (paA02 == null) {
            this.A0F = new PA(this.A07, anonymousClass18, interfaceC0703Jh, i);
            this.A04 = false;
        } else {
            this.A0F = paA02;
            this.A04 = true;
        ...
        this.A0F.A0c(new C0932Sh(this));
        MS.A0G(1003, this.A0F.A0O());
        if (this.A06.A0o()) {
            C1075Xy c1075Xy2 = this.A07;
            this.A0E = new P2(c1075Xy2, this.A08, this.A06, new C7U(c1075Xy2), this.A09, this.A0C, this.A0D, new C0931Sg(this));
            this.A0E.A0N();
            this.A0F.A0O().setOnTouchListener(new ViewOnTouchListenerC0845Oy(this));
            addView(this.A0E, new FrameLayout.LayoutParams(-1, -1));
        } else {
            this.A0E = null;
        }
        ViewGroup mediaView = getMediaView();
        this.A0H = new C0895Qw(mediaView, 1, new WeakReference(this.A0G), this.A07);
        ...
        if (JR.A1I(c1075Xy)) {
            c1075Xy.A09().AFR(mediaView, anonymousClass18.A0U(), false, false, true);
        }
        try {
            ...
            if (!zA0q) {
                if (C0746Lb.A05(anonymousClass18.A0X())) {
            ...
            preloadedDynamicWebViewController.A0M().A04(C04578z.A15, A0B(0, 26, 58));
        }
    }
    ...
    public final void A81() {
        ...
        new C0864Pr(this.A07, this.A0D, this.A06.A0a(), this.A0C).A05();
    }

    @Override // com.facebook.ads.redexgen.X.SW
    public final void A8h() {
        new Handler(Looper.getMainLooper()).post(new C0930Sf(this));
    }
    ...
    public final void AD2(String str) {
        ...
        LZ.A0E(new LZ(), this.A07, C0745La.A00(strA0b), this.A06.A0U());
    }
