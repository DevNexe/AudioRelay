...
public final class C0678Ii {
    ...
    public C0678Ii(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C0678Ii(byte[] bArr, int i) {
        this.A00 = bArr;
        this.A02 = i;
    }
    ...
    public final void A0A(int i, int firstByteReadSize) {
        ...
        bArr[i3] = (byte) (firstByteInputBits | ((i >>> (firstByteReadSize - iMin)) << i2));
        int i4 = firstByteReadSize - iMin;
        int i5 = i3 + 1;
        while (i4 > 8) {
