...
public final class C1B implements Serializable {
    ...
    public static C1B A00(JSONObject jSONObject) {
        ...
        C1D c1dA0I = new C1D().A0K(jSONObject.optString(A01(472, 9, 61))).A0H(jSONObject.optLong(A01(448, 24, 104), -1L)).A0F(iOptInt).A0E(jSONObject.optInt(A01(250, 18, 103), Integer.MAX_VALUE)).A0I(C1W.A01(jSONObject));
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A01(168, 5, 84));
        if (jSONObjectOptJSONObject != null) {
            C1D adMediaBuilder = c1dA0I.A0J(jSONObjectOptJSONObject.optString(A01(405, 3, 58)));
        ...
        c1b.A08(new C1M(C0766Lx.A04(jSONObject.optJSONArray(A01(123, 15, 103)))));
