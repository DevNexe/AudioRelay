...
public class ViewOnTouchListenerC02731h extends F9 implements View.OnTouchListener {
    ...
    public ViewOnTouchListenerC02731h(C1075Xy c1075Xy) {
        super(c1075Xy);
        this.A05 = 0;
        this.A00 = 0;
        this.A03 = true;
    ...
    public ViewOnTouchListenerC02731h(C1075Xy c1075Xy, AttributeSet attributeSet) {
    ...
    public ViewOnTouchListenerC02731h(C1075Xy c1075Xy, AttributeSet attributeSet, int i) {
    ...
    public void setLayoutManager(C4T c4t) {
        if (c4t instanceof C1263cB) {
            super.setLayoutManager(c4t);
            this.A01 = (C1263cB) c4t;
            return;
        }
