...
public final class C04156x {
    public final Map<Integer, C6H<C7A>> A00;

    @Nullable
    public static C04156x A02 = null;
    public static long A01 = 0;

    public C04156x(Map<Integer, C6H<C7A>> map) {
        this.A00 = map;
    }
    ...
    public static C04156x A01() {
        if (A02 == null) {
            A02 = new C04156x(Collections.synchronizedMap(new HashMap()));
        }
        return A02;
    }
