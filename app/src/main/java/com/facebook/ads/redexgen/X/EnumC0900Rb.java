...
public enum EnumC0900Rb {
    ...
    EnumC0900Rb(String str) {
        this.A00 = str;
    }

    public static EnumC0900Rb A00(String str) {
        for (EnumC0900Rb enumC0900Rb : valuesCustom()) {
            if (enumC0900Rb.A00.equals(str)) {
                return enumC0900Rb;
            }
        }
    ...
    public static EnumC0900Rb[] valuesCustom() {
        EnumC0900Rb[] enumC0900RbArr = (EnumC0900Rb[]) values().clone();
        String[] strArr = A02;
