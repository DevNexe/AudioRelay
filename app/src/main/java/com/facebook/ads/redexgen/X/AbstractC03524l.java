...
public abstract class AbstractC03524l {
    ...
    public int A00 = -1;
    public int A04 = -1;
    public AbstractC03524l A06 = null;
    public AbstractC03524l A07 = null;
    public List<Object> A0A = null;
    public List<Object> A0B = null;
    public int A0D = 0;
    public C03424b A0F = null;
    ...
    public AbstractC03524l(View view) {
        if (view != null) {
            this.A0H = view;
            return;
        }
    ...
    public final void A0X(C03424b c03424b, boolean z) {
        this.A0F = c03424b;
        this.A0G = z;
    }
    ...
    public final String toString() {
        String strA02;
        StringBuilder sb = new StringBuilder(A02(147, 11, 57) + Integer.toHexString(hashCode()) + A02(46, 10, 113) + this.A03 + A02(0, 4, 114) + this.A05 + A02(126, 9, 16) + this.A01 + A02(135, 8, 74) + this.A04);
        if (A0d()) {
