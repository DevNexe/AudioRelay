...
public final class KS extends ImageView implements Q7 {
    ...
    public final C0711Jp A03;
    public final AbstractC0724Kc A04;
    ...
    public KS(C1075Xy c1075Xy, C0711Jp c0711Jp) {
        super(c1075Xy);
        this.A04 = new AbstractC0724Kc() { // from class: com.facebook.ads.redexgen.X.7n
    ...
    private void A04() {
        setImageBitmap(C0770Mb.A01(EnumC0769Ma.SOUND_OFF));
    }

    private void A05() {
        setImageBitmap(C0770Mb.A01(EnumC0769Ma.SOUND_ON));
    }
