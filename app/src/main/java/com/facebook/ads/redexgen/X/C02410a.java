...
@RequiresApi(21)
public class C02410a extends C02440d {
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass37
    public final void A0F(View view, final InterfaceC03092s interfaceC03092s) {
        if (interfaceC03092s == null) {
            ...
            view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.facebook.ads.redexgen.X.36
                ...
                public final WindowInsets onApplyWindowInsets(View view2, WindowInsets windowInsets) {
                    return (WindowInsets) C3P.A01(interfaceC03092s.AA0(view2, C3P.A00(windowInsets)));
                }
            });
        }
    }
