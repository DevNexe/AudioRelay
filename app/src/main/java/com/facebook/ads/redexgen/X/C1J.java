...
public final class C1J {
    ...
    public static List<C1B> A01(JSONArray jSONArray, JSONObject jSONObject, C1075Xy c1075Xy, C1N c1n) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                c1075Xy.A06().A8y(A00(8, 7, 31), C04578z.A2A, new AnonymousClass90(e));
            }
        }
        return arrayList;
    }
