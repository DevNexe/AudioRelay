...
public final class MX implements Executor {
    ...
    public MX(String str, int i) {
        ...
        this.A01 = new ThreadPoolExecutor(Math.max(2, Math.min(iAvailableProcessors - 1, 4)), KEEP_ALIVE_SECONDS, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new MW(this, str));
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (MX.class) {
            ...
            if (size == oldThreshold) {
                ...
                if (c1074XxA00 != null) {
                    c1074XxA00.A06().A8y(A00(42, 7, 27), C04578z.A1c, new AnonymousClass90(A00(21, 21, 46), A00(14, 7, 25) + i));
                }
            }
        }
