...
public class C02982g<K, V> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C02982g) {
            C02982g c02982g = (C02982g) obj;
            if (size() != c02982g.size()) {
                return false;
            }
            int i = 0;
            while (true) {
                try {
                    ...
                    K kA09 = A09(i);
                    V vA0B = A0B(i);
                    Object obj2 = c02982g.get(kA09);
                    if (vA0B == null) {
                        if (obj2 == null && c02982g.containsKey(kA09)) {
                        }
                        return false;
                    }
                    if (!vA0B.equals(obj2)) {
