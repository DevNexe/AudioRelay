...
public final class DL {
    ...
    public static DK A01(byte[] bArr) {
        C0679Ij c0679Ij = new C0679Ij(bArr);
        if (c0679Ij.A07() < 32) {
            return null;
        }
        c0679Ij.A0Y(0);
        if (c0679Ij.A08() != c0679Ij.A04() + 4) {
            return null;
        }
        ...
        int atomType2 = c0679Ij.A08();
        int iA01 = D3.A01(atomType2);
        if (iA01 > 1) {
            Log.w(A02(0, 12, 31), A02(12, 26, 59) + iA01);
            return null;
        }
        UUID uuid = new UUID(c0679Ij.A0L(), c0679Ij.A0L());
        if (iA01 == 1) {
            c0679Ij.A0Z(c0679Ij.A0H() * 16);
        }
