...
public final class C03253j implements GU, RW {
    ...
    public final InterfaceC04458l A01;
    public final R2 A02;
    public final RX A03;
    public final C0904Rf A04;
    public final InterfaceC0905Rg A05;
    public final String A06;
    public final Map<RS, C0644Gy> A09 = new HashMap();
    public final Map<RS, C4L> A08 = new HashMap();
    public final List<InterfaceC0909Rk> A07 = new ArrayList();
    ...
    public C03253j(C8U c8u, InterfaceC04458l interfaceC04458l, R2 r2, String str, InterfaceC0905Rg interfaceC0905Rg, C0904Rf c0904Rf, RV rv) {
        this.A00 = c8u;
        this.A01 = interfaceC04458l;
        this.A02 = r2;
        this.A06 = str;
        this.A05 = interfaceC0905Rg;
        this.A04 = c0904Rf;
    ...
    private Set<InterfaceC0908Rj> A02(JSONObject responseObject) throws JSONException {
        ...
        for (final C0644Gy c0644Gy : this.A09.values()) {
            int i = C0907Ri.A01[EnumC0913Ro.A00(jSONObject.getString(c0644Gy.A6l().A03())).ordinal()];
            if (i == 1) {
                final JSONObject jSONObject3 = jSONObject2.getJSONObject(c0644Gy.A6l().A03()).getJSONObject(A01(312, 4, 17));
                final JSONObject jSONObjectOptJSONObject = jSONObject2.getJSONObject(c0644Gy.A6l().A03()).optJSONObject(A01(316, 11, 48));
                hashSet.add(new GQ(c0644Gy, jSONObject3, jSONObjectOptJSONObject) { // from class: com.facebook.ads.redexgen.X.3m
                    ...
                    {
                        EnumC0913Ro enumC0913Ro = EnumC0913Ro.A03;
                        this.A00 = jSONObject3;
                        this.A01 = jSONObjectOptJSONObject;
                    }

                    @Override // com.facebook.ads.redexgen.X.GQ, com.facebook.ads.redexgen.X.InterfaceC0908Rj
                    public final void A3O(Map<RR, EnumC0913Ro> map, Map<GV, EnumC0900Rb> map2) {
                        super.A00.A05(this.A00, this.A01);
                        super.A3O(map, map2);
                    }
                });
            } else if (i == 2) {
                hashSet.add(new GQ(c0644Gy) { // from class: com.facebook.ads.redexgen.X.3l
                    {
                        EnumC0913Ro enumC0913Ro = EnumC0913Ro.A04;
                    }
                });
            } else {
        ...
        for (final C4L c4l : this.A08.values()) {
            int i2 = C0907Ri.A00[EnumC0900Rb.A00(jSONObject.getString(c4l.A6l().A03())).ordinal()];
            if (i2 == 1) {
                hashSet.add(new GR(c4l) { // from class: com.facebook.ads.redexgen.X.45
                    {
                        EnumC0900Rb enumC0900Rb = EnumC0900Rb.A04;
                    }
                });
            } else if (i2 == 2) {
                hashSet.add(new GR(c4l) { // from class: com.facebook.ads.redexgen.X.3k
                    {
                        EnumC0900Rb enumC0900Rb = EnumC0900Rb.A05;
                    }

                    @Override // com.facebook.ads.redexgen.X.GR, com.facebook.ads.redexgen.X.InterfaceC0908Rj
                    public final void A3O(Map<RR, EnumC0913Ro> map, Map<GV, EnumC0900Rb> map2) {
                        this.A01.A06();
                        super.A3O(map, map2);
                    }
    ...
    private JSONObject A03(Map<RR, EnumC0912Rn> map, Map<GV, EnumC0899Ra> map2, Map<GV, JSONObject> map3, Map<GV, JSONObject> map4) throws JSONException {
        String strA01;
        JSONObject bundleData = new JSONObject();
        for (Map.Entry<RR, EnumC0912Rn> entry : map.entrySet()) {
            bundleData.put(entry.getKey().A6l().A03(), entry.getValue().A02());
        }
        for (Map.Entry<GV, EnumC0899Ra> entry2 : map2.entrySet()) {
            bundleData.put(entry2.getKey().A6l().A03(), entry2.getValue().A02());
        }
        JSONObject jSONObject = new JSONObject();
        Iterator<Map.Entry<RR, EnumC0912Rn>> it = map.entrySet().iterator();
        while (true) {
            ...
            Map.Entry<RR, EnumC0912Rn> next = it.next();
            if (next.getValue() == EnumC0912Rn.A04) {
    ...
    private void A04() throws Throwable {
        Map<RR, EnumC0912Rn> clientBundleRequests = new HashMap<>();
        Map<GV, EnumC0899Ra> clientBundleData = new HashMap<>();
        Map<GV, JSONObject> clientBundleFingerprint = new HashMap<>();
        Map<GV, JSONObject> map = new HashMap<>();
        synchronized (this) {
            for (RR rr : this.A09.values()) {
                if (rr.A8c()) {
                    clientBundleRequests.put(rr, EnumC0912Rn.A04);
                } else {
                    clientBundleRequests.put(rr, EnumC0912Rn.A03);
                }
            }
            ...
            for (C4L c4l : this.A08.values()) {
                if (c4l.A8c()) {
                    if (c4l.A07(atomicReference, atomicReference2)) {
                        clientBundleData.put(c4l, EnumC0899Ra.A05);
                        clientBundleFingerprint.put(c4l, atomicReference.get());
                    } else {
                        clientBundleData.put(c4l, EnumC0899Ra.A04);
                    }
                    map.put(c4l, atomicReference2.get());
                }
            }
            Iterator<InterfaceC0909Rk> it = this.A07.iterator();
            if (it.hasNext()) {
                it.next();
                throw new NullPointerException(A01(RCHTTPStatusCodes.NOT_FOUND, 22, 80));
            }
        }
    ...
    public final synchronized RR A4O(RS rs) {
        if (rs.A02() == RU.A03) {
            ...
            C0644Gy c0644Gy = new C0644Gy(rs);
            this.A09.put(rs, c0644Gy);
            Iterator<InterfaceC0909Rk> it = this.A07.iterator();
            if (it.hasNext()) {
                it.next();
    ...
    @Override // com.facebook.ads.redexgen.X.GU, com.facebook.ads.redexgen.X.InterfaceC04378a
