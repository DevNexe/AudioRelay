...
public class C1262cA extends AbstractC03474g {
    ...
    public C1262cA(Context context) {
    ...
    private final void A07(C03454e c03454e) {
        ...
        c03454e.A04((int) (this.A00 * 1.2f), (int) (this.A01 * 1.2f), (int) (A0L(10000) * 1.2f), this.A05);
    }

    @Override // com.facebook.ads.redexgen.X.AbstractC03474g
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC03474g
    public final void A0H(int i, int i2, C03494i c03494i, C03454e c03454e) {
        if (A06() == 0) {
            A09();
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC03474g
    public void A0I(View view, C03494i c03494i, C03454e c03454e) {
        int iA0O = A0O(view, A0K());
        int iA03 = A03(view, A00());
        int iA0M = A0M((int) Math.sqrt((iA0O * iA0O) + (iA03 * iA03)));
        if (iA0M > 0) {
            c03454e.A04(-iA0O, -iA03, iA0M, this.A04);
        }
    }
    ...
    public PointF A0P(int i) {
        Object objA08 = A08();
        if (objA08 instanceof InterfaceC03464f) {
            return ((InterfaceC03464f) objA08).A45(i);
        }
        Log.w(A04(0, 20, 70), A04(20, 93, 111) + InterfaceC03464f.class.getCanonicalName());
        return null;
    }
}
