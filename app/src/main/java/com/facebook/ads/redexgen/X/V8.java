...
public final class V8 implements HZ, I0<Object> {
    ...
    public final HY A07;
    public final IN A08;
    public final C0690Iu A09;

    public V8() {
        this(null, null, 1000000L, AdError.SERVER_ERROR_CODE, IN.A00);
    }

    public V8(@Nullable Handler handler, @Nullable HY hy, long j, int i, IN in) {
        this.A06 = handler;
        this.A07 = hy;
        this.A09 = new C0690Iu(i);
        this.A08 = in;
        this.A01 = j;
    }
    ...
    @Override // com.facebook.ads.redexgen.X.I0
    public final synchronized void ACb(Object obj, C0654Hi c0654Hi) {
        if (this.A00 == 0) {
