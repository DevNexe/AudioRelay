...
public final class C0713Jr {
    ...
    public static List<String> A02(C1075Xy c1075Xy, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                arrayList.add(jSONArray.getString(i));
            } catch (JSONException e) {
                c1075Xy.A06().A8y(A00(39, 17, 1), C04578z.A1C, new AnonymousClass90(e));
            }
        }
        return arrayList;
    }

    public static void A04(View view, C0711Jp c0711Jp, EnumC0710Jo enumC0710Jo) {
        view.addOnAttachStateChangeListener(new ViewOnAttachStateChangeListenerC0712Jq(c0711Jp, enumC0710Jo));
    }

    public static void A05(C1075Xy c1075Xy, String str, long j) {
        C0711Jp c0711Jp = new C0711Jp(str, c1075Xy.A08());
        HashMap map = new HashMap();
        map.put(A00(24, 15, 47), MJ.A06(j));
        map.put(A00(12, 12, 118), MJ.A04(j));
        c0711Jp.A02(EnumC0710Jo.A0D, map);
    }

    public static void A06(C1075Xy c1075Xy, JSONObject jSONObject, long j, @Nullable String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c1075Xy, jSONObjectOptJSONObject, A02(c1075Xy, jSONArrayOptJSONArray), j, null);
        } else {
            if (TextUtils.isEmpty(str) || !A02.containsKey(str)) {
                return;
            }
            A07(c1075Xy, jSONObjectOptJSONObject, A02.get(str), j, str);
        }
    }

    public static void A07(C1075Xy c1075Xy, JSONObject jSONObject, List<String> list, long j, @Nullable String str) {
    ...
    public static boolean A0A(String str, EnumC0710Jo enumC0710Jo) {
        return A0B(str, enumC0710Jo.A02());
    }
