...
public final class C0782Mn extends LinearLayout {
    ...
    public C0782Mn(C1075Xy c1075Xy, int i) {
        super(c1075Xy);
        this.A03 = c1075Xy;
        this.A02 = C2E.A00(c1075Xy.A00());
        setOrientation(0);
    ...
    private void A04(int i) {
        ...
        A05(this.A00, EnumC0769Ma.AD_CHOICES_ICON);
        if (i == 2) {
            int i2 = A05;
        ...
        if (i == 1) {
            enumC0769Ma = EnumC0769Ma.AN_INFO_ICON;
        } else {
            enumC0769Ma = EnumC0769Ma.DEFAULT_INFO_ICON;
        }
        A05(this.A01, enumC0769Ma);
        int i6 = A06;
    ...
    public static void A05(ImageView imageView, EnumC0769Ma enumC0769Ma) {
        imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        imageView.setImageBitmap(C0770Mb.A01(enumC0769Ma));
        imageView.setColorFilter(-1);
    }

    public void setAdDetails(C1U c1u, String str, C0711Jp c0711Jp, InterfaceC0785Mq interfaceC0785Mq) {
        setOnClickListener(new ViewOnClickListenerC0781Mm(this, c0711Jp, interfaceC0785Mq, str, c1u));
    }
