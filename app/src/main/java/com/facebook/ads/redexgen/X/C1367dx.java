...
public final class C1367dx implements C0K {
    ...
    static {
        A04();
        A07 = C1367dx.class.getSimpleName();
    }

    public C1367dx(String str) {
        this(str, C0I.A01(str));
    }

    public C1367dx(String str, int i) {
        this(str);
        this.A00 = i;
    }

    public C1367dx(String str, @Nullable String str2) {
    ...
    private HttpURLConnection A02(int i, int i2) throws C1369dz, IOException {
        String strA01;
        ...
        do {
            ...
            if (code > 5) {
                throw new C1369dz(A01(293, 20, 106) + code);
            }
        } while (z);
        return httpURLConnection;
    }

    private void A03() throws C1369dz {
    ...
    private final void A05(int i, int i2) throws C1369dz {
        try {
            this.A02 = A02(i, i2);
            ...
            throw new C1369dz(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e);
        }
    }
    ...
    public final void ACx(int i) throws C1369dz {
        A05(i, this.A00);
    }

    @Override // com.facebook.ads.redexgen.X.C0K
    public final void close() throws C1369dz {
        HttpURLConnection httpURLConnection = this.A02;
        if (httpURLConnection != null) {
            try {
                httpURLConnection.disconnect();
            } catch (NullPointerException e) {
                throw new C1369dz(A01(92, 37, 93), e);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C0K
    public final synchronized int length() throws C1369dz {
    ...
    @Override // com.facebook.ads.redexgen.X.C0K
    public final int read(byte[] bArr) throws C1369dz {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new C1369dz(strA01 + this.A03, e2);
            }
        }
        throw new C1369dz(strA01 + this.A03 + A01(51, 23, 21));
    }
