...
public class O8 {
    ...
    public final WeakReference<C0895Qw> A05;
    public final WeakReference<T5> A06;

    public O8(T5 t5, O9 o9, C0895Qw c0895Qw, AtomicBoolean atomicBoolean, AtomicBoolean atomicBoolean2, C1075Xy c1075Xy) {
        this.A06 = new WeakReference<>(t5);
        this.A04 = new WeakReference<>(o9);
        this.A05 = new WeakReference<>(c0895Qw);
        this.A01 = new WeakReference<>(atomicBoolean);
        this.A02 = new WeakReference<>(atomicBoolean2);
        this.A03 = new WeakReference<>(c1075Xy.A0D());
    }
    ...
    public String getAnalogInfo() {
        return C0766Lx.A01(AnonymousClass98.A02());
    }
