...
public class C1364du implements C0R {
    ...
    public final AtomicReference<EnumC02430c> A06 = new AtomicReference<>();
    ...
    public C1364du(C1362ds c1362ds) {
        this.A00 = c1362ds;
    }
    ...
    private final void A03(JSONObject jSONObject) throws Throwable {
        ...
        EnumC02430c enumC02430c = this.A06.get();
        if (enumC02430c != null) {
            C0X.A0D.A04(enumC02430c).A02(jSONObject);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.C0R
    public final void AEj(EnumC02430c enumC02430c) throws Throwable {
        if (L0.A02(this)) {
            return;
        }
        try {
            this.A06.set(enumC02430c);
        } catch (Throwable th) {
            L0.A00(th, this);
        }
    }
