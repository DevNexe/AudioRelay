...
public final class XI implements InterfaceC0505Aw {
    ...
    @Deprecated
    public XI(Context context, @Nullable CM<C1047Ww> cm, int i, long j) {
        this.A02 = context;
        this.A00 = i;
        this.A01 = j;
        this.A03 = cm;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.CM != com.facebook.ads.internal.exoplayer2.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.drm.FrameworkMediaCrypto> */
    private final void A02(Context context, @Nullable CM<C1047Ww> cm, long j, Handler handler, JN jn, int i, ArrayList<XG> arrayList) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.CM != com.facebook.ads.internal.exoplayer2.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.drm.FrameworkMediaCrypto> */
    private final void A03(Context context, @Nullable CM<C1047Ww> cm, BL[] blArr, Handler handler, BT bt, int i, ArrayList<XG> arrayList) {
        int i2;
        int i3;
        String strA00 = A00(0, 23, 71);
        arrayList.add(new C02701e(context, E6.A00, cm, false, handler, bt, BE.A00(context), blArr));
        if (i == 0) {
            return;
        }
        int size = arrayList.size();
        ...
        try {
            i2 = size + 1;
            try {
                arrayList.add(size, (XG) Class.forName(A00(403, 66, 80)).getConstructor(Handler.class, BT.class, BL[].class).newInstance(handler, bt, blArr));
    ...
    private final void A05(Context context, InterfaceC0621Gb interfaceC0621Gb, Looper looper, int i, ArrayList<XG> arrayList) {
        arrayList.add(new AnonymousClass33(interfaceC0621Gb, looper));
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.CM != com.facebook.ads.internal.exoplayer2.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.drm.FrameworkMediaCrypto> */
    @Override // com.facebook.ads.redexgen.X.InterfaceC0505Aw
    public final XG[] A4R(Handler handler, JN jn, BT bt, InterfaceC0621Gb interfaceC0621Gb, EJ ej, @Nullable CM<C1047Ww> cm) {
        CM<C1047Ww> cm2 = cm;
        if (cm2 == null) {
            cm2 = this.A03;
        }
        ...
        A05(this.A02, interfaceC0621Gb, handler.getLooper(), this.A00, arrayList);
