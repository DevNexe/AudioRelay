...
public final class PN {
    ...
    public static PM A00(C1075Xy c1075Xy, JSONObject jSONObject, C7U c7u, C0711Jp c0711Jp, C0844Ox c0844Ox, boolean z) {
        boolean updateUrls;
        String strA0R;
        String strA0R2;
        boolean z2 = z;
        ...
        c0711Jp.A02(EnumC0710Jo.A0P, null);
        try {
            ...
            c0844Ox.A04(C04578z.A15, A01(0, 43, 79));
        }
    ...
    public static void A03(ArrayList<String> arrayList, ArrayList<String> arrayList2, JSONObject jSONObject, C7U c7u, boolean z) throws JSONException {
        ...
        if (!TextUtils.isEmpty(jSONObject.optString(strA02))) {
            ...
            if (z) {
                jSONObject.put(strA02, c7u.A0R(strOptString2));
            }
        }
    }
}
