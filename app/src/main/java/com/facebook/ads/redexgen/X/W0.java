...
public final class W0 implements InterfaceC0569Dx {
    ...
    public boolean A02;
    public boolean A03;
    public final InterfaceC0562Dq A04;
    public final C0679Ij A05 = new C0679Ij(32);

    public W0(InterfaceC0562Dq interfaceC0562Dq) {
        this.A04 = interfaceC0562Dq;
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0569Dx
    public final void A49(C0679Ij c0679Ij, boolean z) {
        int iA06 = -1;
        if (z) {
            iA06 = c0679Ij.A06() + c0679Ij.A0E();
        }
        boolean z2 = this.A03;
        if (A06[1].length() == 27) {
        ...
        while (c0679Ij.A04() > 0) {
            ...
            if (i < 3) {
                ...
                int iMin = Math.min(c0679Ij.A04(), 3 - this.A00);
                c0679Ij.A0c(this.A05.A00, this.A00, iMin);
                this.A00 += iMin;
                if (this.A00 == 3) {
                    this.A05.A0W(3);
                    this.A05.A0Z(1);
                ...
                int iMin2 = Math.min(c0679Ij.A04(), this.A01 - this.A00);
                c0679Ij.A0c(this.A05.A00, this.A00, iMin2);
                this.A00 += iMin2;
                int i2 = this.A00;
                int i3 = this.A01;
                if (i2 == i3) {
                    ...
                    A06[1] = "WscUDiyP9zB";
                    if (z3) {
                        if (C0695Iz.A09(this.A05.A00, 0, this.A01, -1) != 0) {
                            this.A03 = true;
                            return;
                        }
                        this.A05.A0W(this.A01 - 4);
                    } else {
                        C0679Ij c0679Ij2 = this.A05;
                        if (A06[2].length() != 29) {
                            String[] strArr = A06;
    ...
    public final void A8K(C0691Iv c0691Iv, InterfaceC0537Ce interfaceC0537Ce, C0568Dw c0568Dw) {
        this.A04.A8K(c0691Iv, interfaceC0537Ce, c0568Dw);
        this.A03 = true;
    }
