...
public final class C1388eN {
    public final Map<View, C1395eU> A00 = new WeakHashMap();

    public final synchronized C1395eU A00(View view) {
        C1395eU c1395eU = this.A00.get(view);
        if (c1395eU != null) {
            return c1395eU;
        }
        return C1395eU.A06;
    ...
    public final synchronized void A02(View view, C1395eU c1395eU) {
        this.A00.put(view, c1395eU);
    }
