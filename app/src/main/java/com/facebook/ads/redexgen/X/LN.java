...
public final class LN {
    ...
    public static final Set<C1075Xy> A06;
    ...
    @Nullable
    public static C1075Xy A03(Intent intent) {
        String adId = intent.getStringExtra(A03);
        if (adId != null) {
            for (C1075Xy c1075Xy : A06) {
                if (adId.equals(c1075Xy.A0D().getId())) {
                    return c1075Xy;
                }
            }
            return null;
    ...
    public static AdActivityIntent A04(C1075Xy c1075Xy) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c1075Xy.getApplicationContext(), A05());
        adActivityIntent.putExtra(A03, c1075Xy.A0D().getId());
        A06.add(c1075Xy);
    ...
    public static void A09(C1075Xy c1075Xy, AdActivityIntent adActivityIntent) throws LL {
        try {
            c1075Xy.getApplicationContext().startActivity(A00(adActivityIntent));
    ...
    public static boolean A0B(C1075Xy c1075Xy, Intent intent) throws LL {
        return A0D(c1075Xy, intent, A07.get());
    }

    public static boolean A0C(C1075Xy c1075Xy, Intent intent) throws LL {
        LW lw = A07.get();
        if (lw == null || c1075Xy.A0C() == null) {
            return false;
        }
        String requestId = c1075Xy.A0A();
        try {
            ...
            c1075Xy.A06().A8y(A06(90, 8, 64), C04578z.A07, new AnonymousClass90(e2));
            return false;
        }
    }

    @VisibleForTesting
    public static boolean A0D(C1075Xy c1075Xy, Intent intent, @Nullable LW lw) throws LL {
        if (A0A(intent, JR.A0W(c1075Xy))) {
            return false;
        }
        Context context = c1075Xy;
        String[] strArr = A01;
        if (strArr[6].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
        ...
        if (lw != null && !A0A(intent, JR.A0Y(c1075Xy))) {
            String requestId = c1075Xy.A0A();
            if (requestId == null) {
                try {
                    requestId = A06(0, 0, 81);
                    ...
                    c1075Xy.A06().A8y(A06(90, 8, 64), C04578z.A08, new AnonymousClass90(e2));
                    return false;
                }
            }
    ...
    public static boolean A0E(C1075Xy c1075Xy, Uri uri, String str) throws ActivityNotFoundException {
        return A0F(c1075Xy, uri, str, A08.get());
    }

    @VisibleForTesting
    public static boolean A0F(C1075Xy c1075Xy, Uri uri, String str, @Nullable LY ly) throws ActivityNotFoundException {
        if (ly == null || c1075Xy.A0C() == null) {
            return false;
        }
        Bundle bundle = new Bundle();
        bundle.putString(A06(98, 15, 59), str);
        return ly.handleUriForResult(c1075Xy, uri.toString(), bundle, null, 0, c1075Xy.A0C());
    }
}
