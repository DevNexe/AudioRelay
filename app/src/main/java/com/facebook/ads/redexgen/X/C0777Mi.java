...
public final class C0777Mi implements SensorEventListener {
    ...
    public final Set<InterfaceC0776Mh> A09 = new CopyOnWriteArraySet();
    ...
    public C0777Mi(C1075Xy c1075Xy) {
        this.A08 = c1075Xy;
    }
    ...
    public final void A03(InterfaceC0776Mh interfaceC0776Mh) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC0776Mh)) {
            return;
        }
        this.A09.add(interfaceC0776Mh);
    }
            ...
            if (speed > 800.0f) {
                ...
                if (i >= 3) {
                    ...
                    if (jElapsedRealtime - now3 > 1000) {
                        ...
                        this.A03 = 0;
                        Iterator<InterfaceC0776Mh> it = this.A09.iterator();
                        while (it.hasNext()) {
                            it.next().ACJ();
                        }
                    }
