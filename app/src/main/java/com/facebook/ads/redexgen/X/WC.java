...
public final class WC implements InterfaceC0567Dv {
    ...
    private C0563Dr A00(C0566Du c0566Du) {
        String strA01;
        int i;
        if (A03(32)) {
            return new C0563Dr(this.A01);
        }
        C0679Ij c0679Ij = new C0679Ij(c0566Du.A03);
        ...
        while (true) {
            ...
            strArr2[5] = "Me3yU";
            if (iA04 > 0) {
                int descriptorLength = c0679Ij.A0E();
                int descriptorTag = c0679Ij.A0E();
                int iA06 = c0679Ij.A06() + descriptorTag;
                if (descriptorLength == 134) {
                    arrayList = new ArrayList<>();
                    int nextDescriptorPosition = c0679Ij.A0E();
                    int i2 = nextDescriptorPosition & 31;
                    for (int accessibilityChannel = 0; accessibilityChannel < i2; accessibilityChannel++) {
                        String strA0S = c0679Ij.A0S(3);
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0567Dv
    public final SparseArray<InterfaceC0569Dx> A4K() {
        return new SparseArray<>();
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0567Dv
    public final InterfaceC0569Dx A4P(int i, C0566Du c0566Du) {
        if (i == 2) {
            return new W3(new W9());
        }
        if (i == 3 || i == 4) {
            return new W3(new W4(c0566Du.A01));
        }
        if (i == 15) {
            if (A03(2)) {
                return null;
            }
            return new W3(new WD(false, c0566Du.A01));
        }
        if (i == 17) {
            if (A03(2)) {
                return null;
            }
            return new W3(new W5(c0566Du.A01));
        }
        if (i == 21) {
        ...
        if (i == 27) {
            ...
            return new W3(new W8(A00(c0566Du), A03(1), A03(8)));
        }
        if (i == 36) {
            return new W3(new W7(A00(c0566Du)));
        }
        if (i != 89) {
            if (i != 138) {
                if (i != 129) {
                ...
                return new W3(new WG(c0566Du.A01));
            }
            return new W3(new WB(c0566Du.A01));
        }
        return new W3(new WA(c0566Du.A02));
    }
}
