...
public final class C0641Gv {
    ...
    public C0641Gv(@Nullable String str, String str2, long j, long j2, H1 h1, String[] strArr, String str3) {
        this.A05 = str;
        this.A06 = str2;
        this.A03 = h1;
        this.A0A = strArr;
    ...
    private final C0641Gv A03(int i) {
        List<C0641Gv> list = this.A00;
        if (list != null) {
            return list.get(i);
        }
    ...
    public static C0641Gv A04(String str) {
        return new C0641Gv(null, C0643Gx.A02(str), -9223372036854775807L, -9223372036854775807L, null, null, A06(0, 0, 104));
    }

    public static C0641Gv A05(String str, long j, long j2, H1 h1, String[] strArr, String str2) {
        return new C0641Gv(str, null, j, j2, h1, strArr, str2);
    }
    ...
    private void A09(long j, boolean z, String str, Map<String, SpannableStringBuilder> map) {
        ...
        if (A06(0, 2, 108).equals(this.A05) && z) {
            SpannableStringBuilder spannableStringBuilderA02 = A02(str2, map);
            if (A0C[1].length() == 9) {
                throw new RuntimeException();
            }
            A0C[7] = "inqcH2t7hqDFIF9gj0D4l0zfPZYOosXl";
            spannableStringBuilderA02.append('\n');
            return;
        }
        if (!A0C(j)) {
            return;
        ...
        for (int i = 0; i < A00(); i++) {
            A03(i).A09(j, z || zEquals, str2, map);
        }
        if (zEquals) {
            C0643Gx.A04(A02(str2, map));
        }
        Set<Map.Entry<String, SpannableStringBuilder>> setEntrySet = map.entrySet();
        if (A0C[1].length() != 9) {
            String[] strArr = A0C;
    ...
    private void A0A(Map<String, H1> map, SpannableStringBuilder spannableStringBuilder, int i, int i2) {
        H1 h1A00 = C0643Gx.A00(this.A03, this.A0A, map);
        if (h1A00 != null) {
            C0643Gx.A05(spannableStringBuilder, i, i2, h1A00);
        }
    }
    ...
    public final List<GX> A0D(long j, Map<String, H1> map, Map<String, C0642Gw> map2) {
        ...
        for (Map.Entry<String, SpannableStringBuilder> entry : regionOutputs.entrySet()) {
            C0642Gw c0642Gw = map2.get(entry.getKey());
            arrayList.add(new GX(A01(entry.getValue()), (Layout.Alignment) null, c0642Gw.A00, c0642Gw.A05, c0642Gw.A04, c0642Gw.A01, Integer.MIN_VALUE, c0642Gw.A03, c0642Gw.A06, c0642Gw.A02));
        }
        return arrayList;
    }

    public final void A0E(C0641Gv c0641Gv) {
        if (this.A00 == null) {
            this.A00 = new ArrayList();
        }
        this.A00.add(c0641Gv);
    }
