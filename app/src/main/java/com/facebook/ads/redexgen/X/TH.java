...
public final class TH extends NN {
    ...
    public TH(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, String str) {
        super(c1075Xy, interfaceC0703Jh, str);
        this.A05 = c1075Xy;
        this.A04 = C2E.A00(c1075Xy.A00());
    ...
    public final void A0O(C2H c2h, C2F c2f) {
        MS.A0T(this.A03);
        this.A01.setImageBitmap(C0770Mb.A01(EnumC0769Ma.BACK_ARROW));
        this.A01.setOnClickListener(new ViewOnClickListenerC0795Na(this));
        ...
        for (C2H c2h2 : c2h.A05()) {
            ...
            nr.setOnClickListener(new ViewOnClickListenerC0796Nb(this, nr, c2h2));
            this.A02.addView(nr, layoutParams);
        }
    }
