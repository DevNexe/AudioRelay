...
public final class C0746Lb {
    ...
    public static int A00(C1075Xy c1075Xy, int i) {
        SharedPreferences sharedPreferences = C0738Kt.A00(c1075Xy);
        return sharedPreferences.getInt(A01(0, 21, 2), i);
    }

    @Nullable
    public static String A02(C1075Xy c1075Xy, @Nullable String str) {
        int iA00 = A00(c1075Xy, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C1075Xy c1075Xy, String str, @Nullable String str2) {
        if (c1075Xy == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1075Xy, str);
    ...
    public final RewardedVideoAd A07(C1075Xy c1075Xy, String str, @Nullable String str2) {
        if (c1075Xy == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1075Xy, str);
    ...
    public final void A08(C1075Xy c1075Xy, boolean z) {
        int i = 0;
        String strA01 = A01(0, 21, 2);
        if (!z) {
            i = C0738Kt.A00(c1075Xy).getInt(strA01, 0) + 1;
        }
        C0738Kt.A00(c1075Xy).edit().putInt(strA01, i).apply();
    }

    public final boolean A09(C1075Xy c1075Xy, @Nullable String str, int i) {
        if (i <= 0) {
            return false;
        }
        try {
            return !A05(str) && A00(c1075Xy, i + (-1)) >= i + (-1);
        } catch (JSONException unused) {
        }
        return false;
    }
