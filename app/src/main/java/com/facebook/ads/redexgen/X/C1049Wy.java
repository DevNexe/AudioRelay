...
@TargetApi(18)
public final class C1049Wy<T extends CN> implements CM<T>, C3<T> {
    ...
    public final List<C1050Wz<T>> A08;
    public final List<C1050Wz<T>> A09;
            ...
            if (i < drmInitData.A01) {
                ...
                if (AG.A05.equals(uuid)) {
                    for (int i2 = 0; i2 < arrayList.size(); i2++) {
                        ...
                        if (C0695Iz.A02 < 23 && iA00 == 0) {
                            return schemeData;
                        }
                        if (C0695Iz.A02 >= 23 && iA00 == 1) {
                            return schemeData;
                        }
                    }
                }
    ...
    public final CL<T> A2P(Looper looper, DrmInitData drmInitData) {
        ...
        if (this.A0B) {
            ...
            C1050Wz<T> c1050Wz2 = this.A09.get(0);
            if (A0E[0].length() != 30) {
                throw new RuntimeException();
            }
        ...
        if (c1050Wz == null) {
            c1050Wz = new C1050Wz<>(this.A0A, this.A05, this, schemeDataA00, this.A00, this.A02, this.A07, this.A06, looper, this.A04, this.A03);
            this.A09.add(c1050Wz);
        }
        c1050Wz.A0G();
        return c1050Wz;
    }
    ...
    public final boolean A3x(@NonNull DrmInitData drmInitData) {
        ...
        return !(A01(92, 4, 43).equals(str) || A01(96, 4, 62).equals(str) || A01(104, 4, 119).equals(str)) || C0695Iz.A02 >= 25;
    }
    ...
    public final void AC0() {
        Iterator<C1050Wz<T>> it = this.A08.iterator();
        while (it.hasNext()) {
            it.next().A0H();
        }
        this.A08.clear();
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Wz != com.facebook.ads.internal.exoplayer2.drm.DefaultDrmSession<T extends com.facebook.ads.redexgen.X.CN> */
    @Override // com.facebook.ads.redexgen.X.C3
    public final void ADQ(C1050Wz<T> c1050Wz) {
        this.A08.add(c1050Wz);
        if (this.A08.size() == 1) {
            c1050Wz.A0I();
        }
    }
    ...
    public final void ADs(CL<T> cl) {
        if (cl instanceof C1048Wx) {
            return;
        }
        C1050Wz<T> c1050Wz = (C1050Wz) cl;
        if (c1050Wz.A0L()) {
            this.A09.remove(c1050Wz);
            if (this.A08.size() > 1 && this.A08.get(0) == c1050Wz) {
                this.A08.get(1).A0I();
            }
            this.A08.remove(c1050Wz);
        }
    }
}
