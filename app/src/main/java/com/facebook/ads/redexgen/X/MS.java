...
public final class MS {
    ...
    public static void A0F(int i, View view) {
        ...
        scaleAnimation.setAnimationListener(new C0961Tl(view, scaleAnimation2));
    ...
    public static void A0T(ViewGroup viewGroup) {
        if (Build.VERSION.SDK_INT > 19) {
            A0U(viewGroup, RCHTTPStatusCodes.SUCCESS);
        }
    }
    ...
    public static void A0V(ViewGroup viewGroup, Transition transition) {
        if (Build.VERSION.SDK_INT > 19) {
            A0W(viewGroup, transition, RCHTTPStatusCodes.SUCCESS);
        }
    }
