...
public final class C1200b9 implements C6L {
    ...
    public static void A01() {
        byte[] bArr = {74, 119, 108, 106, 127, 123, 102, 96, 97, 47, 109, 122, 102, 99, 107, 102, 97, 104, 47, 73, 78, 65, 47, 99, 96, 104, 104, 102, 97, 104, 47, 69, 92, 64, 65, 122, 81, 70, 81, 30, 24, 35, 24, 29, 8, 29, 35, 16, 19, 27, 27, 21, 18, 27, 96, 107, 102, 5, 66, 74, 22, 0, 7, 38, 55, 92, 1, 10, 12};
        String[] strArr = A02;
    ...
    static {
        A01();
        A03 = C1200b9.class.getSimpleName();
    }

    public C1200b9(C1074Xx c1074Xx) {
        this.A00 = c1074Xx;
    }
