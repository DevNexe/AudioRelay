...
public abstract class AbstractC0947Sw extends AbstractC0826Of {
    ...
    public AbstractC0947Sw(C0830Oj c0830Oj, boolean z) {
        super(c0830Oj, z);
        this.A03 = c0830Oj.A04();
        this.A04 = this.A03.A0O();
        this.A05 = A09(c0830Oj);
        AbstractC0784Mp abstractC0784MpA08 = c0830Oj.A08();
        if (abstractC0784MpA08 != null) {
            abstractC0784MpA08.setLayoutParams(new RelativeLayout.LayoutParams(-1, abstractC0784MpA08.getToolbarHeight()));
            abstractC0784MpA08.setPageDetailsVisible(false);
        }
    }

    private OJ A09(C0830Oj c0830Oj) {
        String strA0A;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(12);
        if (c0830Oj.A04().A0Y().equals(A0A(37, 14, 56))) {
            strA0A = Q9.A04.A02();
        } else {
            strA0A = A0A(0, 37, 124);
        }
        C0948Sx c0948Sx = new C0948Sx(c0830Oj.A05(), A0B, this.A04.A0E().A00() == C1G.A05, getColors(), this.A04.A0F().A06(), strA0A, c0830Oj.A06(), c0830Oj.A09(), c0830Oj.A0B(), c0830Oj.A07());
        this.A02 = new IT(c0948Sx, 400, 100, 0);
        MS.A0K(c0948Sx);
        c0948Sx.A0A(c0830Oj.A00());
        addView(c0948Sx, layoutParams);
        return c0948Sx;
    }
    ...
    public final int A0e(@Nullable AbstractC0784Mp abstractC0784Mp) {
        return abstractC0784Mp == null ? AbstractC0784Mp.A00 : abstractC0784Mp.getToolbarHeight();
    }
    ...
    public void A0f() {
        ...
        if (expandableLayout != null) {
            ...
            this.A00.A0I(new IV(getAdDetailsView().getCTAButton(), RCHTTPStatusCodes.UNSUCCESSFUL, -1, c1kA01.A09(true)));
            this.A00.A0I(new C0677Ih(getAdDetailsView().getCTAButton(), RCHTTPStatusCodes.UNSUCCESSFUL, MS.A08(A09, A0A, A08), MS.A05(c1kA01.A08(true), A08)));
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (c0676Ig == null) {
            this.A01 = new C0676Ig(expandableLayout, RCHTTPStatusCodes.UNSUCCESSFUL, expandableLayout.getHeight(), 0);
