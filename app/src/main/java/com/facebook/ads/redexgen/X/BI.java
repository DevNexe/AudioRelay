...
public final class BI implements InterfaceC0990Uo, Comparator<I8> {
    ...
    public final int compare(I8 i8, I8 i9) {
        if (i8.A00 - i9.A00 == 0) {
            return i8.compareTo(i9);
        }
        return i8.A00 < i9.A00 ? -1 : 1;
    }
    ...
    @Override // com.facebook.ads.redexgen.X.I3
    public final void ACP(I4 i4, I8 i8, I8 i9) {
        ACO(i4, i8);
        ACN(i4, i9);
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0990Uo
