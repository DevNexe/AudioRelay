...
public class C1345da implements InterfaceC02490i, InterfaceC02530n {
    ...
    static {
        A04();
        A0C = C1345da.class.getSimpleName();
    }

    public C1345da(C1075Xy c1075Xy) {
        this(c1075Xy, new AnonymousClass11());
    }

    public C1345da(C1075Xy c1075Xy, AnonymousClass11 anonymousClass11) {
        ...
        if (!this.A05) {
            ...
            if (listA0f != null && listA0f.size() > 0) {
                ...
                for (int i = 0; i < size; i++) {
                    C1345da c1345da = new C1345da(this.A09);
                    c1345da.A05(listA0f.get(i));
                    arrayList.add(new UB(this.A09, c1345da, (C9I) null, this.A03));
                }
                this.A04 = arrayList;
            }
            this.A05 = true;
    ...
    private void A06(Map<String, String> map, Map<String, String> map2) {
        try {
            ...
            new Handler().postDelayed(new C1346db(this, map2, urlParams), this.A01.A07() * AdError.NETWORK_ERROR_CODE);
    ...
    public final void A0L(C1075Xy c1075Xy, AnonymousClass12 anonymousClass12, InterfaceC0703Jh interfaceC0703Jh, C02821q c02821q, K4 k4) {
        int iA06;
        this.A02 = anonymousClass12;
        this.A03 = k4;
        JSONObject jSONObjectA03 = c02821q.A03();
        C9I c9iA01 = c02821q.A01();
        if (c9iA01 != null) {
            iA06 = c9iA01.A06();
        } else {
            iA06 = RCHTTPStatusCodes.SUCCESS;
        }
        this.A00 = iA06;
        A05(AnonymousClass13.A00(c1075Xy, jSONObjectA03, C0766Lx.A02(jSONObjectA03, A02(106, 2, 85))));
        if (C02500j.A03(c1075Xy, this, interfaceC0703Jh)) {
            c1075Xy.A0D().A41();
    ...
    public final void A0M(Map<String, String> urlParams) {
        ...
        C0751Lg.A02(this.A09, A02(58, 12, 65));
        ...
        C1075Xy c1075Xy = this.A09;
        AbstractC02460f adAction = C02470g.A00(c1075Xy, c1075Xy.A08(), this.A01.A0Y(), this.A01.A0B(), map);
        if (adAction != null) {
            try {
                adAction.A0C();
            } catch (Exception e) {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC02490i
