...
public final class DF {
    ...
    public D9 A04;
    public DO A05;
    public final InterfaceC0545Co A06;
    public final DQ A07 = new DQ();
    public final C0679Ij A09 = new C0679Ij(1);
    public final C0679Ij A08 = new C0679Ij();

    public DF(InterfaceC0545Co interfaceC0545Co) {
        this.A06 = interfaceC0545Co;
    }
    ...
    public void A01() {
        ...
        C0679Ij c0679Ij = this.A07.A09;
        DP dpA00 = A00();
        if (dpA00.A00 != 0) {
            c0679Ij.A0Z(dpA00.A00);
        }
        if (this.A07.A0H[this.A01]) {
            c0679Ij.A0Z(c0679Ij.A0I() * 6);
        }
    }
    ...
    public final int A03() {
        ...
        this.A06.AEG(c0679Ij, length);
        if (!z) {
            int vectorSize3 = length + 1;
            return vectorSize3;
        }
        C0679Ij c0679Ij2 = this.A07.A09;
        int iA0I = c0679Ij2.A0I();
        c0679Ij2.A0Z(-2);
        int subsampleCount = iA0I * 6;
        int i = subsampleCount + 2;
        this.A06.AEG(c0679Ij2, i);
