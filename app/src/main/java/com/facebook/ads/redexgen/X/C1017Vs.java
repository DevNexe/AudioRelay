...
public final class C1017Vs implements InterfaceC0542Cl {
    public long A00;
    public long A01;
    ...
    public C1017Vs(int i, int i2, int i3, int i4, int i5, int i6) {
        this.A06 = i;
        this.A07 = i2;
        this.A02 = i3;
        this.A04 = i4;
    ...
    public final C0541Ck A7O(long j) {
        ...
        int i = this.A04;
        long jA0E = C0695Iz.A0E((j2 / ((long) i)) * ((long) i), 0L, this.A00 - ((long) i));
        long j3 = this.A01 + jA0E;
        long seekTimeUs = A05(j3);
        C0543Cm c0543Cm = new C0543Cm(seekTimeUs, j3);
        if (seekTimeUs < j) {
            long j4 = this.A00;
            int i2 = this.A04;
            if (jA0E != j4 - ((long) i2)) {
                ...
                return new C0541Ck(c0543Cm, new C0543Cm(seekPosition, j5));
            }
        }
