...
public final class C04669i implements Closeable {
    ...
    public final C04679j A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C04679j c04679j) throws IOException {
        if (!this.A01) {
            if (c04679j.A02() >= 0 && c04679j.A03() >= 0) {
                this.A00 = c04679j;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 96), Integer.valueOf(c04679j.A02()), Integer.valueOf(c04679j.A03())));
        }
        throw new IOException(A00(0, 28, 58));
    }
