...
public enum EnumC0749Le {
    ...
    public static final EnumC0749Le[] A02;
    ...
    static {
        A03();
        A02 = new EnumC0749Le[]{A0G, A08, A05, A0E, A0H, A0I, A0B, A0A};
        JSONArray jSONArray = new JSONArray();
        for (EnumC0749Le enumC0749Le : A02) {
            jSONArray.put(enumC0749Le.A00());
        }
