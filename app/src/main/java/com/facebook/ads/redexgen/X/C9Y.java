...
public final class C9Y {
    ...
    public static String A03(C8U c8u, AnonymousClass99 anonymousClass99) {
        ...
        if (TextUtils.isEmpty(strA07)) {
            ...
            if (!andSet) {
                c8u.A06().A8y(A00(116, 7, 65), C04578z.A1Z, new AnonymousClass90(A00(73, 7, 29)));
            }
        }
        return strA07;
    }
    ...
    public static String A04(C8U c8u, boolean z) {
        ...
        String strA01 = A00(133, 10, 64);
        String strA02 = A00(88, 28, 104);
        if (jA01 > 0) {
            SharedPreferences sharedPreferences = c8u.getSharedPreferences(ProcessUtils.getProcessSpecificName(strA02, c8u), 0);
        ...
        A02[7] = "Kvz6zSF";
        if (jA01 > 0) {
            String userAgentString2 = ProcessUtils.getProcessSpecificName(strA02, c8u);
            ...
            editorEdit.putString(strA01, userAgentString3).apply();
    ...
    public static String A05(AnonymousClass99 anonymousClass99, C8U c8u) {
        if (JQ.A04(c8u)) {
            return A00(63, 5, 117) + A03(c8u, anonymousClass99) + A00(39, 6, 127) + anonymousClass99.A06() + A00(45, 6, 121) + anonymousClass99.A04() + A00(38, 1, 111);
        }
        return A00(0, 0, 40);
    }

    public static String A06(AnonymousClass99 anonymousClass99, C8U c8u, boolean z) {
        return A04(c8u, z) + A00(0, 38, 127) + c8u.A03().A7m() + A00(57, 6, 54) + AnonymousClass99.A03 + A00(38, 1, 111) + A05(anonymousClass99, c8u) + A00(68, 5, 69) + c8u.A03().A7n() + A00(51, 6, 77) + Locale.getDefault().toString() + A00(87, 1, 79);
    }

    public static void A09(C8U c8u, Throwable th) {
        c8u.A06().A8y(A00(166, 8, 84), C04578z.A2f, new AnonymousClass90(th));
    }
}
