...
public final class C1287cd implements AnonymousClass22 {
    ...
    public C1287cd(C1075Xy c1075Xy, AnonymousClass24 anonymousClass24, InterfaceC02871v interfaceC02871v, AbstractC1300cq abstractC1300cq) {
        this.A03 = c1075Xy;
    ...
    public final void A80(Message message) {
        ...
        if (adA00 == null) {
            this.A03.A06().A8y(strA00, C04578z.A0K, new AnonymousClass90(A00(0, 17, 12)));
            return;
        }
        int i = message.what;
        String strA01 = A00(120, 9, 2);
        String strA02 = A00(17, 17, 14);
        if (i != 10) {
            if (i == 2100) {
                this.A01.AEc();
                Bundle bundle = message.getData().getBundle(strA02);
                if (bundle != null) {
                    this.A02.A01 = bundle.getLong(A00(94, 26, 87));
                    this.A02.A00 = bundle.getInt(A00(69, 25, 51));
                } else {
                    this.A03.A06().A8y(strA00, C04578z.A0V, new AnonymousClass90(A00(129, 26, 89), strA01 + message));
                }
                this.A02.A01(null);
            } else if (i != 2103) {
                if (i == 2106) {
        ...
        Bundle bundle3 = bundle2.getBundle(strA02);
        if (bundle3 != null) {
            ...
            this.A03.A06().A8y(strA00, C04578z.A0V, new AnonymousClass90(A00(155, 27, 49), strA01 + message));
        }
