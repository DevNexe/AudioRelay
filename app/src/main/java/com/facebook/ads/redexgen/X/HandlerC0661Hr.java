...
import com.facebook.ads.redexgen.X.InterfaceC0662Hs;
...
public final class HandlerC0661Hr<T extends InterfaceC0662Hs> extends Handler implements Runnable {
    public static byte[] A0A;
    public int A00;

    @Nullable
    public InterfaceC0660Hq<T> A01;
    ...
    public final /* synthetic */ C0998Uw A09;
    ...
    public HandlerC0661Hr(C0998Uw c0998Uw, Looper looper, T loadable, InterfaceC0660Hq<T> interfaceC0660Hq, int i, long j) {
        super(looper);
        this.A09 = c0998Uw;
        this.A05 = loadable;
        this.A01 = interfaceC0660Hq;
        this.A03 = i;
        this.A04 = j;
    }
                ...
                try {
                    try {
                        try {
                            ...
                            if (!this.A07) {
                                C0692Iw.A02(A01(156, 10, 86) + this.A05.getClass().getSimpleName() + A01(0, 6, 68));
                                try {
                                    this.A05.A8m();
                                    C0692Iw.A00();
                                } catch (Throwable th) {
                            ...
                            Log.e(strA01, A01(121, 35, 38), e2);
                            if (!this.A08) {
                                obtainMessage(3, new C0666Hw(e2)).sendToTarget();
                            }
                        }
                    } catch (Error e3) {
                        Log.e(strA01, A01(46, 31, 68), e3);
                        if (!this.A08) {
                    ...
                    Log.e(strA01, A01(14, 32, 85), e4);
                    if (!this.A08) {
                        obtainMessage(3, new C0666Hw(e4)).sendToTarget();
                    }
                }
