...
public final class C0652Hg implements R2 {
    ...
    public InterfaceC04568y A00;
    public Executor A01;
    public boolean A02;
    public R7 A03;
    public final RC A04 = new C0668Hy();
    public final RH A05;
    public final RI A06;
    ...
    public C0652Hg(R7 r7, InterfaceC04568y interfaceC04568y, Executor executor) {
        A0B();
        this.A03 = r7;
        this.A06 = new HN(r7.A04());
        final RI ri = this.A06;
        this.A05 = new AbstractC0665Hv(ri) { // from class: com.facebook.ads.redexgen.X.4M
        };
        this.A01 = executor;
        this.A00 = interfaceC04568y;
    }
            ...
            try {
                ...
                if ((httpURLConnectionA08 instanceof HttpsURLConnection) && (pinKeys || z)) {
                    try {
                        ...
                        this.A00.A9I(strA07, C04578z.A1y, new AnonymousClass90(e));
                    } catch (Exception e2) {
                        this.A00.A9I(strA07, C04578z.A1x, new AnonymousClass90(e2));
                    }
                }
                ...
                if (httpURLConnectionA08.getDoInput()) {
                    c0653Hh = A06(httpURLConnectionA08);
                } else {
                    c0653Hh = new C0653Hh(httpURLConnectionA08, null);
                }
                if (this.A06.A8Z()) {
                    this.A06.A9F(c0653Hh);
                }
    ...
    private final R1 A04(String str, String str2, byte[] bArr, RA ra) {
        return A02(new C0655Hk(str, null, str2, bArr, ra));
    }
    ...
    private final R1 A05(HttpURLConnection httpURLConnection) throws Exception {
        ...
        try {
            ...
            return new C0653Hh(httpURLConnection, bArrADe);
        } finally {
            if (errorStream != null) {
                try {
                    errorStream.close();
    ...
    private void A0F(String str, String str2, byte[] bArr, R3 r3, RA ra) {
        A0D(new C0655Hk(str, null, str2, bArr, ra), r3);
    }
    ...
    public final R1 A0J(RE re) throws RF {
                        ...
                        if (isRecoverable && i < iA01 - 1) {
                            ...
                            if (jA03 > 0) {
                                try {
                                    ...
                                    InterfaceC04568y interfaceC04568y = this.A00;
                                    long jCurrentTimeMillis3 = System.currentTimeMillis() - startTime;
                                    if (re.A04 != null) {
                                        int numTries = re.A04.length;
                                        j2 = numTries;
                                    }
                                    interfaceC04568y.A98(startTime, jCurrentTimeMillis3, 0L, j2, 0, e2);
                                    throw e;
                                }
                            } else {
                                continue;
                            ...
                            R1 r1A00 = e.A00();
                            InterfaceC04568y interfaceC04568y2 = this.A00;
                            ...
                            interfaceC04568y2.A98(startTime, jCurrentTimeMillis4, startTime2, endTimeMillis, r1A00 == null ? 0 : r1A00.A7a(), e);
                            throw e;
                        }
                    } else {
                        continue;
        ...
        InterfaceC04568y interfaceC04568y3 = this.A00;
        ...
        interfaceC04568y3.A98(startTime, jCurrentTimeMillis5, 0L, j, 0, new TimeoutException(A07(82, 35, 27)));
        return null;
    }
