...
public final class JT {
    ...
    public static int A05(Context context) {
        return JR.A0O(context).A2B(A0L(1022, 21, 19), 10);
    }
    ...
    public static int A0A(Context context) {
        return JR.A0O(context).A2B(A0L(405, 46, 99), 0);
    }
    ...
    public static long A0I(Context context) {
        return JR.A0O(context).A2C(A0L(320, 46, 122), 2000L);
    }

    public static long A0J(Context context) {
        return ((long) JR.A0O(context).A2B(A0L(1043, 41, 66), RCHTTPStatusCodes.UNSUCCESSFUL)) * 1000;
    }
