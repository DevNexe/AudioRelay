...
public final class C0843Ow {
    public static A3 A00(final C0830Oj c0830Oj, int i, final String str, final SB sb) {
        if (i == 1) {
            return new A3(c0830Oj, str, sb) { // from class: com.facebook.ads.redexgen.X.1i
                ...
                public final void A0j(C1075Xy c1075Xy) {
                    C0823Oc titleDescContainer = getTitleDescContainer();
                    ...
                    LinearLayout linearLayout = new LinearLayout(c1075Xy);
        ...
        return new A3(c0830Oj, str, sb) { // from class: com.facebook.ads.redexgen.X.26
            ...
            @Override // com.facebook.ads.redexgen.X.A3, com.facebook.ads.redexgen.X.AbstractC0826Of
