...
public final class AQ {
    ...
    public final C0489Ag A02;
    public final HT A03;
    public final Set<InterfaceC0493Ak> A04;
    ...
    public AQ(C0489Ag c0489Ag, C0489Ag c0489Ag2, Set<InterfaceC0493Ak> set, HT ht, boolean z, int i, int i2, boolean z2, boolean z3, boolean z4) {
        this.A02 = c0489Ag;
        this.A04 = set;
        this.A03 = ht;
        this.A08 = z;
        ...
        this.A09 = z2;
        this.A06 = z3;
        this.A07 = z4 || c0489Ag2.A00 != c0489Ag.A00;
        this.A0A = (c0489Ag2.A03 == c0489Ag.A03 && c0489Ag2.A07 == c0489Ag.A07) ? false : true;
        this.A05 = c0489Ag2.A08 != c0489Ag.A08;
        this.A0B = c0489Ag2.A06 != c0489Ag.A06;
    }

    public final void A00() {
        if (this.A0A || this.A01 == 0) {
            Iterator<InterfaceC0493Ak> it = this.A04.iterator();
            while (it.hasNext()) {
        ...
        if (strArr[1].charAt(12) == strArr[4].charAt(12)) {
            ...
            if (z) {
                Iterator<InterfaceC0493Ak> it2 = this.A04.iterator();
                while (true) {
            ...
            if (this.A0B) {
                ...
                Iterator<InterfaceC0493Ak> it3 = this.A04.iterator();
                while (it3.hasNext()) {
            ...
            if (strArr5[1].charAt(12) == strArr5[4].charAt(12)) {
                ...
                strArr6[5] = "Qd2F";
                if (z2) {
                    Iterator<InterfaceC0493Ak> it4 = this.A04.iterator();
                    while (it4.hasNext()) {
                        it4.next().ABN(this.A02.A08);
                    }
                }
                if (this.A07) {
                    Iterator<InterfaceC0493Ak> it5 = this.A04.iterator();
                    while (it5.hasNext()) {
                        it5.next().ABs(this.A06, this.A02.A00);
                    }
                }
                if (this.A09) {
                    for (InterfaceC0493Ak listener : this.A04) {
                        listener.ACH();
                    }
                    return;
                }
