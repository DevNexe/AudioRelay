...
public final class C1033Wi extends Cq {
    ...
    public C1033Wi(InterfaceC0545Co interfaceC0545Co) {
        super(interfaceC0545Co);
        this.A04 = new C0679Ij(C0675If.A03);
        this.A03 = new C0679Ij(4);
    }

    @Override // com.facebook.ads.redexgen.X.Cq
    public final void A0B(C0679Ij c0679Ij, long j) throws C0488Af {
        int iA0E = c0679Ij.A0E();
        long jA09 = j + (((long) c0679Ij.A09()) * 1000);
        if (iA0E == 0 && !this.A02) {
            C0679Ij videoSequence = new C0679Ij(new byte[c0679Ij.A04()]);
            c0679Ij.A0c(videoSequence.A00, 0, c0679Ij.A04());
        ...
        int i2 = 0;
        while (c0679Ij.A04() > 0) {
            c0679Ij.A0c(this.A03.A00, i, this.A01);
            this.A03.A0Y(0);
            int iA0H = this.A03.A0H();
            this.A04.A0Y(0);
            super.A00.AEG(this.A04, 4);
            super.A00.AEG(c0679Ij, iA0H);
            i2 = i2 + 4 + iA0H;
        }
        InterfaceC0545Co interfaceC0545Co = super.A00;
        ...
        interfaceC0545Co.AEH(jA09, i3, i2, 0, null);
    }
    ...
    public final boolean A0C(C0679Ij c0679Ij) throws C1034Wj {
        ...
        throw new C1034Wj(A00(0, 28, 8) + i2);
    }
}
