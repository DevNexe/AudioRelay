...
public class OI implements MB<Bundle> {
    ...
    public String A02;
    public boolean A03;
    public final C1283cZ A04;
    public final C1075Xy A05;
    public final InterfaceC0703Jh A06;
    public final InterfaceC0872Pz A07;
    public final Q4 A08;
    public final Q5 A09;
    ...
    public OI(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, InterfaceC0872Pz interfaceC0872Pz, List<C2A> list, String str, boolean z, @Nullable Bundle bundle, Q4 q4) {
        this(c1075Xy, interfaceC0703Jh, interfaceC0872Pz, list, str, z, bundle, null, q4);
    }

    public OI(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, InterfaceC0872Pz interfaceC0872Pz, List<C2A> list, String str, boolean z, @Nullable Bundle bundle, @Nullable Map<String, String> map, Q4 q4) {
        this.A0A = new Object();
        this.A01 = 0;
        this.A00 = 0;
        this.A02 = null;
        ...
        this.A07 = interfaceC0872Pz;
        this.A0B = str;
        this.A0C = map;
        this.A03 = z;
        this.A08 = q4;
        list.add(new C0822Ob(this, 0.5d, -1.0d, 2.0d, true));
        list.add(new C0821Oa(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A04 = new C1283cZ(list, bundle.getBundle(A0G(6, 16, 29)), this.A08);
            this.A01 = bundle.getInt(A0G(57, 18, 2));
            this.A00 = bundle.getInt(A0G(39, 18, 44));
        } else {
            this.A04 = new C1283cZ(list, this.A08);
        }
        this.A09 = new Q5(new Handler(), this);
    }

    public OI(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, InterfaceC0872Pz interfaceC0872Pz, List<C2A> list, String str, boolean z, Q4 q4) {
        this(c1075Xy, interfaceC0703Jh, interfaceC0872Pz, list, str, z, null, q4);
    }
    ...
    private final void A0P(int i, boolean z, boolean z2) {
        ...
        if (i > i2) {
            ...
            if (z2 || i - this.A00 >= 5000) {
                InterfaceC0703Jh interfaceC0703Jh = this.A06;
                String str = this.A0B;
                ...
                interfaceC0703Jh.A9R(str, mapA0K);
                this.A00 = this.A01;
                this.A04.A05();
                return;
            }
