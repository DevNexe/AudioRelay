...
public class WP implements DV, InterfaceC0542Cl {
    ...
    public final void A01(C0679Ij c0679Ij) {
        c0679Ij.A0Z(1);
        int iA0G = c0679Ij.A0G() / 18;
        this.A02 = new long[iA0G];
        this.A03 = new long[iA0G];
        for (int i = 0; i < iA0G; i++) {
            this.A02[i] = c0679Ij.A0L();
            ...
            this.A03[i] = c0679Ij.A0L();
            c0679Ij.A0Z(2);
        }
    }

    @Override // com.facebook.ads.redexgen.X.DV
    public final InterfaceC0542Cl A4S() {
        return this;
    }
    ...
    public final C0541Ck A7O(long j) {
        int iA0B = C0695Iz.A0B(this.A02, this.A04.A04(j), true, true);
        long seekTimeUs = this.A04.A03(this.A02[iA0B]);
        C0543Cm c0543Cm = new C0543Cm(seekTimeUs, this.A00 + this.A03[iA0B]);
        if (seekTimeUs < j) {
            long[] jArr = this.A02;
            if (iA0B != jArr.length - 1) {
                long jA03 = this.A04.A03(jArr[iA0B + 1]);
                long secondSeekTimeUs = this.A00;
                return new C0541Ck(c0543Cm, new C0543Cm(jA03, secondSeekTimeUs + this.A03[iA0B + 1]));
            }
        }
    ...
    public final long AF1(long j) {
        ...
        this.A01 = this.A02[C0695Iz.A0B(this.A02, jA04, true, true)];
        return jA04;
    }
}
