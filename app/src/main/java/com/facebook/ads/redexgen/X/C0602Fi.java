...
public final class C0602Fi extends AbstractC1335dQ {
    ...
    private void A0A(boolean z) {
        if (this.A06 == EnumC0736Kq.A0C) {
            A0C(z);
            return;
        }
        EnumC0736Kq enumC0736Kq = this.A06;
        String[] strArr = A0E;
        ...
        if (enumC0736Kq == EnumC0736Kq.A0B) {
            A0B(z);
        } else {
            A0C(z);
        }
    ...
    private void A0B(boolean z) {
        ...
        boolean z2 = JR.A1U(this.A04) && C03735g.A0A(this.A03.A0d());
        if (z2) {
            C03735g c03735g = new C03735g(c7u, this.A03.A0d(), this.A03.A0Y(), this.A03.A0Z(), z2, new C1341dW(this));
            C0711Jp funnelLoggingHandler = new C0711Jp(this.A03.A0U(), this.A04.A08());
            c7u.A0d(funnelLoggingHandler);
            c03735g.A0B();
            return;
        }
        C02791n.A02(this.A04, this.A03, z, new C1340dV(this));
    }

    private void A0C(boolean isUnifiedAssetsLoaderEnabled) {
        C7U c7u = new C7U(this.A04);
        c7u.A0d(this.A05);
        boolean z = JR.A1U(this.A04) && C03735g.A0A(this.A03.A0d());
        boolean zA0r = this.A03.A0r();
        if (z) {
            new C03735g(c7u, this.A03.A0d(), this.A03.A0Y(), this.A03.A0Z(), z, new C1343dY(this, zA0r)).A0B();
            return;
        }
        C1324dF c1324dF = (C1324dF) this.A03;
        if (TextUtils.isEmpty(c1324dF.A0O().A0D().A08())) {
            this.A01.ACF(this, AdError.INTERNAL_ERROR);
        } else {
            C02801o.A02(this.A04, c7u, c1324dF);
            c7u.A0W(new C0609Fp(this, isUnifiedAssetsLoaderEnabled, zA0r, c1324dF, this), new C7N(c1324dF.A0Z(), A04(144, 14, 91)));
        }
    }

    @Override // com.facebook.ads.redexgen.X.AbstractC1335dQ
    ...
    public final boolean A0F() {
        ...
        String strA03 = C0864Pr.A03(super.A02, this.A0B, this.A08);
        ...
        try {
            ...
            this.A04.A06().A8y(A04(23, 11, 115), C04578z.A01, new AnonymousClass90(cause2));
        }
        String[] strArr = A0E;
        if (strArr[1].length() != strArr[0].length()) {
            throw new RuntimeException();
    ...
    public final void A0G(C1075Xy c1075Xy, AnonymousClass14 anonymousClass14, C02821q c02821q, boolean z, @Nullable String str, @Nullable String str2) {
        this.A0C.set(false);
        this.A04 = c1075Xy;
        this.A01 = anonymousClass14;
        this.A0A = c02821q.A02();
        this.A00 = c02821q.A00();
        this.A09 = str2;
        String str3 = this.A0A;
        this.A08 = str3 != null ? str3.split(A04(0, 1, 25))[0] : A04(0, 0, 20);
        this.A03 = C1324dF.A01(c02821q.A03(), this.A04);
        this.A03.A0i(str);
        this.A03.A0e(c02821q.A01().A06());
        this.A05 = new C0711Jp(this.A03.A0U(), c1075Xy.A08());
        if (this.A03.A0r()) {
            this.A06 = EnumC0736Kq.A05;
            if (this.A03.A0o()) {
                C0R c0rA0D = this.A04.A0D();
                EnumC02430c enumC02430c = EnumC02430c.A04;
                String[] strArr = A0E;
                if (strArr[7].charAt(31) != strArr[6].charAt(31)) {
                    ...
                    c0rA0D.AEj(enumC02430c);
                }
                throw new RuntimeException();
            }
            this.A04.A0D().AEj(EnumC02430c.A06);
        ...
        if (iA0J == 0) {
            this.A06 = EnumC0736Kq.A0C;
            C1075Xy c1075Xy2 = this.A04;
            String[] strArr3 = A0E;
            if (strArr3[4].charAt(5) != strArr3[5].charAt(5)) {
                ...
                c1075Xy2.A0D().AEj(EnumC02430c.A09);
            }
            throw new RuntimeException();
        }
        if (iA0J == 1) {
            this.A06 = EnumC0736Kq.A0B;
            this.A04.A0D().AEj(EnumC02430c.A08);
        }
        this.A02 = new AnonymousClass15(this.A0B, this, anonymousClass14);
        A06();
        A0A(z);
