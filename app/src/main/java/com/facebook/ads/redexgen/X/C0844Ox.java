...
public final class C0844Ox {
    ...
    public C0844Ox(String str, String str2, int i) {
        String strA01;
        this.A02 = str;
        this.A00 = i;
    ...
    public final void A04(int i, String str) {
        ...
        if (c1074XxA00 != null) {
            InterfaceC04568y interfaceC04568yA06 = c1074XxA00.A06();
            String[] strArr = A04;
            if (strArr[2].charAt(28) == strArr[4].charAt(28)) {
                throw new RuntimeException();
            }
            A04[1] = "oo4WYpYrHyZLXSXdo0EivsHVHotPm1t3";
            interfaceC04568yA06.A8y(A01(83, 3, 77), i, A00(str));
        }
    }
}
