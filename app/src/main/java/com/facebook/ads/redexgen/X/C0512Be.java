...
public final class C0512Be {
    ...
    public boolean A0L;
    public boolean A0M;
    public final InterfaceC0510Bc A0N;
    ...
    public C0512Be(InterfaceC0510Bc interfaceC0510Bc) {
        this.A0N = (InterfaceC0510Bc) IK.A01(interfaceC0510Bc);
        if (C0695Iz.A02 >= 18) {
            try {
    ...
    public final void A0G(AudioTrack audioTrack, int i, int i2, int i3) {
        ...
        this.A02 = i2;
        this.A00 = i3;
        this.A0I = new C0509Bb(audioTrack);
        this.A03 = audioTrack.getSampleRate();
        this.A0M = A0A(i);
        this.A0L = C0695Iz.A0c(i);
    ...
    public final boolean A0L(long j) {
        InterfaceC0510Bc interfaceC0510Bc;
        int playState = this.A0H.getPlayState();
        if (this.A0M) {
            if (playState == 2) {
                this.A0K = false;
        ...
        boolean z = this.A0K;
        this.A0K = A0J(j);
        if (z && !this.A0K && playState != 1 && (interfaceC0510Bc = this.A0N) != null) {
            interfaceC0510Bc.ACc(this.A00, AG.A01(this.A05));
        }
        return true;
    }
}
