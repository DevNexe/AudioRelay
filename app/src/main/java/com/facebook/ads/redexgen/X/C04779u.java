...
public final class C04779u {
    ...
    public final synchronized C9l A06(int i, byte[] bArr, int i2, int[] iArr, int i3) throws IOException {
        ...
        int i6 = 0;
        long j = -1;
        while (i5 < c04769tA00.A00) {
            if ((i5 - i) + i3 >= iArr.length) {
                z = true;
                break;
            }
            long j2 = c04769tA00.A03[i5];
            long j3 = (i5 == c04769tA00.A00 - i4 ? c04769tA00.A01 : c04769tA00.A03[i5 + 1]) - j2;
            if (j == -1) {
                j = j2;
            }
        ...
        if (i5 <= i) {
            return new C9l(z ? EnumC04689k.A03 : EnumC04689k.A04, i, i, 0);
        }
        c04769tA00.A02.seek(j);
        c04769tA00.A02.read(bArr, i2, i6);
        return new C9l(EnumC04689k.A02, i, i5, i6);
    }
    ...
    public final synchronized boolean A09(byte[] bArr) throws IOException {
        ...
        A03(c04769tA00.A00, c04769tA00.A01);
        A04(c04769tA00.A01, bArr);
        c04769tA00.A02.getFD().sync();
        c04769tA00.A00++;
        c04769tA00.A01 += (long) bArr.length;
        return true;
    }
    ...
    public C04779u(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C04769t.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 30), file.getCanonicalPath()));
        }
    }

    private C04769t A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C04769t.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i, long j) throws IOException {
        this.A00.A03[i] = j;
        this.A00.A02.seek(C04769t.A02(i));
