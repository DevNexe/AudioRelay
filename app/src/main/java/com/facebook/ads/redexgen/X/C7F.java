...
public final class C7F {
    ...
    public C7F(Context context, EnumC04176z enumC04176z, @Nullable String str) {
        try {
            A04(context);
            if (enumC04176z.A04() == EnumC04176z.A0G.A04()) {
                A05(context, str);
            }
        } catch (Throwable th) {
            C6O.A03(th);
    ...
    public static C7F A00(Context context, EnumC04176z enumC04176z, @Nullable String str) {
        if (A01 == null) {
            A01 = new C7F(context, enumC04176z, str);
        }
        return A01;
    }
