...
public final class A9 extends AbstractC0947Sw implements N7 {
    ...
    @Nullable
    public AbstractC0784Mp A03;
    public C0863Pq A04;

    @Nullable
    public IT A05;
    public boolean A06;
    public final InterfaceC0785Mq A07;
    public final OT A08;
    public final OU A09;
    public final QK A0A;
    public final C0693Ix A0B;
    ...
    public A9(C0830Oj c0830Oj) {
        super(c0830Oj, false);
        this.A0C = new AtomicBoolean(false);
        this.A06 = false;
        this.A02 = c0830Oj.A05();
        this.A03 = c0830Oj.A08();
        ...
        A04();
        this.A07 = c0830Oj.A09();
        C0824Od.A00(c0830Oj.A05(), this, getAdInfo().A0D().A07());
        this.A0A = A00(c0830Oj);
        getAdDetailsView().bringToFront();
        this.A0B = A01(c0830Oj);
        A0f();
        this.A04 = new C0863Pq(this.A02, c0830Oj.A06(), getAdDataBundle());
        this.A08 = new C0945Su(this);
        this.A09 = new OU(c0830Oj, getAdDataBundle(), this.A0A, this.A0B, getAdDetailsView(), this.A07, this.A08);
    }

    private QK A00(C0830Oj c0830Oj) {
        QK qk = (QK) c0830Oj.A02();
        int iA0e = A0e(c0830Oj.A08());
        ImageView imageView = (ImageView) c0830Oj.A03();
        imageView.setPadding(AbstractC0947Sw.A0D, AbstractC0947Sw.A0D, AbstractC0947Sw.A0D, AbstractC0947Sw.A0D);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC0947Sw.A0E, AbstractC0947Sw.A0E);
        layoutParams.setMargins(0, iA0e, AbstractC0947Sw.A0C, 0);
    ...
    private C0693Ix A01(C0830Oj c0830Oj) {
        C0693Ix c0693IxA0A = c0830Oj.A0A();
        c0693IxA0A.A06(-1, AbstractC0947Sw.A09);
        c0693IxA0A.setPadding(AbstractC0947Sw.A0H, AbstractC0947Sw.A0H, AbstractC0947Sw.A0H, AbstractC0947Sw.A0H);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0947Sw.A0G);
        layoutParams.addRule(12);
        addView(c0693IxA0A, layoutParams);
        return c0693IxA0A;
    }
    ...
    private void A04() {
        AbstractC0784Mp abstractC0784Mp = this.A03;
        if (abstractC0784Mp == null) {
            return;
        }
        this.A05 = new IT(abstractC0784Mp, 400, -abstractC0784Mp.getToolbarHeight(), 0);
    }

    private void A05() {
        new C0711Jp(getAdDataBundle().A0U(), getAdEventManager()).A02(EnumC0710Jo.A0r, null);
        if (!getAdInfo().A0O()) {
            return;
        }
        this.A0C.set(true);
        ...
        Pair<EnumC0862Pp, View> pairA03 = c0863Pq.A03(ctaButton);
        this.A00 = (View) pairA03.second;
        int i = C0831Ok.A00[((EnumC0862Pp) pairA03.first).ordinal()];
        if (i == 1) {
        ...
        layoutParams.setMargins(AbstractC0947Sw.A0F, AbstractC0947Sw.A0F, AbstractC0947Sw.A0F, AbstractC0947Sw.A0F);
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0947Sw, com.facebook.ads.redexgen.X.AbstractC0826Of
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0947Sw
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0947Sw, com.facebook.ads.redexgen.X.AbstractC0826Of, android.view.View
