...
public final class TG extends NN {
    ...
    public TG(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, String str) {
    ...
    public final void A0L() {
        this.A00.setImageBitmap(C0770Mb.A01(EnumC0769Ma.CROSS));
        this.A00.setOnClickListener(new ViewOnClickListenerC0801Ng(this));
        this.A00.setContentDescription(A0B(4, 18, 29));
        NR nr = new NR(this.A04);
        nr.setData(this.A03.A0H(), EnumC0769Ma.HIDE_AD);
        nr.setOnClickListener(new ViewOnClickListenerC0802Nh(this, nr));
        NR nr2 = new NR(this.A04);
        nr2.setData(this.A03.A0L(), EnumC0769Ma.REPORT_AD);
        nr2.setOnClickListener(new ViewOnClickListenerC0803Ni(this, nr2));
        NR nr3 = new NR(this.A04);
        nr3.setData(this.A03.A0M(), EnumC0769Ma.AD_CHOICES_ICON);
        nr3.setOnClickListener(new ViewOnClickListenerC0804Nj(this, nr3));
    ...
    public final void A0N(C2H c2h, C2F c2f) {
        String strA0H;
        EnumC0769Ma enumC0769Ma;
        int i;
        this.A00.setOnClickListener(null);
        if (c2f == C2F.A05) {
            strA0H = this.A03.A0F();
            enumC0769Ma = EnumC0769Ma.REPORT_AD;
            i = -552389;
        } else {
            strA0H = this.A03.A0H();
            enumC0769Ma = EnumC0769Ma.HIDE_AD;
            i = -13272859;
        }
        NM nmA0M = new NL(this.A04, this.A0B).A0I(strA0H).A0H(this.A03.A0D()).A0F(c2h.A04()).A0K(false).A0E(enumC0769Ma).A0D(i).A0L(false).A0J(false).A0M();
    ...
    public final void A0O(C2H c2h, C2F c2f) {
        C0800Nf c0800Nf = new C0800Nf(this.A04, c2h, this.A0B, c2f == C2F.A05 ? EnumC0769Ma.REPORT_AD : EnumC0769Ma.HIDE_AD);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, 0);
        layoutParams.gravity = 17;
        layoutParams.weight = 1.0f;
        this.A00.setImageBitmap(C0770Mb.A01(EnumC0769Ma.BACK_ARROW));
        this.A00.setOnClickListener(new ViewOnClickListenerC0805Nk(this));
        this.A00.setContentDescription(A0B(0, 4, 64));
        MS.A0T(this.A01);
        this.A02.fullScroll(33);
        this.A01.removeAllViews();
        this.A01.addView(this.A00);
        this.A01.addView(c0800Nf, layoutParams);
    }
