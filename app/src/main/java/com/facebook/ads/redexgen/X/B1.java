...
public abstract class B1 {
    ...
    public abstract C0507Az A0A(int i, C0507Az c0507Az, boolean z);
    ...
    public final int A03(int nextWindowIndex, C0507Az c0507Az, B0 b0, int i, boolean z) {
        int i2 = A09(nextWindowIndex, c0507Az).A00;
    ...
    public final Pair<Integer, Long> A07(B0 b0, C0507Az c0507Az, int i, long j) {
        return A08(b0, c0507Az, i, j, 0L);
    }

    public final Pair<Integer, Long> A08(B0 b0, C0507Az c0507Az, int i, long j, long j2) {
        IK.A00(i, 0, A01());
        A0D(i, b0, false, j2);
        ...
        while (jA07 != -9223372036854775807L) {
            ...
            jA03 -= jA07;
            i2++;
            jA07 = A09(i2, c0507Az).A07();
        }
        return Pair.create(Integer.valueOf(i2), Long.valueOf(jA03));
    }

    public final C0507Az A09(int i, C0507Az c0507Az) {
        return A0A(i, c0507Az, false);
    }
    ...
    public final boolean A0F(int i, C0507Az c0507Az, B0 b0, int i2, boolean z) {
        return A03(i, c0507Az, b0, i2, z) == -1;
    }
}
