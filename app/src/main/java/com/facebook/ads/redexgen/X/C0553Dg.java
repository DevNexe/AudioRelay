...
public final class C0553Dg implements InterfaceC1027Wc {
    ...
    public C0553Dg(long[] jArr, long[] jArr2, long j) {
        this.A02 = jArr;
        this.A01 = jArr2;
        this.A00 = j;
    }

    public static C0553Dg A00(long durationUs, long j, Ci ci, C0679Ij c0679Ij) {
        int iA0E;
        long position = j;
        c0679Ij.A0Z(10);
        ...
        int i = ci.A03;
        long jA0F = C0695Iz.A0F(iA08, 1000000 * ((long) (i >= 32000 ? 1152 : 576)), i);
        int iA0I = c0679Ij.A0I();
        int iA0I2 = c0679Ij.A0I();
        int iA0I3 = c0679Ij.A0I();
        c0679Ij.A0Z(2);
        int scale = ci.A02;
        ...
        return new C0553Dg(jArr, jArr2, jA0F);
    }
    ...
    public final C0541Ck A7O(long j) {
        int iA0B = C0695Iz.A0B(this.A02, j, true, true);
        C0543Cm c0543Cm = new C0543Cm(this.A02[iA0B], this.A01[iA0B]);
        if (c0543Cm.A01 < j) {
            long[] jArr = this.A02;
            if (iA0B != jArr.length - 1) {
                return new C0541Ck(c0543Cm, new C0543Cm(jArr[iA0B + 1], this.A01[iA0B + 1]));
            }
        }
    ...
    public final long A7e(long j) {
        return this.A02[C0695Iz.A0B(this.A01, j, true, true)];
    }
