...
public final class C03845r {
    ...
    public C03845r(C8U c8u) {
        this.A00 = c8u.getSharedPreferences(ProcessUtils.getProcessSpecificName(A00(33, 21, 63), c8u), 0);
    }

    public final C03835q A02() {
        SharedPreferences sharedPreferences = this.A00;
        String strA00 = A00(0, 13, 40);
        if (sharedPreferences.contains(strA00)) {
            return new C03835q(this.A00.getString(strA00, A00(0, 0, 80)), this.A00.getBoolean(A00(54, 15, 31), false), EnumC03825p.A09, this.A00.getLong(A00(26, 7, 80), -1L));
        }
        return C03835q.A00();
    }
    ...
    public final void A04(C03835q c03835q) {
        SharedPreferences.Editor editorEdit = this.A00.edit();
        editorEdit.putString(A00(0, 13, 40), c03835q.A03());
        editorEdit.putBoolean(A00(54, 15, 31), c03835q.A04());
        editorEdit.putLong(A00(26, 7, 80), c03835q.A01());
        editorEdit.apply();
    }
