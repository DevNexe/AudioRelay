...
public final class C0863Pq {
    ...
    public C0863Pq(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, AnonymousClass18 anonymousClass18) {
        this.A04 = c1075Xy;
        this.A05 = new C0711Jp(anonymousClass18.A0U(), interfaceC0703Jh);
    ...
    private View A00() {
        ...
        f9.setLayoutManager(new C1263cB(this.A04, 0, false));
        f9.setAdapter(new C0920Rv(this.A04, this.A02.A00(), A09));
        return f9;
    }

    private View A01(@Nullable T1 t1) {
        C0823Oc c0823Oc = new C0823Oc(this.A04, this.A00.A01(), true, false, false);
        c0823Oc.A01(this.A01.A06(), this.A01.A01(), null, false, true);
        ...
        linearLayout.addView(c0823Oc, layoutParams);
        if (t1 != null) {
            MS.A0J(t1);
    ...
    private final EnumC0862Pp A02() {
        if (!this.A02.A00().isEmpty()) {
            return EnumC0862Pp.A04;
        }
        EnumC0862Pp enumC0862Pp = EnumC0862Pp.A03;
        String[] strArr = A06;
    ...
    public final Pair<EnumC0862Pp, View> A03(@Nullable T1 t1) {
        View viewA00;
        EnumC0862Pp enumC0862PpA02 = A02();
        if (C0861Po.A00[enumC0862PpA02.ordinal()] != 1) {
            viewA00 = A01(t1);
        } else {
            viewA00 = A00();
        }
        C0713Jr.A04(viewA00, this.A05, EnumC0710Jo.A0S);
        return new Pair<>(enumC0862PpA02, viewA00);
    }
}
