...
public enum EnumC0765Lw {
    ...
    EnumC0765Lw(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0765Lw A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC0765Lw enumC0765Lw : values()) {
            if (enumC0765Lw.A01 == nativeComponentTag) {
                return enumC0765Lw;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0765Lw enumC0765LwA00 = A00(nativeComponentTag);
        if (view != null && enumC0765LwA00 != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0765Lw enumC0765Lw) {
        if (view != null && enumC0765Lw != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0765Lw);
        }
    }
