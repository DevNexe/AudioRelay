...
public final class C0946Sv extends AbstractC0826Of {
    public C0946Sv(C0830Oj c0830Oj, boolean z) {
        super(c0830Oj, true);
        RelativeLayout relativeLayout = new RelativeLayout(c0830Oj.A05());
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(12);
        MS.A0R(relativeLayout, getAdContextWrapper());
        LinearLayout linearLayout = new LinearLayout(c0830Oj.A05());
        linearLayout.setOrientation(!z ? 1 : 0);
        linearLayout.setGravity(80);
        MS.A0K(linearLayout);
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams2.setMargins(AbstractC0826Of.A08, 0, AbstractC0826Of.A08, AbstractC0826Of.A08);
        LinearLayout.LayoutParams layoutParams3 = new LinearLayout.LayoutParams(z ? -2 : -1, -2);
        layoutParams3.setMargins(z ? AbstractC0826Of.A08 : 0, z ? 0 : AbstractC0826Of.A08, 0, 0);
