...
public final class C0519Bl {
    ...
    public static Format A03(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        int i;
        C0678Ii c0678IiA04 = A04(bArr);
        c0678IiA04.A08(60);
        int i2 = A02[c0678IiA04.A04(6)];
        int i3 = A03[c0678IiA04.A04(4)];
        int rate = c0678IiA04.A04(5);
        int[] iArr = A04;
        if (rate >= iArr.length) {
            i = -1;
        } else {
            int bitrate = iArr[rate];
            i = (bitrate * AdError.NETWORK_ERROR_CODE) / 2;
        }
        c0678IiA04.A08(10);
        int bitrate2 = c0678IiA04.A04(2);
        int bitrate3 = bitrate2 > 0 ? 1 : 0;
        return Format.A07(str, A05(0, 13, 1), null, i, -1, i2 + bitrate3, i3, null, drmInitData, 0, str2);
    }

    public static C0678Ii A04(byte[] bArr) {
        if (bArr[0] == 127) {
            return new C0678Ii(bArr);
        }
        ...
        C0678Ii c0678Ii = new C0678Ii(bArrCopyOf);
        if (bArrCopyOf[0] == 31) {
            C0678Ii c0678Ii2 = new C0678Ii(bArrCopyOf);
            while (true) {
                int iA01 = c0678Ii2.A01();
                if (A01[5].charAt(2) == 'T') {
                    throw new RuntimeException();
                }
                ...
                if (iA01 >= 16) {
                    c0678Ii2.A08(2);
                    c0678Ii.A0A(c0678Ii2.A04(14), 14);
                }
            }
        }
        c0678Ii.A0B(bArrCopyOf);
        return c0678Ii;
    }
