...
public final class C02640y extends BroadcastReceiver {
    ...
    public C02640y(C1075Xy c1075Xy, String str, C1347dc c1347dc, InterfaceC02630x interfaceC02630x) {
        this.A02 = c1075Xy;
        this.A03 = str;
        this.A01 = interfaceC02630x;
        this.A00 = c1347dc;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (A00(252, 39, 46).equals(str)) {
            InterfaceC02630x interfaceC02630x = this.A01;
            C1347dc c1347dc = this.A00;
            if (A05[3].charAt(4) != 'D') {
                A05[0] = "TqpNublq1V6zWfVafs4QLB";
                interfaceC02630x.AB3(c1347dc);
                return;
            } else {
        ...
        InterfaceC02630x interfaceC02630x3 = this.A01;
        if (A05[7].charAt(0) != 'P') {
            throw new RuntimeException();
        }
        A05[0] = "2dNMpRkIvORsTqY7tSIXPx";
        interfaceC02630x3.AB8();
    }
}
