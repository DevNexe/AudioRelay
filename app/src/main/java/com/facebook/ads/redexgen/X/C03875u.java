...
public final class C03875u {
    ...
    public static C03865t A00(ContentResolver contentResolver) {
        String strA01 = A01(72, 14, 36);
        String strA02 = A01(3, 9, 127);
        String strA03 = A01(0, 3, 122);
        Cursor cursor = null;
        try {
            Cursor cursorQuery = contentResolver.query(C0745La.A00(A01(12, 60, 38)), new String[]{strA03, strA02, strA01}, null, null, null);
            if (cursorQuery == null || !cursorQuery.moveToFirst()) {
                C03865t c03865t = new C03865t(null, null, false);
                if (cursorQuery != null) {
                    cursorQuery.close();
                }
                return c03865t;
            }
            String string = cursorQuery.getString(cursorQuery.getColumnIndex(strA03));
            String advertisingId = cursorQuery.getString(cursorQuery.getColumnIndex(strA02));
            C03865t c03865t2 = new C03865t(string, advertisingId, Boolean.valueOf(cursorQuery.getString(cursorQuery.getColumnIndex(strA01))).booleanValue());
            cursorQuery.close();
            return c03865t2;
        } catch (Throwable th) {
            if (0 != 0) {
