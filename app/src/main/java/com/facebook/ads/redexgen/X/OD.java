...
public final class OD extends FrameLayout {
    ...
    public OD(C1075Xy c1075Xy, AttributeSet attributeSet) {
        super(c1075Xy, attributeSet);
        this.A03 = new ImageView(c1075Xy, attributeSet);
        this.A02 = new ImageView(c1075Xy, attributeSet);
        A00();
    }

    public OD(C1075Xy c1075Xy, AttributeSet attributeSet, int i) {
        super(c1075Xy, attributeSet, i);
        this.A03 = new ImageView(c1075Xy, attributeSet, i);
        this.A02 = new ImageView(c1075Xy, attributeSet, i);
        A00();
    }

    @TargetApi(21)
    public OD(C1075Xy c1075Xy, AttributeSet attributeSet, int i, int i2) {
        super(c1075Xy, attributeSet, i, i2);
        this.A03 = new ImageView(c1075Xy, attributeSet, i, i2);
        this.A02 = new ImageView(c1075Xy, attributeSet, i, i2);
        A00();
    }
