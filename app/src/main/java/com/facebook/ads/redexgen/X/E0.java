...
public final class E0 {
    ...
    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0695Iz.A02 >= 21 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0695Iz.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public final Point A0E(int widthAlignment, int heightAlignment) {
        ...
        return new Point(C0695Iz.A04(widthAlignment, widthAlignment2) * widthAlignment2, C0695Iz.A04(heightAlignment, heightAlignment2) * heightAlignment2);
    }
    ...
    public final boolean A0I(String codecMimeType) {
        String strA05;
        if (codecMimeType == null || this.A01 == null || (strA05 = C0672Ic.A05(codecMimeType)) == null) {
            return true;
        }
