...
public final class AnonymousClass67 {
    ...
    @VisibleForTesting
    public final M3 A02 = new M3(300000000000L, new C1207bG(this));
    ...
    public static C9R A00(C1074Xx c1074Xx) {
        if (JR.A0v(c1074Xx)) {
    ...
    public void A02() {
        ...
        String strA7Z = C9U.A00().A01(c1074Xx, true).A7Z(A00(c1074Xx));
        synchronized (this) {
            this.A01 = strA7Z;
        }
    }
    ...
    public final synchronized String A06(C1074Xx c1074Xx) {
        this.A00 = c1074Xx;
        this.A00.A06().A9W();
