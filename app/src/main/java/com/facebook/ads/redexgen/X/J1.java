...
public final class J1 {
    ...
    public static J1 A00(C0679Ij c0679Ij) throws C0488Af {
        try {
            c0679Ij.A0Z(4);
            int iA0E = (c0679Ij.A0E() & 3) + 1;
            if (iA0E != 3) {
                ArrayList arrayList = new ArrayList();
                int numSequenceParameterSets = c0679Ij.A0E() & 31;
                for (int j = 0; j < numSequenceParameterSets; j++) {
                    arrayList.add(A03(c0679Ij));
                }
                ...
                if (numSequenceParameterSets > 0) {
                    ...
                    C0674Ie c0674IeA06 = C0675If.A06(bArr2, iA0E, height);
                    i = c0674IeA06.A06;
                    i2 = c0674IeA06.A02;
                    f = c0674IeA06.A00;
                }
            ...
            throw new C0488Af(A01(0, 24, 119), e);
        }
    }

    public static byte[] A03(C0679Ij c0679Ij) {
        int offset = c0679Ij.A0I();
        int iA06 = c0679Ij.A06();
        c0679Ij.A0Z(offset);
        return IO.A08(c0679Ij.A00, iA06, offset);
    }
}
