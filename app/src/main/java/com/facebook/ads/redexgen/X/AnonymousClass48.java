...
public class AnonymousClass48 {
    ...
    public List<AbstractC03524l> A08 = null;
    ...
    public final View A03(C03424b c03424b) {
        if (this.A08 != null) {
            return A00();
        }
        View viewA0G = c03424b.A0G(this.A01);
        this.A01 += this.A03;
        return viewA0G;
    }
    ...
    public final boolean A05(C03494i c03494i) {
        int i = this.A01;
        return i >= 0 && i < c03494i.A03();
    }
}
