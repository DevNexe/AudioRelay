...
public enum EnumC0706Jk {
    ...
    A0N(A01(635, 25, 113)),
    A0O(A01(660, 20, 107)),
    A0F(A01(AdRequest.MAX_CONTENT_URL_LENGTH, 37, 57)),
    A0E(A01(RCHTTPStatusCodes.ERROR, 12, 14)),
    A0Q(A01(694, 5, 109)),
    A0J(A01(576, 16, 59)),
    A0K(A01(592, 9, 70)),
    A0G(A01(549, 11, 57)),
    ...
    EnumC0706Jk(String str) {
        this.A00 = str;
    }

    public static EnumC0706Jk A00(String str) {
        for (EnumC0706Jk enumC0706Jk : values()) {
            if (enumC0706Jk.A00.equalsIgnoreCase(str)) {
                return enumC0706Jk;
            }
        }
        String[] strArr = A02;
