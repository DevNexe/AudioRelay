...
public final class C5L implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0754Lj A0C = new F2(this);
    public final AbstractC0768Lz A0B = new F1(this);
    public final AbstractC0742Kx A0E = new C0592Ey(this);
    public final N6 A09 = new C0590Ew(this);
    public final AbstractC0724Kc A0F = new C0582Eo(this);
    public final N4 A0A = new C0581En(this);
    ...
    public final void A04(NativeAd nativeAd) {
        ...
        C1345da adapter = UB.A0L(nativeAd.getInternalNativeAd()).A0y();
        if (adapter != null) {
    ...
    public final void A05(InterfaceC0703Jh interfaceC0703Jh) {
        this.A05.setAdEventManager(interfaceC0703Jh);
    }
    ...
    public final void A07(@Nullable InterfaceC0793My interfaceC0793My) {
        this.A05.setListener(interfaceC0793My);
    }
    ...
    public final void engageSeek() {
        if (this.A06) {
            ...
            this.A06 = true;
            this.A07 = EnumC0892Qt.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (initializationType == 0) {
            this.A05 = new C0494Al(c1075XyA02);
        } else if (initializationType == 1) {
            this.A05 = new C0494Al(c1075XyA02, adViewConstructorParams.getAttributeSet());
        } else if (initializationType == 2) {
            this.A05 = new C0494Al(c1075XyA02, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
        } else if (initializationType == 3) {
            this.A05 = new C0494Al(c1075XyA02, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
        } else {
    ...
    public final boolean shouldAutoplay() {
        C0494Al c0494Al = this.A05;
        if (c0494Al == null || c0494Al.getState() == EnumC0892Qt.A06) {
            return false;
        }
