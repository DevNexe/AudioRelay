...
public final class P2 extends FrameLayout {
    ...
    public final C1075Xy A07;
    public final C0711Jp A08;
    public final InterfaceC0785Mq A09;
    public final NI A0A;
    public final P1 A0B;
    public final C0870Px A0C;
    public final QK A0D;
    public final AnonymousClass89 A0E;
    public final N6 A0F;
    public final N4 A0G;
    public final AbstractC0768Lz A0H;
    public final AbstractC0754Lj A0I;
    public final L4 A0J;
    public final L3 A0K;
    ...
    public P2(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, AnonymousClass18 anonymousClass18, C7U c7u, C0711Jp c0711Jp, InterfaceC0785Mq interfaceC0785Mq, NI ni, P1 p1) {
        super(c1075Xy);
        ...
        this.A0I = new AbstractC0754Lj() { // from class: com.facebook.ads.redexgen.X.9s
            public static byte[] A01;
        ...
        this.A0H = new AbstractC0768Lz() { // from class: com.facebook.ads.redexgen.X.9n
            public static byte[] A01;
        ...
        this.A0F = new N6() { // from class: com.facebook.ads.redexgen.X.9G
            ...
            public final void A03(AnonymousClass88 anonymousClass88) {
                ...
                P1 p2 = this.A00.A0B;
                P2 p3 = this.A00;
                p2.ACj(A00(0, 9, 100), p3.A04(p3.A0D.getDuration()));
            }
        };
        ...
        this.A06 = c7u;
        this.A08 = c0711Jp;
        this.A09 = interfaceC0785Mq;
        this.A0A = ni;
        this.A0D = new QK(c1075Xy);
        this.A0B = p1;
        this.A0D.setFunnelLoggingHandler(c0711Jp);
        this.A0D.getEventBus().A03(this.A0J, this.A0I, this.A0H, this.A0K, this.A0F, this.A0G);
        this.A0E = new AnonymousClass89(c1075Xy, interfaceC0703Jh, this.A0D, anonymousClass18.A0U());
        if (JR.A1J(this.A07)) {
            this.A0C = new C0870Px(c1075Xy, interfaceC0703Jh, this.A0D, anonymousClass18.A0U(), null);
        } else {
            this.A0C = null;
        }
        A0B();
        ...
        if (!TextUtils.isEmpty(strA07)) {
            C0824Od.A00(c1075Xy, this, strA07);
        }
    ...
    private void A08() {
        this.A0D.postDelayed(new C0925Sa(this), JR.A0I(this.A07));
    }
    ...
    private void A0B() {
        if (!TextUtils.isEmpty(this.A05.A0O().A0D().A07())) {
            C04267m c04267m = new C04267m(this.A07);
            this.A0D.A0c(c04267m);
            c04267m.setImage(this.A05.A0O().A0D().A07());
        }
        C04076p c04076p = new C04076p(this.A07, true, this.A08);
        this.A0D.A0c(c04076p);
        this.A0D.A0c(new KT(c04076p, QJ.A03, true));
        this.A0D.A0c(new C04207c(this.A07));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0H(AnonymousClass84 anonymousClass84) {
        if (this.A0D.getState() == EnumC0892Qt.A02 && JR.A11(this.A07)) {
    ...
    public void A0I(String str) {
        ...
        InterfaceC0785Mq interfaceC0785Mq = this.A09;
        NI ni = this.A0A;
        String[] strArr = A0M;
    ...
    public final void A0T(boolean z) {
        if (this.A0D.A0j() || this.A02 || this.A0D.getState() == EnumC0892Qt.A06 || this.A00 == null) {
            return;
        }
        boolean z2 = this.A01;
        if (A0M[7].charAt(5) == 'u') {
