...
public final class GW implements RX {
    ...
    public final RZ A01;
    public final RW A02;
    public final InterfaceC0901Rc A03;
    ...
    public GW(RW rw, InterfaceC0901Rc interfaceC0901Rc) {
        this.A02 = rw;
        this.A03 = interfaceC0901Rc;
    ...
    public final synchronized void A5S(int i) {
        long jA4f = this.A03.A4f() + (((long) i) * 1000000 * ((long) (A04 ? 1 : AdError.NETWORK_ERROR_CODE)));
