...
public final class Ee {
    ...
    public final List<C0575Ed> A06;
    public final boolean A07;
    public final boolean A08;
    public final boolean A09;
    public final boolean A0A;

    public Ee(long j, boolean z, boolean z2, boolean z3, List<C0575Ed> list, long j2, boolean z4, long j3, int i, int i2, int i3) {
        this.A04 = j;
        this.A0A = z;
        this.A08 = z2;
        this.A09 = z3;
    ...
    public Ee(Parcel parcel) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(C0575Ed.A00(parcel));
        }
    ...
    public static Ee A02(C0679Ij c0679Ij) {
        long jA0M = c0679Ij.A0M();
        boolean autoReturn = (c0679Ij.A0E() & 128) != 0;
        boolean z = false;
        boolean z2 = false;
        ...
        if (!autoReturn) {
            ...
            if (!z2) {
                ...
                for (int i = 0; i < iA0E3; i++) {
                    arrayList.add(new C0575Ed(c0679Ij.A0E(), c0679Ij.A0M(), null));
                }
            }
            if (z4) {
                int componentCount = c0679Ij.A0E();
                long j2 = componentCount;
                z3 = (128 & j2) != 0;
                long breakDuration90khz = ((1 & j2) << 32) | c0679Ij.A0M();
                j = (1000 * breakDuration90khz) / 90;
            }
            iA0I = c0679Ij.A0I();
            headerByte = c0679Ij.A0E();
            iA0E = c0679Ij.A0E();
        }
