...
public final class V7 implements InterfaceC0650He {
    ...
    public InterfaceC0650He A00;
    public InterfaceC0650He A01;
    public InterfaceC0650He A02;
    public InterfaceC0650He A03;
    public InterfaceC0650He A04;
    public InterfaceC0650He A05;
    public InterfaceC0650He A06;
    public final Context A07;
    public final InterfaceC0650He A08;
    public final I0<? super InterfaceC0650He> A09;
    ...
    public V7(Context context, I0<? super InterfaceC0650He> i0, InterfaceC0650He interfaceC0650He) {
        this.A07 = context.getApplicationContext();
        this.A09 = i0;
        this.A08 = (InterfaceC0650He) IK.A01(interfaceC0650He);
    }

    private InterfaceC0650He A00() {
        if (this.A00 == null) {
    ...
    private InterfaceC0650He A01() {
        if (this.A01 == null) {
            this.A01 = new VB(this.A07, this.A09);
        }
        InterfaceC0650He interfaceC0650He = this.A01;
        if (A0B[4].length() != 17) {
            throw new RuntimeException();
        }
        A0B[7] = "5KWAQaHsfffdQGrIbOe";
        return interfaceC0650He;
    }

    private InterfaceC0650He A02() {
        if (this.A02 == null) {
            this.A02 = new VA();
        }
        return this.A02;
    ...
    private InterfaceC0650He A04() {
        if (this.A05 == null) {
            this.A05 = new C0996Uu(this.A07, this.A09);
        }
        return this.A05;
    }

    private InterfaceC0650He A05() {
        if (this.A06 == null) {
            try {
                this.A06 = (InterfaceC0650He) Class.forName(A06(141, 60, 75)).getConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    public final Uri A7k() {
        InterfaceC0650He interfaceC0650He = this.A03;
        if (interfaceC0650He == null) {
            return null;
        }
        return interfaceC0650He.A7k();
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0650He
    public final long ACw(C0654Hi c0654Hi) throws IOException {
        IK.A04(this.A03 == null);
        String scheme = c0654Hi.A04.getScheme();
        if (C0695Iz.A0e(c0654Hi.A04)) {
            if (c0654Hi.A04.getPath().startsWith(A06(0, 15, 23))) {
                this.A03 = A00();
            } else {
                this.A03 = A03();
            }
            ...
            this.A03 = A00();
        } else if (A06(RCHTTPStatusCodes.CREATED, 7, 125).equals(scheme)) {
            this.A03 = A01();
