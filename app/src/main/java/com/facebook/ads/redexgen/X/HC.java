...
public final class HC {
    ...
    public static long A01(String str) throws NumberFormatException {
        long j = 0;
        String[] strArrA0m = C0695Iz.A0m(str, A02(50, 2, 102));
        for (String subpart : C0695Iz.A0l(strArrA0m[0], A02(1, 1, 3))) {
    ...
    public static void A04(C0679Ij c0679Ij) throws GZ {
        String line = c0679Ij.A0P();
