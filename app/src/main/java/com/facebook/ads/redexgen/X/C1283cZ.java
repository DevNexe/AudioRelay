...
public final class C1283cZ implements MB<Bundle> {
    public static byte[] A03;
    public final C2C A00;
    public final Q4 A01;
    public final List<C1282cY> A02;
    ...
    public final Bundle A02() {
        ...
        Iterator<C1282cY> it = this.A02.iterator();
        while (it.hasNext()) {
