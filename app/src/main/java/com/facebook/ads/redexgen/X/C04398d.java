...
public final class C04398d {
    ...
    public final C1072Xv A03 = new C1072Xv(this);
    public final C1073Xw A02 = new C1073Xw(this);
    ...
    static {
        ...
        sb.append(C1072Xv.A02.A01);
        String strA05 = A05(58, 2, 51);
        sb.append(strA05);
        String strA06 = A05(142, 6, 16);
        sb.append(strA06);
        String strA07 = A05(60, 1, 106);
        sb.append(strA07);
        sb.append(C1072Xv.A01.A01);
        sb.append(strA05);
        String strA08 = A05(136, 6, 111);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A04.A01);
        sb.append(strA05);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A05.A01);
        sb.append(strA05);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A0A.A01);
        sb.append(strA05);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A08.A01);
        sb.append(strA05);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A07.A01);
        sb.append(strA05);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A06.A01);
        sb.append(strA05);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A03.A01);
        sb.append(strA05);
        sb.append(strA08);
        sb.append(strA07);
        sb.append(C1073Xw.A02.A01);
    ...
    public C04398d(C1074Xx c1074Xx) {
        this.A01 = c1074Xx;
    }

    private synchronized SQLiteDatabase A00() {
        if (this.A00 == null) {
            final C1074Xx c1074Xx = this.A01;
            this.A00 = new SQLiteOpenHelper(c1074Xx, this) { // from class: com.facebook.ads.redexgen.X.8e
                ...
                {
                    super(c1074Xx, A01(c1074Xx), (SQLiteDatabase.CursorFactory) null, 4);
                    if (this != null) {
                        this.A00 = this;
                        return;
                    }
                ...
                public static String A01(C1074Xx c1074Xx2) {
                    ...
                    String packageName = c1074Xx2.getPackageName();
                    String processName = ProcessUtils.getProcessName(c1074Xx2);
    ...
    private synchronized SQLiteDatabase A01() {
        ...
        this.A01.A06().A8y(A05(128, 8, 84), C04578z.A0v, new AnonymousClass90(e));
        throw e;
        return A00();
    }
    ...
    public final int A08(int i) {
        A08.lock();
        try {
            return A0E().delete(A05(136, 6, 111), C1073Xw.A02.A01 + A05(3, 4, 28), new String[]{String.valueOf(i - 1)});
        } finally {
            A08.unlock();
        }
    }
    ...
    public final <T> AsyncTask A0F(final AbstractC04418g<T> abstractC04418g, final AbstractC04619d<T> abstractC04619d) {
        Executor executor = MX.A07;
        final C1074Xx c1074Xx = this.A01;
        return MU.A00(executor, new AsyncTask<Void, Void, T>(c1074Xx, abstractC04418g, abstractC04619d) { // from class: com.facebook.ads.redexgen.X.8c
            public static byte[] A04;
            ...
            public final C1074Xx A01;
            public final AbstractC04418g<T> A02;
            public final AbstractC04619d<T> A03;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.9d != com.facebook.ads.internal.eventstorage.AdEventStorageCallback<T> */
            {
                this.A02 = abstractC04418g;
                this.A03 = abstractC04619d;
                this.A01 = c1074Xx;
            }
            ...
            private final T A00(Void... voidArr) throws Throwable {
                ...
                try {
                    try {
                        ...
                        this.A01.A06().A8y(A01(0, 8, 71), C04578z.A0w, new AnonymousClass90(e));
                        this.A00 = EnumC04408f.A09;
                        return tA03;
                    }
                } catch (Throwable th) {
                    L0.A00(th, this);
    ...
    public final AsyncTask A0G(String str, int i, String str2, double d, double d2, String str3, Map<String, String> map, AbstractC04619d<String> abstractC04619d) {
        return A0F(new C0578Ek(this, str2, str, i, d, d2, str3, map), abstractC04619d);
    }
    ...
    public final boolean A0L(String str) {
        ...
        A08.lock();
        try {
            A0E().execSQL(A05(121, 7, 95) + A05(136, 6, 111) + A05(44, 5, 67) + C1073Xw.A02.A01 + A05(61, 1, 83) + C1073Xw.A02.A01 + A05(56, 2, 49) + A05(49, 7, 11) + C1073Xw.A04.A01 + A05(62, 2, 26), new String[]{str});
            z = true;
