...
public final class XF implements JN, BT, InterfaceC0621Gb, EJ, SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
    ...
    public final /* synthetic */ C0564Ds A00;

    public XF(C0564Ds c0564Ds) {
        this.A00 = c0564Ds;
    }
    ...
    public final void AA6(C0530Bw c0530Bw) {
        this.A00.A09 = c0530Bw;
        Iterator it = this.A00.A0I.iterator();
        while (it.hasNext()) {
            ((BT) it.next()).AA6(c0530Bw);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0621Gb
    public final void AAS(List<GX> list) {
        this.A00.A0C = list;
        Iterator it = this.A00.A0K.iterator();
        while (it.hasNext()) {
            ((InterfaceC0621Gb) it.next()).AAS(list);
        }
    }
