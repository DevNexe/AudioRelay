...
public final class T5 extends O6 {
    ...
    public T5(C1075Xy c1075Xy, WeakReference<O9> weakReference, int i, String str) {
        this(c1075Xy, weakReference, i, false);
        if (JR.A1I(c1075Xy)) {
            c1075Xy.A00().A09().AFQ(this, str == null ? A04(0, 0, 74) : str, false, true);
            this.A06 = true;
        }
    }

    public T5(C1075Xy c1075Xy, WeakReference<O9> weakReference, int i, boolean z) {
        super(c1075Xy);
        ...
        this.A03 = new C0895Qw(this, i, new WeakReference(this.A02), this.A09);
