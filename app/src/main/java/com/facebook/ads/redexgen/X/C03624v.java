...
public final class C03624v extends Thread {
    ...
    static {
        A02();
        A09 = C03624v.class.getName();
    }

    public C03624v(C1075Xy c1075Xy, C03644x c03644x) {
        this(c1075Xy, c03644x, JR.A06(c1075Xy));
    }

    public C03624v(C1075Xy c1075Xy, C03644x c03644x, int i) {
                        ...
                        if (this.A05 != 0) {
                            ...
                            if (!needPost2) {
                                ...
                                if (!needPost3) {
                                    ...
                                    if (needPost4) {
                                        this.A03.A06().A8y(A01(15, 7, 116), C04578z.A1D, new AnonymousClass90(this.A02.A04()));
                                    }
                                    this.A06 = true;
                                }
                            }
