...
public abstract class AbstractC1300cq implements AnonymousClass27 {
    public static byte[] A05;
    public final InterfaceC02871v A00;
    ...
    public AbstractC1300cq(C1075Xy c1075Xy, AnonymousClass23 anonymousClass23) {
        this.A01 = c1075Xy;
        DynamicLoaderFactory.makeLoader(this.A01).getInitApi().onAdLoadInvoked(this.A01);
        this.A00 = new C1303ct(c1075Xy, this);
    ...
    public final void ABX(int i, String str, @Nullable Bundle bundle) {
        ...
        this.A03.post(new C1302cs(this, messageObtain));
    }
}
