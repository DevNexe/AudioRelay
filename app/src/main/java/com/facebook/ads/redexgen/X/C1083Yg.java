...
public class C1083Yg implements AnonymousClass72<String> {
    ...
    static {
        A03();
        A04 = C1083Yg.class.getSimpleName();
    }

    public C1083Yg(String str) {
        this.A00 = str;
        this.A01 = A01(str);
    }
    ...
    public static String A01(String ret) {
        ...
        try {
            Object[] params = {ret};
            if (C1082Yf.A01 != null && C1082Yf.A02 != null) {
                strA00 = (String) C1082Yf.A02.invoke(C1082Yf.A01, params);
                return strA00;
            }
            return strA00;
        } catch (Exception e) {
    ...
    public final boolean A8S(Object obj) {
        C1083Yg c1083Yg = (C1083Yg) obj;
        return this.A00.equals(c1083Yg.A00) && this.A01.equals(c1083Yg.A01);
    }
