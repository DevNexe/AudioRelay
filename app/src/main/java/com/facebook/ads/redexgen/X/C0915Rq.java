...
public final class C0915Rq extends FrameLayout implements InterfaceC0868Pv {
    ...
    public C0915Rq(C1075Xy c1075Xy, NativeAd nativeAd, K7 k7, K8 k8, OW ow, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1075Xy);
        this.A07 = new ArrayList<>();
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new C0869Pw(c1075Xy, this.A05, k7, ow, adOptionsView);
        C0869Pw c0869Pw = this.A06;
        int i = A0C;
        c0869Pw.setPadding(i, i, i, A0E);
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0868Pv
    public View getView() {
        return this;
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        C0869Pw c0869Pw = this.A06;
        c0869Pw.layout(i, i2, i3, c0869Pw.getMeasuredHeight() + i2);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int iA00 = A00();
        if (this.A04.getMediaWidth() == 0 || this.A04.getMediaHeight() == 0 || ((C1230bd) this.A04.getMediaViewApi()).A0N()) {
            iMin = iA00;
        } else {
