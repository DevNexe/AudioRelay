...
public final class C04819y implements Closeable {
    ...
    public final C04719o A01;
    public final Deque<C04809x> A02 = new LinkedList();
    ...
    public C04819y(C04719o c04719o, InterfaceC04799w interfaceC04799w) throws IOException {
        this.A01 = c04719o;
        A05(c04719o, interfaceC04799w);
        if (this.A02.isEmpty()) {
            A00();
        }
    }

    private C04809x A00() throws IOException {
        int iA00 = -1;
        if (!this.A02.isEmpty()) {
        ...
        this.A02.add(new C04809x(i, new C04779u(newFile)));
    ...
    private void A04(int i, File file) throws IOException {
        C04779u c04779u = new C04779u(file);
        c04779u.A05();
        this.A02.addFirst(new C04809x(i, c04779u));
    }

    private void A05(C04719o c04719o, InterfaceC04799w interfaceC04799w) throws IOException {
        File[] fileArrListFiles = c04719o.A05().listFiles();
        if (fileArrListFiles != null) {
            ...
            for (File file : fileArrListFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC04799w.AE4(String.format(Locale.US, A02(260, 39, 79), file.getCanonicalPath()));
                }
            }
            if (!map.isEmpty()) {
                int i3 = i;
                ...
                while (it.hasNext()) {
                    ...
                    if (iIntValue < i3) {
                        interfaceC04799w.AE4(String.format(Locale.US, A02(166, 61, 2), Integer.valueOf(iIntValue), Integer.valueOf(i3)));
                ...
                while (i >= i3) {
                    ...
                    try {
                        ...
                        interfaceC04799w.AE5(String.format(Locale.US, A02(104, 62, 43), file2.getCanonicalPath(), Integer.valueOf(i)), e);
            ...
            for (File file3 : hashSet) {
                if (!file3.delete()) {
                    interfaceC04799w.AE4(String.format(Locale.US, A02(40, 26, 29), file3.getCanonicalPath()));
                }
            }
            return;
        }
        throw new IOException(String.format(Locale.US, A02(66, 38, 93), c04719o.A05().getCanonicalPath()));
    }
    ...
    public final synchronized int A09() throws IOException {
        ...
        if (!this.A00) {
            iA01 = 0;
            Iterator<C04809x> it = this.A02.iterator();
            while (it.hasNext()) {
                iA01 += it.next().A01();
            }
        } else {
    ...
    public final synchronized C04699m A0A(int i, int i2, byte[] bArr, int i3, int[] iArr, int i4) throws IOException {
        if (!this.A00) {
            for (C04809x c04809x : this.A02) {
                if (c04809x.A00() == i) {
                    return new C04699m(i, c04809x.A02(i2, bArr, i3, iArr, i4));
                }
            }
            return new C04699m(-1, new C9l(EnumC04689k.A04, -1, -1, 0));
        }
        throw new IOException(A02(227, 33, 62));
    }
    ...
    public final synchronized boolean A0D() throws IOException {
        if (!this.A00) {
            if (this.A02.size() > 1) {
                C04809x first = this.A02.getFirst();
