...
public final class C1246bt extends C5E implements AdOptionsViewApi {
    ...
    public C1246bt(final Context context, NativeAdBase nativeAdBase, @Nullable NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView) {
        int i2;
        ...
        this.A01 = A00(EnumC0769Ma.DEFAULT_INFO_ICON);
        this.A00 = A00(EnumC0769Ma.AD_CHOICES_ICON);
        ...
        ubA0L.A1U(this);
        C1345da c1345daA0y = ubA0L.A0y();
        if (c1345daA0y != null && c1345daA0y.A0T() && !c1345daA0y.A0R()) {
            ...
            EnumC0765Lw.A04(this.A02, EnumC0765Lw.A0B);
        }
    }

    public C1246bt(Context context, NativeAdBase nativeAdBase, @Nullable NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        this(context, nativeAdBase, nativeAdLayout, AdOptionsView.Orientation.HORIZONTAL, 23, adOptionsView);
    }

    private ImageView A00(EnumC0769Ma enumC0769Ma) {
    ...
    public final void A03(EnumC0769Ma enumC0769Ma) {
        this.A01.setImageBitmap(C0770Mb.A01(enumC0769Ma));
    }
