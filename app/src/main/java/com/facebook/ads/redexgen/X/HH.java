...
public final class HH implements Comparable<HH> {
    ...
    public HH(Format format, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters, int i) {
        ...
        this.A05 = C0518Bk.A0H(i, false) ? 1 : 0;
        this.A03 = C0518Bk.A0K(format, defaultTrackSelector$Parameters.A07) ? 1 : 0;
    ...
    public final int compareTo(HH hh) {
        ...
        int i2 = hh.A05;
        if (i != i2) {
            return C0518Bk.A01(i, i2);
        }
        int i3 = this.A03;
        int i4 = hh.A03;
        if (i3 != i4) {
            return C0518Bk.A01(i3, i4);
        }
        int i5 = this.A02;
        int i6 = hh.A02;
        if (i5 != i6) {
            return C0518Bk.A01(i5, i6);
        }
        if (this.A06.A0D) {
            return C0518Bk.A01(hh.A00, this.A00);
        }
        ...
        A07[3] = "q1nzmC2W0";
        if (i8 != i9) {
            return C0518Bk.A01(i8, i9) * i7;
        }
        int i10 = this.A04;
        int i11 = hh.A04;
        return i10 != i11 ? C0518Bk.A01(i10, i11) * i7 : C0518Bk.A01(this.A00, hh.A00) * i7;
    }
