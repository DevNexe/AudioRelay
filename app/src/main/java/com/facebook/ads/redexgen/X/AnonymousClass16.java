...
public final class AnonymousClass16 extends BroadcastReceiver {
    ...
    public AnonymousClass16(C0494Al c0494Al, Context context) {
        this.A01 = c0494Al;
        this.A00 = context;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str.equals(A00(116, 21, 58))) {
            ...
            if (serializableExtra instanceof MQ) {
                ...
                InterfaceC0793My listener = this.A01.getListener();
            ...
            if (serializableExtra instanceof AnonymousClass88) {
                ...
                if (serializableExtra instanceof C0767Ly) {
                    if (this.A01.getListener() != null) {
                        InterfaceC0793My listener2 = this.A01.getListener();
                        if (A04[5].length() != 15) {
