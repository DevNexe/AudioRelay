...
public final class C04428i {
    ...
    public C04428i(Set<String> options, @Nullable Integer num, @Nullable Integer num2, String str) {
        this.A03 = options;
        this.A00 = num;
        this.A01 = num2;
        this.A02 = str;
    ...
    public C04428i(@Nullable String[] strArr, @Nullable Integer num, @Nullable Integer num2) {
    ...
    @Nullable
    public static C04428i A00(@Nullable String str) {
        if (str == null) {
            return null;
        }
        ...
        return new C04428i(linkedHashSet, numValueOf, numValueOf2, str);
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        if (!(obj instanceof C04428i)) {
            return false;
        }
        C04428i c04428i = (C04428i) obj;
        ...
        A06[0] = "YHhc40Na8nm";
        Integer num2 = c04428i.A00;
        if (num != num2 && (num == null || !num.equals(num2))) {
            return false;
        }
        Integer num3 = this.A01;
        Integer num4 = c04428i.A01;
        return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c04428i.A03);
    }
