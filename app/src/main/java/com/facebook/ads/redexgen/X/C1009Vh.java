...
public final class C1009Vh implements EG {
    ...
    public final Metadata A4h(DJ dj) throws EH {
        ...
        if (spliceCommandType == 0) {
            ...
            command = PrivateCommand.A00(c0679Ij, iA04, j2);
