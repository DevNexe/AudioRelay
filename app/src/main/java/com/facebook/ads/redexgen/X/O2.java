...
public class O2 extends WebChromeClient {
    ...
    public final WeakReference<C1075Xy> A00;
    public final WeakReference<O0> A01;
    public final WeakReference<C0818Nx> A02;
    ...
    public O2(WeakReference<C1075Xy> weakReference, WeakReference<O0> weakReference2, WeakReference<C0818Nx> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        C1075Xy c1075Xy = this.A00.get();
        if (c1075Xy == null || c1075Xy.A0C() == null || !TE.A09) {
            return false;
        }
        if (TE.A08 != null) {
        ...
        try {
            ...
            c1075Xy.A0C().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 112)), AdError.NO_FILL_ERROR_CODE);
            return true;
        } catch (Exception e) {
            c1075Xy.A06().A8z(A00(80, 8, 70), C04578z.A2a, new AnonymousClass90(e));
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        C0818Nx c0818Nx = this.A02.get();
        if (!TextUtils.isEmpty(strMessage) && consoleMessage.messageLevel() == ConsoleMessage.MessageLevel.LOG && c0818Nx != null) {
            c0818Nx.A04(strMessage);
            return true;
        }
        return true;
    }
