...
public final class JP {
    ...
    public JP(C1075Xy c1075Xy, String str, String str2) {
        this.A03 = c1075Xy;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    public final void A0C() {
        A08(C04578z.A1s, new AnonymousClass90(A05(101, 18, 66), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 125), A05(119, 51, 26));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(C04578z.A1o, new AnonymousClass90(A05(51, 50, 11)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e) {
            A07(C04578z.A1n, new AnonymousClass90(e));
        }
    }
}
