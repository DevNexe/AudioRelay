...
public final class DN implements InterfaceC1027Wc {
    ...
    public static DN A01(long j, long j2, Ci ci, C0679Ij c0679Ij) {
        int flags;
        int i = ci.A04;
        int i2 = ci.A03;
        int iA08 = c0679Ij.A08();
        int samplesPerFrame = iA08 & 1;
        if (samplesPerFrame != 1 || (flags = c0679Ij.A0H()) == 0) {
            return null;
        }
        long dataSize = C0695Iz.A0F(flags, ((long) i) * 1000000, i2);
        int samplesPerFrame2 = iA08 & 6;
        if (samplesPerFrame2 != 6) {
            return new DN(j2, ci.A02, dataSize);
        }
        long jA0H = c0679Ij.A0H();
        long[] jArr = new long[100];
        for (int i3 = 0; i3 < 100; i3++) {
            long durationUs = c0679Ij.A0E();
            jArr[i3] = durationUs;
        }
        if (j != -1 && j != j2 + jA0H) {
    ...
    public final C0541Ck A7O(long j) {
        ...
        if (!A8g()) {
            return new C0541Ck(new C0543Cm(0L, this.A02 + ((long) this.A00)));
        }
        long positionOffset = C0695Iz.A0E(j, 0L, this.A03);
        ...
        if (d <= 0.0d) {
            ...
            A06[4] = "";
            scaledPosition = d2 + (((i == 99 ? 256.0d : jArr[i + 1]) - d2) * (d - ((double) i)));
        }
        return new C0541Ck(new C0543Cm(positionOffset, this.A02 + C0695Iz.A0E(Math.round((scaledPosition / 256.0d) * this.A01), this.A00, this.A01 - 1)));
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC1027Wc
    public final long A7e(long j) {
        ...
        if (A8g()) {
            ...
            if (positionOffset > j2) {
                ...
                int iA0B = C0695Iz.A0B(this.A04, (long) d2, true, true);
                long jA00 = A00(iA0B);
                long j3 = this.A04[iA0B];
                long jA01 = A00(iA0B + 1);
                long j4 = iA0B == 99 ? 256L : this.A04[iA0B + 1];
                if (j3 == j4) {
                    d = 0.0d;
                } else {
                    d = (d2 - j3) / (j4 - j3);
                }
                long nextScaledPosition = Math.round((jA01 - jA00) * d);
