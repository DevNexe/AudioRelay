...
public class C1258c6 implements InterfaceC03323q {
    ...
    public C1258c6(F9 f9) {
        this.A00 = f9;
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC03323q
    public final void A3T(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        if (abstractC03524lA0G != null) {
            if (abstractC03524lA0G.A0e() || abstractC03524lA0G.A0h()) {
                abstractC03524lA0G.A0P();
            } else {
                throw new IllegalArgumentException(A00(0, 48, 113) + abstractC03524lA0G + this.A00.A1I());
            }
        }
    ...
    public final void A4m(int i) {
        ...
        View viewA5z = A5z(i);
        if (viewA5z != null && (abstractC03524lA0G = F9.A0G(viewA5z)) != null) {
            if (!abstractC03524lA0G.A0e() || abstractC03524lA0G.A0h()) {
                abstractC03524lA0G.A0T(256);
            } else {
                throw new IllegalArgumentException(A00(48, 43, 45) + abstractC03524lA0G + this.A00.A1I());
            }
        }
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC03323q
    public final AbstractC03524l A63(View view) {
        return F9.A0G(view);
    }
    ...
    public final void AAh(View view) {
        AbstractC03524l abstractC03524lA0G = F9.A0G(view);
        if (abstractC03524lA0G != null) {
            abstractC03524lA0G.A07(this.A00);
        }
    }
    ...
    public final void ABD(View view) {
        AbstractC03524l abstractC03524lA0G = F9.A0G(view);
        if (abstractC03524lA0G != null) {
            abstractC03524lA0G.A08(this.A00);
        }
    }
