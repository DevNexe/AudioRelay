...
public final class C1214bN implements InterfaceC03745h {
    public static byte[] A02;
    public static final String A03;
    public final InterfaceC03775k A00;
    ...
    static {
        A02();
        A03 = C1214bN.class.getSimpleName();
    }

    public C1214bN(InterfaceC03775k interfaceC03775k, C1074Xx c1074Xx) {
        this.A00 = interfaceC03775k;
        this.A00.A3D(new C1216bP(this));
        this.A01 = new C7U(c1074Xx);
        A01();
    }
    ...
    public void A01() {
        ...
        for (InterfaceC03805n interfaceC03805n : this.A00.A5j()) {
            int i = C03765j.A00[interfaceC03805n.A7j().ordinal()];
            if (i == 1) {
                A04(interfaceC03805n.getUrl());
            } else if (i == 2) {
                A06(interfaceC03805n.getUrl());
            } else if (i == 3) {
                A05(interfaceC03805n.getUrl());
            }
        }
        this.A01.A0W(new C1215bO(this), new C7N(A00(81, 36, 11), A00(125, 7, 46)));
    }
