...
public final class NO {
    ...
    @Nullable
    public static NN A01(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, String str, @Nullable NativeAdLayout nativeAdLayout) {
        if (nativeAdLayout == null) {
            return null;
        }
        ...
        int i = A01;
        if (width >= i && height >= i) {
            return new TG(c1075Xy, interfaceC0703Jh, str);
        }
        if (width < A03 || height < A02) {
            return null;
        }
        return new TH(c1075Xy, interfaceC0703Jh, str);
    }

    public static NN A02(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, String str, C1U c1u, InterfaceC0786Mr interfaceC0786Mr, InterfaceC0785Mq interfaceC0785Mq) {
        return new TI(c1075Xy, interfaceC0703Jh, str, c1u, interfaceC0786Mr, interfaceC0785Mq);
    }
