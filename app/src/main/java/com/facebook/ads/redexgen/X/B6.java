...
public interface B6 {
    ...
    void onDecoderDisabled(B5 b5, int i, C0530Bw c0530Bw);

    void onDecoderEnabled(B5 b5, int i, C0530Bw c0530Bw);

    void onDecoderInitialized(B5 b5, int i, String str, long j);

    void onDecoderInputFormatChanged(B5 b5, int i, Format format);

    void onDownstreamFormatChanged(B5 b5, C0607Fn c0607Fn);
    ...
    void onLoadError(B5 b5, C0606Fm c0606Fm, C0607Fn c0607Fn, IOException iOException, boolean z);
    ...
    void onPlaybackParametersChanged(B5 b5, C0490Ah c0490Ah);
