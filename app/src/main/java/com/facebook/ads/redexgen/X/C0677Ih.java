...
public final class C0677Ih implements QT {
    ...
    public C0677Ih(View view, int i, Drawable drawable, Drawable drawable2) {
        this.A03 = i;
        this.A07 = view;
        this.A05 = drawable;
        this.A04 = drawable2;
    ...
    private void A04(boolean z) {
        ...
        if (z) {
            ...
            this.A06.postDelayed(new C0684Io(this), this.A03);
            return;
        }
    ...
    private void A05(boolean z) {
        ...
        if (z) {
            ...
            this.A06.postDelayed(new C0685Ip(this), this.A03);
            return;
        }
