...
public abstract class L8 implements Runnable {
    ...
    public static final AtomicReference<InterfaceC0743Ky> A04;

    @Nullable
    public final C0741Kw A00;
    ...
    public static void A04(boolean z, InterfaceC0743Ky interfaceC0743Ky) {
        A02.set(z);
        A04.set(interfaceC0743Ky);
    }

    @Nullable
    public final C0741Kw A05() {
        return this.A00;
    }
    ...
    public final void run() throws Throwable {
        ...
        try {
            ...
            try {
                ...
                if (A02.get()) {
                    LF.A00().A8p(3301, th);
                    InterfaceC0743Ky interfaceC0743Ky = A04.get();
                    if (interfaceC0743Ky != null) {
                        interfaceC0743Ky.AE0(th, this);
                    }
                } else {
                    throw th;
                }
