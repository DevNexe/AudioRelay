...
public final class UN extends C5E implements DefaultMediaViewVideoRendererApi {
    ...
    @Nullable
    public InterfaceC0720Jy A02;

    @Nullable
    public C0494Al A04;
    public C04267m A05;
    public ViewOnClickListenerC04217e A06;

    @DoNotStrip
    public AbstractC0894Qv A07;
    public C0895Qw A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    ...
    private AbstractC0894Qv A04() {
        return new UP(this);
    }

    private C0895Qw A05() {
        return new C0895Qw(this.A00, 50, true, new WeakReference(this.A07), this.A01);
    }

    private void A09() {
        C0494Al c0494Al = this.A04;
        if (c0494Al != null) {
            Q3 q3 = (Q3) c0494Al.getVideoView();
            if (A0G[3].length() != 24) {
    ...
    private void A0A() {
        C0494Al c0494Al = this.A04;
        if (c0494Al != null) {
            c0494Al.getVideoView().setOnTouchListener(new ViewOnTouchListenerC0719Jx(this));
        }
    }
    ...
    private void A0C() {
        ...
        C0494Al c0494Al = this.A04;
        if (c0494Al != null && c0494Al.getState() == EnumC0892Qt.A05) {
            this.A0B = true;
        }
        this.A08.A0V();
    }
    ...
    public void A0I(UB ub, @Nullable InterfaceC0720Jy interfaceC0720Jy) {
        String url;
        this.A0A = false;
        this.A0B = false;
        this.A02 = interfaceC0720Jy;
        A09();
        C04267m c04267m = this.A05;
        if (ub != null) {
            ...
            if (adCoverImage == null) {
                ...
                url = ub.getAdCoverImage().getUrl();
            }
        } else {
            url = null;
        }
        c04267m.setImage(url, new UQ(this));
        this.A03 = ub.A18();
        this.A06.setPlayAccessibilityLabel(ub.A1E());
        this.A06.setPauseAccessibilityLabel(ub.A1D());
        this.A08.A0U();
    }
    ...
    public final void initialize(Context context, MediaViewVideoRenderer mediaViewVideoRenderer, MediaViewVideoRendererApi mediaViewVideoRendererApi, int i) {
        ...
        this.A05 = new C04267m(this.A01);
        this.A07 = A04();
        this.A08 = A05();
        float f = Lr.A00;
        int i2 = (int) (2.0f * f);
        int i3 = (int) (25.0f * f);
        this.A06 = new ViewOnClickListenerC04217e(this.A01);
        ...
        while (true) {
            ...
            if (A0G[3].length() == 24) {
                ...
                if (childAt instanceof C0494Al) {
                    this.A04 = (C0494Al) childAt;
                    break;
                }
                i4++;
            } else {
    ...
    public final void onPrepared() {
        this.A00.setOnTouchListener(new ViewOnTouchListenerC0718Jw(this));
        A0A();
    }
