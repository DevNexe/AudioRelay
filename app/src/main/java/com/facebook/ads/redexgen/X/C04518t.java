...
public final class C04518t {
    ...
    public static int A00(String str, int i, C8U c8u) {
        if ((A01(457, 7, 71).equals(str) && C04578z.A1z == i) || A01(422, 5, 56).equals(str) || A01(437, 6, 113).equals(str)) {
    ...
    public static void A05(C8U c8u, int i, int i2) {
        c8u.A06().A8y(A01(427, 10, 60), C04578z.A2W, new AnonymousClass90(A01(338, 33, 80) + i, A01(87, 9, 13) + i2));
    }
    ...
    public static void A09(C8U c8u, String str, int i, AnonymousClass90 anonymousClass90) {
        synchronized (C04518t.class) {
            if (!A03) {
                int iA01 = JT.A01(c8u);
                if (A09.getAndIncrement() < iA01 - 1) {
                    A07.add(new C04528u(str, i, anonymousClass90));
                } else if (A09.get() == iA01) {
                    A07.add(new C04528u(A01(427, 10, 60), C04578z.A2T, new AnonymousClass90(A01(140, 42, 0) + str + A01(47, 1, 19) + i)));
                }
            } else {
    ...
    public static void A0A(C8U c8u, String str, int i, AnonymousClass90 anonymousClass90, boolean z) throws Throwable {
        InterfaceC04508s interfaceC04508s = A0B.get();
        boolean z2 = interfaceC04508s != null && interfaceC04508s.A8e();
        if (A08.get() || z2) {
            int iA00 = anonymousClass90.A00();
            String strA01 = A01(289, 17, 46);
            String strA02 = A01(31, 16, 8);
            if (iA00 == 0) {
                Log.e(strA01, A01(182, 37, 40) + str + strA02 + i, anonymousClass90);
            } else {
                Log.i(strA01, A01(306, 32, 116) + str + strA02 + i + A01(19, 12, 63) + anonymousClass90.getMessage() + A01(0, 19, 80) + anonymousClass90.A02());
            }
        }
        C1066Xp c1066Xp = new C1066Xp(c8u, str, i, anonymousClass90, interfaceC04508s);
        if (z) {
            A01.execute(c1066Xp);
        } else {
            c1066Xp.run();
    ...
    public static void A0C(C1074Xx c1074Xx, InterfaceC04508s interfaceC04508s, C8r c8r, boolean z) {
        A0A.set(c8r);
        A0B.set(interfaceC04508s);
        A08.set(z);
        synchronized (C04518t.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1067Xq(c1074Xx));
            }
        }
    }
        ...
        try {
            ...
            if (A01(422, 5, 56).equals(str)) {
                ...
                if (iA06 > 0) {
                    ...
                    if (zContains) {
                        return dA00 <= d2 * logProbability;
                    }
                    return dA00 <= d2;
                }
            }
            if (A01(457, 7, 71).equals(str) && C04578z.A1z == i) {
                if (!A08.get()) {
                    iA0E = JT.A0E(c8u);
                } else {
                    iA0E = 1;
    ...
    public static boolean A0J(C8U c8u, String str, int eventsLimit, AnonymousClass90 anonymousClass90) {
        ...
        if (anonymousClass90.A01() != -1) {
            ...
            int iA01 = A00(str, eventsLimit, c8u);
            if (iA00 < iA01) {
                iA00 = iA01;
            }
        }
