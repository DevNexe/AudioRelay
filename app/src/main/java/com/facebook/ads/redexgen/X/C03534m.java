...
public final class C03534m {
    ...
    public static int A00(C03494i c03494i, C4D c4d, View view, View view2, C4T c4t, boolean z) {
        if (c4t.A0W() == 0 || c03494i.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z) {
    ...
    public static int A01(C03494i c03494i, C4D c4d, View view, View view2, C4T c4t, boolean z) {
        if (c4t.A0W() == 0 || c03494i.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z) {
        ...
        return (int) (((c4d.A0C(view2) - c4d.A0F(view)) / (Math.abs(c4t.A0p(view) - c4t.A0p(view2)) + 1)) * c03494i.A03());
    }

    public static int A02(C03494i c03494i, C4D c4d, View view, View view2, C4T c4t, boolean z, boolean z2) {
        int iMax;
        if (c4t.A0W() != 0) {
            int iA03 = c03494i.A03();
            String[] strArr = A00;
            ...
            if (iA03 != 0 && view != null && view2 != null) {
                ...
                if (z2) {
                    iMax = Math.max(0, (c03494i.A03() - iMax2) - 1);
                } else {
