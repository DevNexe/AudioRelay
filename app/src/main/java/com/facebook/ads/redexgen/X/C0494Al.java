...
public final class C0494Al extends QK {
    ...
    @Nullable
    public NativeAd A01;
    public InterfaceC0703Jh A02;

    @Nullable
    public InterfaceC0793My A03;
    ...
    public final N6 A0B;
    public final AbstractC0768Lz A0C;
    public final AbstractC0754Lj A0D;
    ...
    static {
        A03();
        A0G = C0494Al.class.getSimpleName();
    }

    public C0494Al(C1075Xy c1075Xy) {
        super(c1075Xy);
        this.A0E = UUID.randomUUID().toString();
        this.A0D = new B8(this);
        this.A0C = new C0502At(this);
        this.A0B = new C0496An(this);
        this.A09 = new AnonymousClass16(this, c1075Xy);
        this.A0A = c1075Xy;
        A02();
    }

    public C0494Al(C1075Xy c1075Xy, AttributeSet attributeSet) {
    ...
    public C0494Al(C1075Xy c1075Xy, AttributeSet attributeSet, int i) {
    ...
    private void A04(Intent intent) {
        ...
        intent.putExtra(A01(322, 8, 34), EnumC0736Kq.A06);
    ...
    private void A05(String str) {
        this.A0A.A06().A8y(A01(198, 7, 120), C04578z.A27, new AnonymousClass90(AdErrorType.PARSER_FAILURE.getDefaultErrorMessage(), A01(90, 7, 93) + str));
    ...
    public final void A0n() {
        ...
        try {
            ...
            this.A0A.A06().A8y(A01(176, 11, 126), C04578z.A0D, new AnonymousClass90(e));
            Log.e(A01(97, 17, 22), A01(0, 90, 38), e);
        }
    }

    @Nullable
    public InterfaceC0793My getListener() {
        return this.A03;
    }
    ...
    public void setAdEventManager(InterfaceC0703Jh interfaceC0703Jh) {
        this.A02 = interfaceC0703Jh;
    }

    public void setClientToken(@Nullable String str) {
        AnonymousClass89 anonymousClass89;
        C0870Px c0870Px = this.A04;
        if (c0870Px != null) {
            c0870Px.A0A();
        }
        AnonymousClass89 anonymousClass810 = this.A05;
        if (anonymousClass810 != null) {
            anonymousClass810.A0g();
        }
        this.A06 = str;
        C0870Px c0870Px2 = null;
        if (str != null) {
        ...
        if (JR.A1J(this.A0A)) {
            if (str != null) {
                c0870Px2 = new C0870Px(this.A0A, this.A02, this, str, null);
            }
            this.A04 = c0870Px2;
            return;
        }
    ...
    public void setListener(@Nullable InterfaceC0793My interfaceC0793My) {
        this.A03 = interfaceC0793My;
    }
