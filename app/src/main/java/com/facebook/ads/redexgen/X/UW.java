...
public final class UW implements InterfaceC0701Jf {
    ...
    public UW(C1074Xx c1074Xx, XS xs) {
        this.A00 = c1074Xx;
        this.A01 = xs;
    }

    public static JSONArray A01(C1074Xx c1074Xx, JSONArray jSONArray, JSONArray jSONArray2) {
        int length = jSONArray != null ? 0 + jSONArray.length() : 0;
        if (jSONArray2 != null) {
            length += jSONArray2.length();
        }
        return A02(c1074Xx, jSONArray, jSONArray2, length);
    }

    public static JSONArray A02(C1074Xx c1074Xx, JSONArray jSONArray, JSONArray totalEvents, int debugLength) {
        if (jSONArray == null) {
            return totalEvents;
        }
        if (totalEvents == null) {
    ...
    private JSONObject A03() {
        ...
        if (JT.A0P(this.A00) && (jSONArrayA03 = AnonymousClass91.A03(this.A00)) != null && jSONArrayA03.length() > 0) {
            ...
            jSONArrayA5f = A01(c1074Xx, jSONArrayA03, jSONArrayA5f);
        }
        JSONObject jSONObject = null;
    ...
    public final void A9y() {
        ...
        if (iA3z > 0) {
            this.A00.A06().A8y(A00(379, 8, 100), C04578z.A10, new AnonymousClass90(A00(28, 44, 73) + iA3z));
        }
        C1074Xx c1074Xx = this.A00;
        String[] strArr = A03;
        String str = strArr[5];
