...
public final class C0869Pw extends LinearLayout {
    public static final int A00 = (int) (Lr.A00 * 32.0f);
    public static final int A01 = (int) (Lr.A00 * 8.0f);

    public C0869Pw(C1075Xy c1075Xy, NativeAd nativeAd, K7 k7, OW ow, AdOptionsView adOptionsView) {
        super(c1075Xy);
        setOrientation(0);
        ...
        TextView textView2 = new TextView(c1075Xy);
        k7.A06(textView2);
