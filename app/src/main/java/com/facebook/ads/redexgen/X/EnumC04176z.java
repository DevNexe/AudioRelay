...
public enum EnumC04176z {
    ...
    public static final Map<Integer, EnumC04176z> A03;
    public int A00;
    ...
    static {
        A03();
        A03 = new HashMap();
        for (EnumC04176z enumC04176z : valuesCustom()) {
            A03.put(Integer.valueOf(enumC04176z.A00), enumC04176z);
        }
    }
    ...
    @Nullable
    public static EnumC04176z A00(int i) {
    ...
    public static EnumSet<EnumC04176z> A02(int i) throws Exception {
        EnumSet<EnumC04176z> enumSetNoneOf = EnumSet.noneOf(EnumC04176z.class);
        if (i <= 0) {
            return enumSetNoneOf;
        }
        EnumC04176z[] enumC04176zArrValuesCustom = valuesCustom();
        while (i != 0) {
            int iNumberOfTrailingZeros = Integer.numberOfTrailingZeros(i);
            i ^= Integer.lowestOneBit(i);
            if (iNumberOfTrailingZeros < enumC04176zArrValuesCustom.length) {
                enumSetNoneOf.add(enumC04176zArrValuesCustom[iNumberOfTrailingZeros]);
            }
        }
        return enumSetNoneOf;
    }
    ...
    public static EnumC04176z[] valuesCustom() {
        EnumC04176z[] enumC04176zArr = (EnumC04176z[]) values().clone();
        if (A02[6].length() == 6) {
            throw new RuntimeException();
        }
        A02[3] = "eRZf21luPciybvl5gLFfDWdEin7TzD8T";
        return enumC04176zArr;
    }
}
