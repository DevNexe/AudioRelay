...
public class C1183as implements InterfaceC04136v {
    ...
    public C1183as(C1163aY c1163aY) {
        this.A00 = c1163aY;
    }
    ...
    public final C7A A5J() {
        if (this.A00.A01 != null) {
            ...
            ApplicationInfo applicationInfo = c1163aY.A01;
            if (A01[1].length() == 3) {
                throw new RuntimeException();
            }
            A01[3] = "Yec9tINwCXE8zEgRYPM9thJfbPEs0Pqz";
            return c1163aY.A08(applicationInfo.taskAffinity);
        }
