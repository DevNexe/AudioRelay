...
public final class C5M implements NativeAdApi {
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, @Nullable ImageView imageView, @Nullable List<View> list) {
        if (imageView != null) {
            C1075Xy c1075XyA11 = A00().A11();
            C1075Xy c1075XyA02 = C5G.A02(imageView.getContext());
            c1075XyA02.A0F(c1075XyA11);
            UB.A0j(A00().getAdIcon(), imageView, c1075XyA02);
        }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, @Nullable MediaView mediaView2, @Nullable List<View> list) {
        if (mediaView != null) {
            ((C1230bd) mediaView.getMediaViewApi()).A0L(this.A00);
        }
        if (mediaView2 != null) {
            ((C1230bd) mediaView2.getMediaViewApi()).A0M(this.A01, false);
        }
        if (list != null) {
