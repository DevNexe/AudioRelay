...
public final class C0487Ae {
    ...
    public Object A08;
    public boolean A09;
    public final C0507Az A0A = new C0507Az();
    public final B0 A0B = new B0();

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    private C0486Ad A02(int i, long j, long j2) {
        FY fy = new FY(i, j2);
        ...
        return new C0486Ad(fy, j, jA09, -9223372036854775807L, jA09 == Long.MIN_VALUE ? this.A0A.A07() : jA09, zA0A, A0B(fy, zA0A));
    }
    ...
    private long A00(int i) {
        ...
        for (C0485Ac c0485AcA0E = A0E(); c0485AcA0E != null; c0485AcA0E = c0485AcA0E.A01) {
            if (c0485AcA0E.A09.equals(obj)) {
                return c0485AcA0E.A02.A04.A03;
            }
        }
        for (C0485Ac c0485AcA0E2 = A0E(); c0485AcA0E2 != null; c0485AcA0E2 = c0485AcA0E2.A01) {
            int iA04 = this.A07.A04(c0485AcA0E2.A09);
            if (iA04 != -1) {
                int holderWindowIndex = this.A07.A09(iA04, this.A0A).A00;
                if (holderWindowIndex == i2) {
                    return c0485AcA0E2.A02.A04.A03;
                }
            }
        }
        long j = this.A02;
    ...
    private C0486Ad A01(int i, int i2, int i3, long durationUs, long j) {
        long jA06;
        ...
        return new C0486Ad(fy, jA06, Long.MIN_VALUE, durationUs, jA0A, zA0A, zA0B);
    }

    @Nullable
    private C0486Ad A03(C0485Ac c0485Ac, long j) {
        long jLongValue;
        C0486Ad c0486Ad = c0485Ac.A02;
        if (c0486Ad.A06) {
            int iA03 = this.A07.A03(c0486Ad.A04.A02, this.A0A, this.A0B, this.A01, this.A09);
            if (iA03 == -1) {
                return null;
            }
            int i = this.A07.A0A(iA03, this.A0A, true).A00;
            Object obj = this.A0A.A03;
            long j2 = c0486Ad.A04.A03;
            if (this.A07.A0B(i, this.A0B).A00 == iA03) {
                long windowSequenceNumber = c0485Ac.A07();
                Pair<Integer, Long> pairA08 = this.A07.A08(this.A0B, this.A0A, i, -9223372036854775807L, Math.max(0L, (windowSequenceNumber + c0486Ad.A01) - j));
                if (pairA08 == null) {
                    return null;
                }
                ...
                Object nextPeriodUid3 = c0485Ac.A01;
                if (nextPeriodUid3 != null && c0485Ac.A01.A09.equals(obj)) {
                    j2 = c0485Ac.A01.A02.A04.A03;
                } else {
                    j2 = this.A02;
        ...
        FY currentPeriodId = c0486Ad.A04;
        ...
        if (currentPeriodId.A01()) {
            ...
            if (adCountInCurrentAdGroup < iA01) {
                ...
                return A01(currentPeriodId.A02, adGroupIndex, adCountInCurrentAdGroup, c0486Ad.A00, currentPeriodId.A03);
            }
            return A02(currentPeriodId.A02, c0486Ad.A00, currentPeriodId.A03);
        }
        long j3 = c0486Ad.A02;
        ...
        if (j3 != Long.MIN_VALUE) {
            int iA05 = this.A0A.A05(c0486Ad.A02);
            if (iA05 == -1) {
                return A02(currentPeriodId.A02, c0486Ad.A02, currentPeriodId.A03);
            }
            int iA02 = this.A0A.A02(iA05);
            if (!this.A0A.A0E(iA05, iA02)) {
                return null;
            }
            return A01(currentPeriodId.A02, iA05, iA02, c0486Ad.A02, currentPeriodId.A03);
        }
    ...
    private C0486Ad A04(C0486Ad c0486Ad, FY fy) {
        long jA07;
        long j = c0486Ad.A03;
        long endPositionUs = c0486Ad.A02;
        ...
        return new C0486Ad(fy, j, endPositionUs, c0486Ad.A00, jA07, zA0A, zA0B);
    }

    private C0486Ad A05(C0489Ag c0489Ag) {
        return A06(c0489Ag.A04, c0489Ag.A01, c0489Ag.A02);
    }

    private C0486Ad A06(FY fy, long j, long j2) {
        this.A07.A09(fy.A02, this.A0A);
        if (fy.A01()) {
    ...
    private boolean A08() {
        C0485Ac c0485AcA0E = A0E();
        if (c0485AcA0E == null) {
            return true;
        }
        while (true) {
            int iA03 = this.A07.A03(c0485AcA0E.A02.A04.A02, this.A0A, this.A0B, this.A01, this.A09);
            while (c0485AcA0E.A01 != null && !c0485AcA0E.A02.A06) {
                c0485AcA0E = c0485AcA0E.A01;
            }
            if (iA03 == -1 || c0485AcA0E.A01 == null || c0485AcA0E.A01.A02.A04.A02 != iA03) {
                break;
            }
            c0485AcA0E = c0485AcA0E.A01;
        }
        boolean zA0S = A0S(c0485AcA0E);
        c0485AcA0E.A02 = A04(c0485AcA0E.A02, c0485AcA0E.A02.A04);
        if (!zA0S) {
            return true;
        }
        boolean zA0P = A0P();
    ...
    private boolean A09(C0485Ac c0485Ac, C0486Ad c0486Ad) {
        C0486Ad c0486Ad2 = c0485Ac.A02;
        return c0486Ad2.A03 == c0486Ad.A03 && c0486Ad2.A02 == c0486Ad.A02 && c0486Ad2.A04.equals(c0486Ad.A04);
    }
    ...
    public final C0485Ac A0C() {
        C0485Ac c0485Ac = this.A05;
        if (c0485Ac != null) {
            if (c0485Ac == this.A06) {
                this.A06 = c0485Ac.A01;
            }
            this.A05.A0D();
            this.A00--;
            if (this.A00 == 0) {
    ...
    public final C0485Ac A0D() {
        C0485Ac c0485Ac = this.A06;
        IK.A04((c0485Ac == null || c0485Ac.A01 == null) ? false : true);
        if (A0C[7].length() != 31) {
            throw new RuntimeException();
        }
        String[] strArr = A0C;
    ...
    public final C0485Ac A0E() {
        return A0P() ? this.A05 : this.A04;
    }

    public final C0485Ac A0F() {
        return this.A04;
    }

    public final C0485Ac A0G() {
        return this.A05;
    }

    public final C0485Ac A0H() {
        return this.A06;
    }

    @Nullable
    public final C0486Ad A0I(long j, C0489Ag c0489Ag) {
        C0485Ac c0485Ac = this.A04;
        if (c0485Ac == null) {
            return A05(c0489Ag);
        }
        return A03(c0485Ac, j);
    }

    public final C0486Ad A0J(C0486Ad c0486Ad, int i) {
        return A04(c0486Ad, c0486Ad.A04.A00(i));
    }

    public final VW A0K(InterfaceC0503Au[] interfaceC0503AuArr, HT ht, HW hw, InterfaceC0594Fa interfaceC0594Fa, Object obj, C0486Ad c0486Ad) {
        long jA07;
        C0485Ac c0485Ac = this.A04;
        if (c0485Ac != null) {
            jA07 = c0485Ac.A07() + this.A04.A02.A01;
        } else {
            jA07 = c0486Ad.A03;
        }
        C0485Ac c0485Ac2 = new C0485Ac(interfaceC0503AuArr, jA07, ht, hw, interfaceC0594Fa, obj, c0486Ad);
        if (this.A04 != null) {
            IK.A04(A0P());
            this.A04.A01 = c0485Ac2;
        }
        this.A08 = null;
        this.A04 = c0485Ac2;
        this.A00++;
    ...
    public final void A0O(boolean z) {
        C0485Ac c0485AcA0E = A0E();
        if (c0485AcA0E != null) {
            this.A08 = z ? c0485AcA0E.A09 : null;
            this.A03 = c0485AcA0E.A02.A04.A03;
            c0485AcA0E.A0D();
            A0S(c0485AcA0E);
        } else if (!z) {
            this.A08 = null;
    ...
    public final boolean A0Q() {
        C0485Ac c0485Ac = this.A04;
        return c0485Ac == null || (!c0485Ac.A02.A05 && this.A04.A0H() && this.A04.A02.A01 != -9223372036854775807L && this.A00 < 100);
    }
    ...
    public final boolean A0S(C0485Ac c0485Ac) {
        IK.A04(c0485Ac != null);
        boolean z = false;
        this.A04 = c0485Ac;
        while (c0485Ac.A01 != null) {
            c0485Ac = c0485Ac.A01;
            if (c0485Ac == this.A06) {
                this.A06 = this.A05;
                z = true;
    ...
    public final boolean A0T(VW vw) {
        C0485Ac c0485Ac = this.A04;
        return c0485Ac != null && c0485Ac.A08 == vw;
    }

    public final boolean A0U(FY fy, long j) {
        int iA03 = fy.A02;
        C0485Ac c0485Ac = null;
        for (C0485Ac c0485AcA0E = A0E(); c0485AcA0E != null; c0485AcA0E = c0485AcA0E.A01) {
            if (c0485Ac == null) {
                c0485AcA0E.A02 = A0J(c0485AcA0E.A02, iA03);
            } else {
                if (iA03 != -1) {
                    Object obj = c0485AcA0E.A09;
                    if (A0C[2].charAt(30) != 'V') {
                        throw new RuntimeException();
                    }
                    String[] strArr = A0C;
                    ...
                    if (obj.equals(this.A07.A0A(iA03, this.A0A, true).A03)) {
                        C0486Ad c0486AdA03 = A03(c0485Ac, j);
                        if (c0486AdA03 == null) {
                            return true ^ A0S(c0485Ac);
                        }
                        c0485AcA0E.A02 = A0J(c0485AcA0E.A02, iA03);
                        if (!A09(c0485AcA0E, c0486AdA03)) {
                            return true ^ A0S(c0485Ac);
                        }
                    }
                }
