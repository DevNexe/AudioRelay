...
public abstract class AbstractC0533Bz extends X0<C0531Bx, AbstractC0523Bp, GZ> implements VS {
    ...
    public AbstractC0533Bz(String str) {
        super(new C0531Bx[2], new AbstractC0523Bp[2]);
        this.A00 = str;
        A0Y(1024);
    }
    ...
    public final GZ A0W(C0531Bx c0531Bx, AbstractC0523Bp abstractC0523Bp, boolean z) {
        try {
            ByteBuffer byteBuffer = c0531Bx.A01;
            abstractC0523Bp.A09(((X2) c0531Bx).A00, A0b(byteBuffer.array(), byteBuffer.limit(), z), c0531Bx.A00);
            abstractC0523Bp.A01(Integer.MIN_VALUE);
            return null;
        } catch (GZ e) {
            return e;
        }
    ...
    public final AbstractC0523Bp A0V() {
        return new AbstractC0523Bp(this) { // from class: com.facebook.ads.redexgen.X.34
            public final AbstractC0533Bz A00;

            {
                this.A00 = this;
            }

            @Override // com.facebook.ads.redexgen.X.AbstractC0523Bp
    ...
    public final void A0a(AbstractC0523Bp abstractC0523Bp) {
        super.A0a(abstractC0523Bp);
    }
