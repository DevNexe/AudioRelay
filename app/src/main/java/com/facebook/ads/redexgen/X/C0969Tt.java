...
public class C0969Tt extends L8 {
    ...
    public C0969Tt(Context context) {
        this.A00 = context;
    }
    ...
    public final void A06() {
        int iA02;
        if (C0753Li.A02 == EnumC0752Lh.A02) {
            return;
        }
        ...
        if (returnMinSdkVersion != -1) {
            int unused = C0753Li.A00 = returnMinSdkVersion;
            C0753Li.A02 = EnumC0752Lh.A02;
            return;
        }
        if (Build.VERSION.SDK_INT >= 24) {
            iA02 = C0753Li.A03(this.A00);
        } else {
            iA02 = C0753Li.A02(this.A00);
        }
        int unused2 = C0753Li.A00 = iA02;
