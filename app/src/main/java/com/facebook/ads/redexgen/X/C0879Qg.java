...
public final class C0879Qg {
    ...
    public C0879Qg(C1075Xy c1075Xy) {
        this.A00 = AO.A00(new XI(c1075Xy), new C0518Bk(new VF(this.A01)), new XK());
    }
    ...
    @Nullable
    public final C0877Qe A08() {
        Format formatA0L = this.A00.A0L();
        if (formatA0L == null) {
            return null;
        }
        return new C0877Qe(formatA0L.A0F, formatA0L.A08);
    }
    ...
    public final void A0F(C1074Xx c1074Xx, Uri uri) {
        if (JR.A26(c1074Xx, A03())) {
            VY vy = new VY(C0883Qk.A05(c1074Xx).A0F(c1074Xx));
            String customCacheKey = C0883Qk.A08(c1074Xx, uri);
        ...
        this.A00.A0P(new VY(new V6(c1074Xx, C0695Iz.A0K(c1074Xx, A00(38, 3, 4)), this.A01)).A01(uri));
    }

    public final void A0G(InterfaceC0876Qd interfaceC0876Qd) {
        this.A00.A3E(new II(this, interfaceC0876Qd));
    }

    public final void A0H(InterfaceC0878Qf interfaceC0878Qf) {
        this.A00.A0Q(new IJ(this, interfaceC0878Qf));
    }
