...
public final class MK {
    ...
    private EnumC0765Lw A00() {
        View view;
        View view2 = this.A0G;
        if (view2 == null || (view = this.A0F) == null) {
            return EnumC0765Lw.A0I;
        }
        if (view2 != view) {
            return EnumC0765Lw.A0G;
        }
        if (Build.VERSION.SDK_INT < 4) {
            return EnumC0765Lw.A0F;
        }
        Object tag = this.A0G.getTag(EnumC0765Lw.A02);
        if (tag == null) {
            return EnumC0765Lw.A0H;
        }
        if (!(tag instanceof EnumC0765Lw)) {
            return EnumC0765Lw.A0J;
        }
        return (EnumC0765Lw) tag;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:13:0x0156  */
    public final Map<String, String> A04() {
        ...
        map.put(A01(20, 11, 106), String.valueOf(this.A04));
        map.put(A01(31, 11, 98), String.valueOf(this.A05));
        map.put(A01(186, 5, 96), String.valueOf(this.A06));
        map.put(A01(102, 6, 16), String.valueOf(this.A03));
        map.put(A01(42, 14, 33), String.valueOf(j));
        long clickDelayMs = this.A0E;
        map.put(A01(165, 9, 37), String.valueOf(clickDelayMs));
        long clickDelayMs2 = this.A0D;
        map.put(A01(82, 7, 41), String.valueOf(clickDelayMs2));
        map.put(A01(174, 6, 44), String.valueOf(this.A0A));
        map.put(A01(180, 6, 103), String.valueOf(this.A0B));
        map.put(A01(56, 6, 117), String.valueOf(this.A07));
        map.put(A01(62, 6, 108), String.valueOf(this.A08));
        map.put(A01(89, 4, 94), String.valueOf(this.A07));
        map.put(A01(93, 4, 16), String.valueOf(this.A08));
        map.put(A01(97, 5, 12), String.valueOf(this.A00));
        map.put(A01(129, 7, 77), strValueOf);
        map.put(A01(136, 7, 117), strValueOf);
        map.put(A01(68, 14, 24), String.valueOf(A00().A05()));
        return map;
    }
    ...
    public final void A06(C1075Xy c1075Xy, MotionEvent motionEvent, @Nullable View view, View view2) {
        if (view == null) {
            c1075Xy.A0D().AFO();
            return;
        }
        ...
        if (action != 0) {
            ...
            this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / Lr.A00);
            this.A08 = (int) (((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1]) / Lr.A00);
            this.A0F = view2;
            return;
        }
        this.A04 = (int) (iArr[0] / Lr.A00);
        this.A05 = (int) (iArr[1] / Lr.A00);
        this.A06 = (int) (view.getWidth() / Lr.A00);
        this.A03 = (int) (view.getHeight() / Lr.A00);
        this.A09 = 1;
        this.A0E = System.currentTimeMillis();
        this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / Lr.A00);
        this.A0B = (int) (((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1]) / Lr.A00);
