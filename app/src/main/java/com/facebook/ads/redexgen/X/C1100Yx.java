...
public class C1100Yx implements InterfaceC04136v {
    ...
    public C1100Yx(C1098Yv c1098Yv) {
        this.A00 = c1098Yv;
    }
    ...
    public final C7A A5J() {
        if (this.A00.A04 != null) {
            ...
            ActivityInfo[] activityInfoArr = c1098Yv.A04;
            if (A01[3].charAt(20) != 'k') {
                throw new RuntimeException();
            }
            A01[4] = "ZFJR0DMAu8l3jjK6mMcKAcH3eLfgQnHb";
            return c1098Yv.A04(activityInfoArr.length);
        }
