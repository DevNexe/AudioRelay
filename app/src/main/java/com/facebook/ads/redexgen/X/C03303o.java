...
public class C03303o {
    ...
    public C03303o(int i, int i2, int i3, Object obj) {
        this.A00 = i;
        this.A02 = i2;
        this.A01 = i3;
        this.A03 = obj;
    ...
    public final boolean equals(Object obj) {
        ...
        C03303o c03303o = (C03303o) obj;
        int i = this.A00;
        if (i != c03303o.A00) {
            return false;
        }
        if (i == 8 && Math.abs(this.A01 - this.A02) == 1 && this.A01 == c03303o.A02 && this.A02 == c03303o.A01) {
            return true;
        }
        if (this.A01 != c03303o.A01 || this.A02 != c03303o.A02) {
            return false;
        }
        Object obj2 = this.A03;
        if (obj2 != null) {
            if (!obj2.equals(c03303o.A03)) {
                return false;
            }
        } else {
            Object obj3 = c03303o.A03;
            if (A05[2].charAt(7) == 'q') {
                throw new RuntimeException();
            }
