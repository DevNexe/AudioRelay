...
public final class PG extends InputStream {
    ...
    public PG(C1074Xx c1074Xx, FileInputStream fileInputStream, PF pf) {
        ...
        if (messageDigest != null) {
            ...
            try {
                if (i3 > 0) {
                    ...
                    this.A02.A87(C0763Lu.A05(messageDigest.digest()));
                    this.A00 = null;
                }
            } catch (Exception e) {
                this.A00 = null;
                this.A01.A06().A9I(A00(3, 3, 122), C04578z.A13, new AnonymousClass90(e));
            }
        }
        return i3;
    }
