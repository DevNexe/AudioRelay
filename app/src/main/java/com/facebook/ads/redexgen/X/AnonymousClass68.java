...
public final class AnonymousClass68 {
    ...
    public static void A02(@Nullable Activity activity, MotionEvent motionEvent) {
        ...
        try {
            ...
            if (c1074XxA00 != null) {
                c1074XxA00.A06().A8y(A00(20, 7, 86), C04578z.A1F, new AnonymousClass90(th));
            }
        }
    }
    ...
    public static void A03(Context context) {
        ...
        ActivityUtils.A05(new C1203bC());
    }

    public static void A04(C1074Xx c1074Xx, @Nullable String str) {
        MX.A06.execute(new C1206bF(c1074Xx, str));
    }

    @SuppressLint({"CatchGeneralException"})
    public static void A05(C1074Xx c1074Xx, String str) {
        if (!AnonymousClass69.A0P(c1074Xx)) {
            return;
        }
        ...
        C6D c6d = A02.get();
        if (c6d != null) {
            MX.A06.execute(new C1205bE(c6d, str, c1074Xx));
        }
    }

    /* JADX WARN: Type inference failed for: r1v2, types: [com.facebook.ads.redexgen.X.6B] */
    @SuppressLint({"CatchGeneralException"})
    public static synchronized void A07(C1074Xx c1074Xx, @Nullable String str) {
        try {
            if (A02.get() != null) {
                return;
            }
            if (AnonymousClass69.A0P(c1074Xx)) {
                C1201bA c1201bA = new C1201bA(c1074Xx);
                C1202bB c1202bB = new C1202bB(c1074Xx);
                C6C c6cA0J = new Object() { // from class: com.facebook.ads.redexgen.X.6B
                    ...
                    public final C6B A0C(EnumC04176z enumC04176z) {
                        this.A0D = enumC04176z;
                        return this;
                    }
                ...
                }.A0I(true).A04(AnonymousClass69.A05(c1074Xx)).A02(AnonymousClass69.A03(c1074Xx)).A03(AnonymousClass69.A04(c1074Xx)).A06(AnonymousClass69.A07(c1074Xx)).A0G(AnonymousClass69.A0M()).A0A(c1201bA).A09(c1202bB.A00()).A00(AnonymousClass69.A01(c1074Xx)).A0C(EnumC04176z.A0G).A0F(AnonymousClass69.A0D(c1074Xx)).A0H(AnonymousClass69.A0N(c1074Xx)).A05(AnonymousClass69.A06(c1074Xx)).A0D(Build.class).A01(AnonymousClass69.A02(c1074Xx)).A08(AnonymousClass69.A09(c1074Xx)).A07(AnonymousClass69.A08(c1074Xx)).A0B(c1202bB).A0E(A00(0, 20, 65)).A0J();
                if (AnonymousClass69.A0Q(c1074Xx)) {
                    A03(c1074Xx.getApplicationContext());
                }
                C6D c6d = new C6D(c1074Xx, c6cA0J, AnonymousClass69.A0A(c1074Xx));
                if (str != null) {
                    c6d.A06(str);
                }
                A02.set(c6d);
            ...
            c1074Xx.A06().A8y(A00(20, 7, 86), C04578z.A1F, new AnonymousClass90(th));
        }
    }
}
