...
public class C03715e {
    ...
    public C03715e(String str, String str2, @Nullable String str3, boolean z, @Nullable String str4) {
        this.A03 = str;
        this.A02 = str2;
        this.A01 = str3;
        this.A04 = z;
    ...
    public static C03715e A00(JSONObject jSONObject) throws JSONException {
        return new C03715e(jSONObject.getString(A01(30, 3, 81)), jSONObject.getString(A01(26, 4, 105)), jSONObject.optString(A01(5, 9, 70)), jSONObject.getString(A01(14, 8, 105)).equals(A01(22, 4, 106)), jSONObject.optString(A01(0, 5, 91)));
    }
}
