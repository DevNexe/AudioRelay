...
public final class IO {
    ...
    public static int A00(C0678Ii c0678Ii) {
        int iA04 = c0678Ii.A04(5);
        if (iA04 == 31) {
            return c0678Ii.A04(6) + 32;
        }
        return iA04;
    }

    public static int A01(C0678Ii c0678Ii) {
        int iA04 = c0678Ii.A04(4);
        if (iA04 == 15) {
            int samplingFrequency = c0678Ii.A04(24);
    ...
    public static Pair<Integer, Integer> A02(C0678Ii c0678Ii, boolean z) throws C0488Af {
        int iA00 = A00(c0678Ii);
        int channelConfiguration = A01(c0678Ii);
        int iA04 = c0678Ii.A04(4);
        if (iA00 == 5 || iA00 == 29) {
            channelConfiguration = A01(c0678Ii);
            iA00 = A00(c0678Ii);
            if (iA00 == 22) {
                iA04 = c0678Ii.A04(4);
            }
        ...
        if (z) {
            if (iA00 != 1 && iA00 != 2 && iA00 != 3 && iA00 != 4 && iA00 != 6 && iA00 != 7 && iA00 != 17) {
                switch (iA00) {
                    ...
                    case 23:
                        break;
                    default:
                        throw new C0488Af(A04(0, 31, 122) + iA00);
                }
            }
            A06(c0678Ii, iA00, iA04);
            if (A01[4].charAt(0) == 'c') {
                throw new RuntimeException();
            }
            ...
            switch (iA00) {
                ...
                case 22:
                case 23:
                    int channelCount = c0678Ii.A04(2);
                    if (channelCount == 2 || channelCount == 3) {
                        throw new C0488Af(A04(31, 22, 11) + channelCount);
                    }
                    break;
            }
        }
    ...
    public static Pair<Integer, Integer> A03(byte[] bArr) throws C0488Af {
        return A02(new C0678Ii(bArr), false);
    }

    public static void A06(C0678Ii c0678Ii, int i, int i2) {
        c0678Ii.A08(1);
        if (c0678Ii.A0F()) {
            if (A01[5].length() != 13) {
                throw new RuntimeException();
