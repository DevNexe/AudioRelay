...
public final class F6 extends C1229bc {
    public InterfaceC0868Pv A00;

    public final void A04(C1075Xy c1075Xy, NativeBannerAd nativeBannerAd, K7 k7, NativeAdLayout nativeAdLayout) {
        ...
        this.A00 = new C0916Rr(c1075Xy, nativeBannerAd, k7, UB.A0L(nativeBannerAd.getInternalNativeAd()).A17(), adIconView, adOptionsView);
