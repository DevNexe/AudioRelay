...
public final class C0987Ul extends I8 {
    ...
    public C0987Ul(String str, long j, long j2, long j3, @Nullable File file) {
        super(str, j, j2, j3, file);
    }

    @Nullable
    public static C0987Ul A00(File file, IC ic) {
        ...
        return new C0987Ul(strA0C, j, length, Long.parseLong(key2), file);
    }

    public static C0987Ul A01(String str, long j) {
        return new C0987Ul(str, j, -1L, -9223372036854775807L, null);
    }

    public static C0987Ul A02(String str, long j) {
        return new C0987Ul(str, j, -1L, -9223372036854775807L, null);
    }

    public static C0987Ul A03(String str, long j, long j2) {
        return new C0987Ul(str, j, j2, -9223372036854775807L, null);
    }
    ...
    public static File A05(File file, IC ic) {
        ...
        if (matcher.matches()) {
            strGroup = C0695Iz.A0O(matcher.group(1));
            if (strGroup == null) {
                return null;
            }
        } else {
    ...
    public final C0987Ul A08(int i) {
        IK.A04(this.A05);
        long now = System.currentTimeMillis();
        return new C0987Ul(this.A04, this.A02, this.A01, now, A04(this.A03.getParentFile(), i, this.A02, now));
    }
}
