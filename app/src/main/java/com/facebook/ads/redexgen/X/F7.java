...
public class F7 extends C1245bs {
    ...
    @Override // com.facebook.ads.redexgen.X.C1245bs, com.facebook.ads.redexgen.X.InterfaceC0785Mq
    public final void A3s(String rewardedVideoError) {
        ...
        String strA03 = Q9.A09.A02();
        if (rewardedVideoError.equals(strA02)) {
            this.A00.get().finish(11);
        } else if (rewardedVideoError.equals(strA03)) {
            this.A00.get().finish(12);
        }
    }

    @Override // com.facebook.ads.redexgen.X.C1245bs, com.facebook.ads.redexgen.X.InterfaceC0785Mq
    public final void A3t(String str, C04589a c04589a) {
        super.A3t(str, c04589a);
    }
}
