...
public final class C02831r {
    ...
    public static AdSettings.IntegrationErrorMode A00(C1075Xy c1075Xy) {
        ...
        if (integrationErrorMode == AdSettings.IntegrationErrorMode.INTEGRATION_ERROR_CRASH_DEBUG_MODE && !A03(c1075Xy)) {
    ...
    public static boolean A03(C1075Xy c1075Xy) {
        return (c1075Xy.getApplicationInfo().flags & 2) != 0;
    }
}
