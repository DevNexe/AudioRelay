...
public final class C1A extends ViewOnTouchListenerC02731h implements PX {
    ...
    public C1A(C1075Xy c1075Xy) {
        ...
        this.A00 = 0;
        this.A05 = false;
        this.A06 = new BF(c1075Xy, new PU(), new PT());
        A02();
    }

    public C1A(C1075Xy c1075Xy, AttributeSet attributeSet) {
    ...
    public C1A(C1075Xy c1075Xy, AttributeSet attributeSet, int i) {
    ...
    @Override // com.facebook.ads.redexgen.X.ViewOnTouchListenerC02731h
    ...
    public final int A7G(int i) {
        int iAbs = Math.abs(i);
        if (iAbs <= ((ViewOnTouchListenerC02731h) this).A06) {
            return 0;
        }
        int i2 = this.A01;
        if (i2 == 0) {
    ...
    public void setOnPageChangedListener(InterfaceC0790Mv interfaceC0790Mv) {
        this.A04 = interfaceC0790Mv;
    }
