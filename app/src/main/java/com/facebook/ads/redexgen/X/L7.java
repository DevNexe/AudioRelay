...
public final class L7 extends RelativeLayout {
    ...
    public static final AtomicReference<InterfaceC0743Ky> A02 = new AtomicReference<>();
    ...
    private void A07(Throwable th) {
        LF.A00().A8p(3305, th);
        InterfaceC0743Ky interfaceC0743Ky = A02.get();
    ...
    public static void A0B(boolean z, InterfaceC0743Ky interfaceC0743Ky) {
        A01.set(z);
        A02.set(interfaceC0743Ky);
    }
