...
public final class C1025Wa extends D3 {
    public static byte[] A03;
    public final long A00;
    public final List<C1025Wa> A01;
    ...
    public final C1025Wa A06(int i) {
        int size = this.A01.size();
        for (int i2 = 0; i2 < size; i2++) {
            C1025Wa c1025Wa = this.A01.get(i2);
            if (((D3) c1025Wa).A00 == i) {
                return c1025Wa;
            }
        }
    ...
    public final void A08(C1025Wa c1025Wa) {
        this.A01.add(c1025Wa);
    }
