...
public final class WQ implements DV {
    ...
    private final long A01(long j, InterfaceC0536Cd interfaceC0536Cd) throws InterruptedException, IOException {
        if (this.A04 == this.A01) {
            return -(this.A05 + 2);
        }
        long jA7F = interfaceC0536Cd.A7F();
        if (A0D(interfaceC0536Cd, this.A01)) {
            this.A0A.A03(interfaceC0536Cd, false);
            ...
            if (j2 < 0) {
                ...
                long initialPosition = interfaceC0536Cd.A7F();
            ...
            long jA7F2 = interfaceC0536Cd.A7F() - (((long) i) * (j2 > 0 ? 1L : 2L));
            long j4 = this.A01;
            long j5 = this.A04;
            long j6 = (j4 - j5) * j2;
            String[] strArr3 = A0D;
    ...
    private final long A02(InterfaceC0536Cd interfaceC0536Cd) throws InterruptedException, IOException {
        A0C(interfaceC0536Cd);
        this.A0A.A02();
        while ((this.A0A.A04 & 4) != 4 && interfaceC0536Cd.A7F() < this.A08) {
            this.A0A.A03(interfaceC0536Cd, false);
            interfaceC0536Cd.AEt(this.A0A.A01 + this.A0A.A00);
        }
        return this.A0A.A05;
    }

    private final long A03(InterfaceC0536Cd interfaceC0536Cd, long j, long j2) throws InterruptedException, IOException {
        this.A0A.A03(interfaceC0536Cd, false);
    ...
    private final void A0C(InterfaceC0536Cd interfaceC0536Cd) throws InterruptedException, IOException {
        if (A0D(interfaceC0536Cd, this.A08)) {
        } else {
            throw new EOFException();
        }
    }

    private final boolean A0D(InterfaceC0536Cd interfaceC0536Cd, long j) throws InterruptedException, IOException {
        long jMin = Math.min(3 + j, this.A08);
        byte[] bArr = new byte[2048];
        int length = bArr.length;
        while (true) {
            if (interfaceC0536Cd.A7F() + ((long) length) > jMin && (length = (int) (jMin - interfaceC0536Cd.A7F())) < 4) {
                return false;
            }
            interfaceC0536Cd.AD8(bArr, 0, length, false);
            ...
            interfaceC0536Cd.AEt(length - 3);
        }
    }

    @Override // com.facebook.ads.redexgen.X.DV
    public final long ADY(InterfaceC0536Cd interfaceC0536Cd) throws InterruptedException, IOException {
        long jA03;
        int i = this.A00;
        if (i == 0) {
            this.A03 = interfaceC0536Cd.A7F();
            this.A00 = 1;
            ...
            if (j2 == 0) {
                ...
                long jA01 = A01(j2, interfaceC0536Cd);
                if (jA01 >= 0) {
                    return jA01;
                }
                jA03 = A03(interfaceC0536Cd, this.A06, -(jA01 + 2));
            }
            this.A00 = 3;
            return -(2 + jA03);
        }
        this.A07 = A02(interfaceC0536Cd);
        this.A00 = 3;
        return this.A03;
    }
