...
public final class AnonymousClass15 extends BroadcastReceiver {
    ...
    public AbstractC1335dQ A00;
    public AnonymousClass14 A01;
    public String A02;

    public AnonymousClass15(String str, AbstractC1335dQ abstractC1335dQ, AnonymousClass14 anonymousClass14) {
        this.A00 = abstractC1335dQ;
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (Q9.A06.A03(this.A02).equals(action)) {
            ...
            AbstractC1335dQ abstractC1335dQ = this.A00;
            if (A03[1].length() != 11) {
                A03[0] = "z37hhVYNur1y5njE4t22VYTMbB";
                anonymousClass14.ACE(abstractC1335dQ);
                return;
            }
            ...
            if (strArr[3].charAt(16) != strArr[4].charAt(16)) {
                ...
                if (zA1H) {
                    AnonymousClass14 anonymousClass15 = this.A01;
                    AbstractC1335dQ abstractC1335dQ2 = this.A00;
                    ...
                    if (strArr2[3].charAt(16) != strArr2[4].charAt(16)) {
                        ...
                        anonymousClass15.ACF(abstractC1335dQ2, adError);
                        return;
                    }
                    String[] strArr4 = A03;
