...
public final class C04719o {
    ...
    public C04719o(File file) {
        this.A00 = file;
    }

    public static C04719o A00(String str, Context context) throws IOException {
        File file = new File(context.getFilesDir(), A01(64, 9, 55));
        A03(file);
        File file2 = new File(file, str);
        A03(file2);
        return new C04719o(file2);
    }
    ...
    public final C04719o A04(String str) throws IOException {
        File file = new File(this.A00, str);
        A03(file);
        return new C04719o(file);
    }
