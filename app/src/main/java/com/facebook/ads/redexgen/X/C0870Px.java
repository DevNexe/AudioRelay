...
public final class C0870Px {
    ...
    public final InterfaceC0703Jh A01;
    public final QK A02;
    public final SF A06;
    ...
    public final AbstractC0768Lz A05 = new AbstractC0768Lz() { // from class: com.facebook.ads.redexgen.X.8G
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.facebook.ads.redexgen.X.AbstractC04609c
        /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
    ...
    public C0870Px(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, QK qk, String str, @Nullable Map<String, String> map) {
        this.A00 = c1075Xy;
        this.A01 = interfaceC0703Jh;
        this.A07 = str;
        this.A08 = map;
        this.A02 = qk;
    ...
    public final void A09() {
        ...
        if (strA04 != null) {
            InterfaceC0703Jh interfaceC0703Jh = this.A01;
            String encodedFrameData = A0A[4];
            if (encodedFrameData.length() == 13) {
                throw new RuntimeException();
            }
            A0A[3] = "qc6G14080U";
            interfaceC0703Jh.A9H(this.A07, A07(strA04));
        }
    }

    public final void A0A() {
        C0914Rp c0914Rp = new C0914Rp(this);
        if (this.A02.A0l()) {
            MM.A00(c0914Rp);
        } else {
            this.A02.getStateHandler().post(c0914Rp);
        }
    }
}
