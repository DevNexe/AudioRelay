...
public class C0578Ek extends AbstractC1071Xu<String> {
    ...
    public final /* synthetic */ C04398d A03;
    ...
    public C0578Ek(C04398d c04398d, String str, String str2, int i, double d, double d2, String str3, Map map) {
        this.A03 = c04398d;
        this.A06 = str;
        this.A05 = str2;
        this.A02 = i;
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC04418g
    @Nullable
        ...
        try {
            try {
                ...
                if (sQLiteDatabaseA0E.isOpen()) {
                    try {
                        ...
                        this.A03.A01.A06().A8y(strA01, C04578z.A0z, new AnonymousClass90(e));
                    }
                }
                Lock lock = C04398d.A08;
                String[] strArr3 = A09;
                ...
                A01(EnumC04408f.A06);
                this.A03.A01.A06().A8y(strA01, C04578z.A0y, new AnonymousClass90(e2));
                if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                    try {
                        ...
                        this.A03.A01.A06().A8y(strA01, C04578z.A0z, new AnonymousClass90(e3));
                    }
                }
                C04398d.A08.unlock();
                return null;
            ...
            if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                try {
                    ...
                    this.A03.A01.A06().A8y(strA01, C04578z.A0z, new AnonymousClass90(e4));
                }
            }
            C04398d.A08.unlock();
            throw th;
