...
public final class XN implements InterfaceC0701Jf {
    ...
    public XN(C1074Xx c1074Xx, XO xo) {
        this.A00 = c1074Xx;
        this.A01 = xo;
    }
    ...
    private void A02(Set<String> set, Set<String> set2) {
        ...
        if (iA0B > 0) {
            this.A00.A06().A8y(A00(405, 15, 79), C04578z.A10, new AnonymousClass90(A00(28, 44, 46) + iA0B));
        }
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0701Jf
    @Nullable
    public final JSONObject A4H() {
        ...
        for (JSONObject jSONObject2 : listA0C) {
            try {
                String strOptString = jSONObject2.optString(A00(420, 5, 0));
                String string = UUID.randomUUID().toString();
                jSONObject.put(string, strOptString);
                jSONObject2.put(A00(425, 8, 6), string);
        ...
        try {
            if (jSONArray.length() > 0) {
                ...
                if (jSONObject.length() > 0) {
                    jSONObject3.put(A00(433, 6, 28), jSONObject);
                }
                jSONObject3.put(A00(357, 6, 32), jSONArray);
            }
            return jSONObject3;
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                if (eventId.equals(string)) {
                    ...
                    C1074Xx c1074Xx = this.A00;
                    String eventId10 = jSONObject.toString();
                    c8vA01.A8s(c1074Xx, eventId10);
                }
            } catch (JSONException e) {
                if (this.A00.A03().A8P()) {
                    String str3 = A04;
