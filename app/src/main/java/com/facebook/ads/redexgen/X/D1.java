...
public final class D1 {
    ...
    public final long A05(InterfaceC0536Cd interfaceC0536Cd, boolean z, boolean z2, int i) throws InterruptedException, IOException {
        if (this.A01 == 0) {
            if (!interfaceC0536Cd.ADc(this.A02, 0, 1, z)) {
                return -1L;
            }
        ...
        if (i2 != 1) {
            interfaceC0536Cd.readFully(this.A02, 1, i2 - 1);
        }
        this.A01 = 0;
