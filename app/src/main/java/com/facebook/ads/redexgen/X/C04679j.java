...
public final class C04679j {
    ...
    public final int A04(C04679j c04679j) {
        int i = this.A00;
        int i2 = c04679j.A00;
        if (i != i2) {
            return i - i2;
        }
        return this.A01 - c04679j.A01;
    }

    public final C04679j A05(int i) {
        int i2 = this.A01;
        if (i + i2 >= 0) {
            return new C04679j(this.A00, i2 + i);
        }
        throw new IllegalArgumentException(String.format(Locale.US, A00(0, 35, 63), Integer.valueOf(i), Integer.valueOf(this.A01)));
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof C04679j)) {
            return false;
        }
        C04679j c04679j = (C04679j) obj;
        int i = c04679j.A00;
        int i2 = this.A00;
        if (A03[4].charAt(2) != 'U') {
        ...
        return i == i2 && c04679j.A01 == this.A01;
    }
