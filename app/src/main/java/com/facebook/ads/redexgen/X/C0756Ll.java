...
public final class C0756Ll {
    ...
    public final InterfaceC0755Lk A04;

    public C0756Ll(int i, InterfaceC0755Lk interfaceC0755Lk) {
        this(i, interfaceC0755Lk, new Handler());
    }

    @VisibleForTesting
    public C0756Ll(int i, InterfaceC0755Lk interfaceC0755Lk, Handler handler) {
        this.A02 = false;
        this.A00 = i;
        this.A04 = interfaceC0755Lk;
        this.A03 = handler;
    }
    ...
    public final boolean A07() {
        ...
        if (!A04() && !A05()) {
            this.A02 = true;
            this.A04.ABy(this.A00);
            this.A03.postDelayed(new C0968Ts(this), 250L);
            return true;
        }
        if (A05[4].charAt(25) == 'L') {
            throw new RuntimeException();
