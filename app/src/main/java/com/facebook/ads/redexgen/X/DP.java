...
public final class DP {
    ...
    public static void A02() {
        A05 = new byte[]{118, 127, 113, 16, 34, 34, 36, 60, 56, 63, 54, 113, 16, 20, 2, 124, 18, 5, 3, 113, 50, 35, 40, 33, 37, 62, 113, 60, 62, 53, 52, 127, 72, 110, 125, 127, 119, 89, 114, 127, 110, 101, 108, 104, 117, 115, 114, 94, 115, 100, 58, 1, 28, 26, 31, 31, 0, 29, 27, 10, 11, 79, 31, 29, 0, 27, 10, 12, 27, 6, 0, 1, 79, 28, 12, 7, 10, 2, 10, 79, 27, 22, 31, 10, 79, 72, 114, 115, 114, 32, 2, 3, 2, 18, 95, 89, 82, 95, 32, 38, 45, 48};
    }
    ...
    public DP(boolean z, @Nullable String str, int i, byte[] bArr, int i2, int i3, @Nullable byte[] bArr2) {
        ...
        this.A00 = i;
        this.A04 = bArr2;
        this.A01 = new C0544Cn(A00(str), bArr, i2, i3);
    }
