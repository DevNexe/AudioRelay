...
public abstract class DY {
    ...
    public abstract long A07(C0679Ij c0679Ij);

    public abstract boolean A0A(C0679Ij c0679Ij, long j, DX dx) throws InterruptedException, IOException;

    private int A00(InterfaceC0536Cd interfaceC0536Cd) throws InterruptedException, IOException {
        boolean zA0A = true;
        while (zA0A) {
            if (!this.A0C.A05(interfaceC0536Cd)) {
                this.A01 = 3;
                return -1;
            }
            this.A03 = interfaceC0536Cd.A7F() - this.A04;
            zA0A = A0A(this.A0C.A02(), this.A04, this.A09);
            if (zA0A) {
                this.A04 = interfaceC0536Cd.A7F();
            }
        }
        ...
        if (this.A09.A01 != null) {
            ...
            this.A08 = dx.A01;
        } else if (interfaceC0536Cd.A6t() == -1) {
            this.A08 = new WK();
        } else {
            DU duA01 = this.A0C.A01();
            this.A08 = new WQ(this.A04, interfaceC0536Cd.A6t(), this, duA01.A01 + duA01.A00, duA01.A05);
        }
        this.A09 = null;
        this.A01 = 2;
        this.A0C.A04();
    ...
    private int A01(InterfaceC0536Cd interfaceC0536Cd, C0540Cj c0540Cj) throws InterruptedException, IOException {
        long jADY = this.A08.ADY(interfaceC0536Cd);
        if (jADY >= 0) {
            c0540Cj.A00 = jADY;
            return 1;
        }
        ...
        if (this.A03 <= 0 && !this.A0C.A05(interfaceC0536Cd)) {
            this.A01 = 3;
            return -1;
        }
        this.A03 = 0L;
        C0679Ij c0679IjA02 = this.A0C.A02();
        long jA07 = A07(c0679IjA02);
        if (jA07 >= 0) {
            long j = this.A02;
            long granulesInPacket = j + jA07;
            if (granulesInPacket >= this.A05) {
                long jA03 = A03(j);
                this.A07.AEG(c0679IjA02, c0679IjA02.A07());
                this.A07.AEH(jA03, 1, c0679IjA02.A07(), 0, null);
                this.A05 = -1L;
            }
        }
    ...
    public final int A02(InterfaceC0536Cd interfaceC0536Cd, C0540Cj c0540Cj) throws InterruptedException, IOException {
        int i = this.A01;
        if (i == 0) {
            return A00(interfaceC0536Cd);
        }
        if (i == 1) {
            interfaceC0536Cd.AEt((int) this.A04);
            this.A01 = 2;
            return 0;
        }
        if (i == 2) {
            int iA01 = A01(interfaceC0536Cd, c0540Cj);
            if (A0D[6].charAt(6) == 'm') {
                throw new RuntimeException();
            }
    ...
    public final void A06(InterfaceC0537Ce interfaceC0537Ce, InterfaceC0545Co interfaceC0545Co) {
