...
public final class C0916Rr extends LinearLayout implements InterfaceC0868Pv {
    ...
    public C0916Rr(C1075Xy c1075Xy, NativeBannerAd nativeBannerAd, K7 k7, K8 k8, MediaView mediaView, AdOptionsView adOptionsView) {
        ...
        C0865Ps c0865Ps = new C0865Ps(c1075Xy, this.A00, k8, k7, adOptionsView);
        c0865Ps.setPadding(A06, 0, 0, 0);
        LinearLayout.LayoutParams layoutParams4 = new LinearLayout.LayoutParams(0, -2);
        layoutParams4.weight = 1.0f;
        layoutParams4.gravity = 16;
        linearLayout.addView(c0865Ps, layoutParams4);
        if (k8 == K8.A0A) {
            int iconSize = A07;
