...
public final class UB implements com.facebook.ads.Ad, NativeAdBaseApi, Repairable, KD {
    ...
    @Nullable
    @DoNotStrip
    public AbstractC0894Qv A0O;

    @Nullable
    @DoNotStrip
    public AbstractC0894Qv A0P;
    ...
    @Nullable
    public String A0T;
    public WeakReference<C1246bt> A0U;

    @Nullable
    public WeakReference<AbstractC0894Qv> A0V;
    public boolean A0W;
    public boolean A0X;
    public boolean A0Y;
    public boolean A0Z;
    ...
    public UB(Context context, String str, @Nullable K4 k4, boolean z) {
        ...
        this.A0J = KM.A05;
        this.A0E = EnumC0721Jz.A04;
        this.A08 = EnumC02650z.A03;
    ...
    public UB(C1075Xy c1075Xy, C1345da c1345da, @Nullable C9I c9i, @Nullable K4 k4) {
        this((Context) c1075Xy, (String) null, k4, true);
        this.A0a = c1345da;
        this.A0D = c9i;
        this.A0j = true;
        this.A05 = new View(c1075Xy);
    }

    public UB(C1075Xy c1075Xy, C1345da c1345da, @Nullable C9I c9i, K4 k4, @Nullable C1306cw c1306cw) {
        this(c1075Xy, c1345da, c9i, k4);
        this.A0B = c1306cw;
    }
    ...
    private int A01() {
        ...
        C1345da c1345da = this.A0a;
        if (c1345da != null) {
            int iA0C = c1345da.A0C();
            String[] strArr = A0m;
    ...
    public static Drawable A05(C1075Xy c1075Xy, Bitmap bitmap, boolean z, @Nullable String str) {
        BitmapDrawable bitmapDrawableA00;
        BitmapDrawable bitmapDrawable = new BitmapDrawable(c1075Xy.getResources(), bitmap);
        return (!z || (bitmapDrawableA00 = C0854Ph.A00(c1075Xy, str)) == null) ? bitmapDrawable : new LayerDrawable(new Drawable[]{bitmapDrawable, bitmapDrawableA00});
    }
    ...
    @Nullable
    private final C1345da A0C() {
        C1345da c1345da = this.A0a;
        if (c1345da != null && c1345da.A0T()) {
            return c1345da;
        }
        return null;
    }
    ...
    private void A0a() {
        if (!TextUtils.isEmpty(getAdChoicesLinkUrl())) {
            LZ.A0E(new LZ(), this.A0c, C0745La.A00(getAdChoicesLinkUrl()), A1B());
        }
    }
    ...
    private void A0f(View view, View view2, List<View> list, boolean z) {
        ...
        if (nativeAdLayout != null) {
            ((C1229bc) nativeAdLayout.getNativeAdLayoutApi()).A02();
        }
        C1246bt c1246bt = this.A0U.get();
        if (c1246bt != null && c1345daA0C.A08() == 1) {
            c1246bt.A03(EnumC0769Ma.AN_INFO_ICON);
        }
        if (view2 == null) {
            if (this.A0J == KM.A05) {
        ...
        boolean nativeAdBannerViewIsImageView3 = c1345daA0C.A0U();
        if (nativeAdBannerViewIsImageView3) {
            this.A0O = new UG(this);
            this.A0Q = new C0895Qw(view, 1, new WeakReference(this.A0O), this.A0c);
            this.A0Q.A0Y(false);
            this.A0Q.A0X(c1345daA0C.A09());
            this.A0Q.A0U();
            this.A0c.A0D().A9e();
        }
        ...
        int iA00 = A00();
        this.A0P = new UF(this, view2, z4, c1345daA0C);
        ...
        if (JR.A1I(this.A0c)) {
            ...
            InterfaceC0715Jt interfaceC0715JtA09 = A11().A09();
            View view4 = this.A03;
            if (clientToken == null) {
                clientToken = A0W(0, 0, 21);
            }
            interfaceC0715JtA09.AFQ(view4, clientToken, this.A03 instanceof Q3, true);
        }
        this.A0R = new C0895Qw(this.A03, iA00, A03(), true, new WeakReference(this.A0P), this.A0c);
        this.A0R.A0Y(!A0q());
        C0895Qw c0895Qw = this.A0R;
        int viewabilityThreshold = A01();
        c0895Qw.A0W(viewabilityThreshold);
        C0895Qw c0895Qw2 = this.A0R;
        int viewabilityThreshold2 = A02();
        c0895Qw2.A0X(viewabilityThreshold2);
        View view5 = this.A03;
        if (view5 instanceof O4) {
            ((O4) view5).A06(this.A0R);
        }
        this.A09 = new C1336dR(this.A0c, new UC(this, null), this.A0R, this.A0a);
        ...
        if (Build.VERSION.SDK_INT >= 18 && JR.A0w(this.A0c)) {
            ...
            C1345da c1345da = this.A0a;
            if (c1345da != null) {
                int viewabilityThreshold3 = c1345da.A0E().A03();
    ...
    private void A0g(FrameLayout frameLayout, String str) {
        C0855Pi c0855Pi = this.A0N;
        if (c0855Pi != null) {
            frameLayout.removeView(c0855Pi);
        }
        this.A0N = C0854Ph.A01(C5G.A02(this.A0c), str);
        C0855Pi c0855Pi2 = this.A0N;
        if (c0855Pi2 != null) {
            frameLayout.addView(c0855Pi2, new FrameLayout.LayoutParams(-1, -1));
            frameLayout.bringChildToFront(this.A0N);
        }
    }

    private void A0h(@Nullable C1345da c1345da, boolean z) {
        if (c1345da == null) {
            return;
        }
        boolean zEquals = this.A0E.equals(EnumC0721Jz.A04);
        String strA0W = A0W(595, 6, 89);
        if (zEquals) {
            AnonymousClass11 anonymousClass11A0E = c1345da.A0E();
            String strA65 = c1345da.A65();
            if (!TextUtils.isEmpty(strA65)) {
                this.A0b.A0d(new C0711Jp(strA65, this.A0c.A08()));
            }
            if (anonymousClass11A0E.A0G() != null) {
                C7S c7s = new C7S(anonymousClass11A0E.A0G().getUrl(), anonymousClass11A0E.A0G().getHeight(), anonymousClass11A0E.A0G().getWidth(), c1345da.A0G(), A0W(595, 6, 89));
                c7s.A00 = this.A0C;
                this.A0b.A0V();
                this.A0b.A0b(c7s);
            }
            if (!this.A0J.equals(KM.A04)) {
                if (anonymousClass11A0E.A0F() != null) {
                    this.A0b.A0b(new C7S(anonymousClass11A0E.A0F().getUrl(), anonymousClass11A0E.A0F().getHeight(), anonymousClass11A0E.A0F().getWidth(), c1345da.A0G(), A0W(595, 6, 89)));
                }
                List<UB> listA0H = c1345da.A0H();
                String[] strArr = A0m;
                if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                    throw new RuntimeException();
                }
                ...
                if (listA0H != null) {
                    for (UB ub : c1345da.A0H()) {
                        if (ub.getAdCoverImage() != null) {
                            this.A0b.A0b(new C7S(ub.getAdCoverImage().getUrl(), ub.getAdCoverImage().getHeight(), ub.getAdCoverImage().getWidth(), c1345da.A0G(), A0W(595, 6, 89)));
                        }
                    }
                }
                String strA0d = anonymousClass11A0E.A0d();
                if (!TextUtils.isEmpty(strA0d)) {
                    this.A0b.A0a(new C7Q(strA0d, c1345da.A0G(), A0W(595, 6, 89), anonymousClass11A0E.A0A()));
                }
            }
        ...
        this.A0b.A0W(new UI(this, c1345da, z), new C7N(c1345da.A0G(), strA0W));
    }
    ...
    private void A0i(AnonymousClass12 anonymousClass12) {
        ...
        c1345da.A0K(anonymousClass12);
    }

    public static void A0j(NativeAdImageApi nativeAdImageApi, ImageView imageView, C1075Xy c1075Xy) {
        if (nativeAdImageApi != null && imageView != null) {
            new T3(imageView, c1075Xy).A05(nativeAdImageApi.getHeight(), nativeAdImageApi.getWidth()).A07(nativeAdImageApi.getUrl());
        }
    }
    ...
    public final String A1G() {
        C1345da c1345da = this.A0a;
        if (c1345da == null || TextUtils.isEmpty(c1345da.A0E().A0d())) {
            return null;
        }
    ...
    public final void A1I() {
        ...
        C1075Xy c1075Xy = this.A0c;
        NN nnA01 = NO.A01(c1075Xy, c1075Xy.A08(), A1B(), this.A07);
        if (nnA01 == null) {
            A0a();
        } else {
            ((C1229bc) this.A07.getNativeAdLayoutApi()).A03(nnA01);
            nnA01.A0K();
        }
    }
    ...
    public final void A1T(C1345da c1345da) {
        A0h(c1345da, true);
        if (this.A0G != null) {
            List<UB> listA0H = c1345da.A0H();
            String[] strArr = A0m;
    ...
    public final void A1U(@Nullable C1246bt c1246bt) {
        this.A0U = new WeakReference<>(c1246bt);
    }

    public final void A1V(EnumC0721Jz enumC0721Jz, @Nullable String str, C7Z c7z) {
        if (str == null) {
            this.A0c.A0D().A2d();
        } else {
            this.A0c.A0D().A2c();
        ...
        if (this.A0j) {
            AdSettings.IntegrationErrorMode integrationErrorModeA00 = C02831r.A00(this.A0c);
            ...
            if (!AdSettings.IntegrationErrorMode.INTEGRATION_ERROR_CRASH_DEBUG_MODE.equals(integrationErrorModeA00)) {
                ...
                A11().A06().A8y(A0W(542, 3, 15), C04578z.A0c, anonymousClass90);
            } else {
                throw new C02881w(strA0W);
            }
        }
        this.A0j = true;
        this.A0E = enumC0721Jz;
        if (enumC0721Jz.equals(EnumC0721Jz.A05)) {
            this.A08 = EnumC02650z.A05;
        }
        this.A0C = c7z;
        C02811p c02811p = new C02811p(this.A0g, this.A0J, A0R(), null, 1);
        c02811p.A05(enumC0721Jz);
        c02811p.A06(this.A0S);
        c02811p.A07(this.A0T);
        this.A0A = new FO(this.A0c, c02811p);
    ...
    public final void A1Y(KM km) {
        if (!A0q()) {
            if (KM.A04.equals(km)) {
                ...
                c1075Xy.A0D().A2g(AdPlacementType.NATIVE_BANNER.toString(), this.A0g);
            } else {
    ...
    public final void A1Z(AbstractC0894Qv abstractC0894Qv) {
        this.A0V = new WeakReference<>(abstractC0894Qv);
    }
    ...
    public final void A1c(boolean z, boolean z2) {
        ...
        UA ua;
        if (z) {
            boolean zEquals = this.A0E.equals(EnumC0721Jz.A05);
            String[] strArr = A0m;
            if (strArr[0].charAt(5) == strArr[2].charAt(5)) {
                throw new RuntimeException();
            }
            ...
            if (zEquals && !A0q() && (ua = this.A0G) != null) {
                ua.ABT();
            }
            C0895Qw c0895Qw = this.A0R;
            if (c0895Qw != null) {
        ...
        KH khA01 = KH.A01(AdErrorType.BROKEN_MEDIA_ERROR, A0W(85, 21, 41));
        A11().A0D().A2a(MJ.A01(this.A00), khA01.A03().getErrorCode(), khA01.A04());
        this.A0G.AAi(khA01);
    }
    ...
    public final void downloadMedia() {
        if (this.A0E.equals(EnumC0721Jz.A05)) {
            this.A08 = EnumC02650z.A04;
        }
        this.A0E = EnumC0721Jz.A04;
        A0h(this.A0a, false);
    }
    ...
    public final Drawable getPreloadedIconViewDrawable() {
        ...
        if (this.A0a != null && (adIcon = A0F().A0G()) != null && (bitmapA0M = this.A0b.A0M(adIcon.getUrl())) != null) {
            ...
            return A05(c1075XyA11, bitmapA0M, zA1d, A1C());
        }
        return null;
    }
    ...
    public final boolean hasCallToAction() {
        C1345da c1345da = this.A0a;
        return c1345da != null && c1345da.A0S();
    }
    ...
    public final boolean isAdLoaded() {
        C1345da c1345da = this.A0a;
        return c1345da != null && c1345da.A0T();
    }

    @Override // com.facebook.ads.Ad
    public final void loadAd() {
        KV.A05(A0W(559, 6, 14), A0W(374, 24, 23), A0W(545, 7, 3));
        A1V(EnumC0721Jz.A00(NativeAdBase.MediaCacheFlag.ALL), null, new C7Z(false, -1, -1));
    }
    ...
    public final void repair(Throwable th) {
        ...
        A11().A0D().A2a(MJ.A01(this.A00), AdError.INTERNAL_ERROR_CODE, str);
        UA ua = this.A0G;
        if (ua != null) {
            ua.AAi(new KH(AdError.INTERNAL_ERROR_CODE, str));
        }
    }
    ...
    public final void unregisterView() {
        ...
        C0855Pi c0855Pi = this.A0N;
        if (c0855Pi != null) {
            ViewParent parent = c0855Pi.getParent();
            if (parent instanceof ViewGroup) {
                ((ViewGroup) parent).removeView(c0855Pi);
            }
            this.A0N = null;
        }
        ...
        if (A0o.containsKey(this.A04) && A0o.get(this.A04).get() == this) {
            ...
            if (strArr5[4].length() != strArr5[6].length()) {
                String[] strArr6 = A0m;
                strArr6[0] = "lVWmVGygxw0UbRbggHe19cSptvLLteak";
                strArr6[2] = "yD1YSLWVotW9RM3Ng5RpEu8J61bKeSm7";
                if (z) {
                    nh = this.A0K;
                    if (nh != null) {
                        ((ViewGroup) view).removeView(nh);
                        this.A0K = null;
                    }
                }
            } else if (z) {
            ...
            if (Build.VERSION.SDK_INT >= 18 && this.A0L != null && JR.A0w(this.A0c)) {
                this.A0L.A07();
        ...
        throw new IllegalStateException(A0W(473, 38, 15));
    }
}
