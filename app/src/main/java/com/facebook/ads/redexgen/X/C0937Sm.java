...
public final class C0937Sm extends AbstractC0826Of {

    @Nullable
    public static C0937Sm A0S;
    ...
    public final AbstractC02460f A0N;
    public final C0711Jp A0O;
    public final OT A0P;
    public final OU A0Q;
    public final C0693Ix A0R;
    ...
    public C0937Sm(C0830Oj c0830Oj) {
        super(c0830Oj, true);
        this.A01 = 0;
        this.A0G = false;
        this.A0I = false;
        ...
        this.A0O = new C0711Jp(c0830Oj.A04().A0U(), c0830Oj.A06());
        this.A0R = this.A0E.A0A();
        C0693Ix c0693Ix = this.A0R;
        if (c0693Ix != null) {
            MS.A0K(c0693Ix);
        }
        this.A0M = this.A0E.A03();
        this.A0N = C02470g.A01(c0830Oj.A05(), c0830Oj.A06(), c0830Oj.A04().A0U(), C0745La.A00(c0830Oj.A04().A0O().A0F().A05()), new HashMap(), false, true);
        C0824Od.A00(c0830Oj.A05(), this, c0830Oj.A04().A0O().A0D().A07());
        setupLayoutConfiguration(false);
        A0G();
        A0C();
        postDelayed(new C0943Ss(this), 1000L);
        A0J();
        this.A0P = new C0942Sr(this);
        this.A0Q = new OU(c0830Oj, this.A0A, this.A0E.A02() instanceof QK ? (QK) this.A0E.A02() : null, this.A0E.A09(), this.A0P, this.A09, this.A0F, this.A0R, this.A0M);
    }
    ...
    private void A0D() {
        ...
        if (view != null) {
            MS.A0J(view);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC0826Of.A09, AbstractC0826Of.A09);
            layoutParams.addRule(10);
            layoutParams.addRule(11);
            layoutParams.setMargins(AbstractC0826Of.A08, this.A05, AbstractC0826Of.A08, AbstractC0826Of.A08);
    ...
    private void A0E() {
        ...
        if (c0693Ix != null) {
            MS.A0J(c0693Ix);
            C0693Ix c0693Ix2 = this.A0R;
            int i = A0Y;
            c0693Ix2.setPadding(i, i, i, i);
            this.A0R.A06(-1, A0W);
    ...
    private void A0F() {
        AbstractC0784Mp abstractC0784MpA08 = this.A0E.A08();
        if (abstractC0784MpA08 == null) {
            return;
        }
        abstractC0784MpA08.setPageDetailsVisible((this.A0H || abstractC0784MpA08.A05()) ? false : true);
    }
    ...
    private void A0G() {
        ...
        MS.A0K(this.A09);
        C0830Oj c0830Oj = this.A0E;
        this.A0F = new C0837Oq(c0830Oj, c0830Oj.A04().A0O().A0F().A04(), getColors(), new C0941Sq(this));
        MS.A0G(AdError.NO_FILL_ERROR_CODE, this.A0F);
        addView(this.A0F);
        A0I();
        A0B();
    }
    ...
    public void A0O(String str) {
        TE te;
        MS.A0J(this.A0D);
        C0939So c0939So = new C0939So(this);
        if (this.A0E.A05().A0C() == null) {
            this.A0E.A05().A0D().A88();
        }
        if (JS.A02(this.A0E.A05()) || this.A0E.A05().A0C() == null) {
            te = new TE(this.A0E.A05(), c0939So);
        } else {
            te = new TE(this.A0E.A05(), this.A0E.A05().A0C(), c0939So);
        }
        this.A0D = te;
    ...
    public void A0P(boolean z) {
        ...
        int i3;
        this.A0H = z;
        postDelayed(new C0938Sn(this, z), 250L);
        ObjectAnimator ctaTransAnim = null;
        String strA0A = A0A(0, 1, 39);
        if (z) {
            C0837Oq c0837Oq = this.A0F;
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(c0837Oq, strA0A, c0837Oq.getY(), this.A03 / 5);
        } else {
        ...
        C0693Ix c0693Ix = this.A0R;
        int height = c0693Ix == null ? 0 : c0693Ix.getHeight();
        if (z) {
            int i6 = this.A02;
            String[] strArr = A0U;
        ...
        if (c0693Ix2 != null) {
            ...
            fArr3[0] = c0693Ix2.getY();
            String[] strArr3 = A0U;
            if (strArr3[6].length() == strArr3[1].length()) {
                A0U[2] = "uMAfPHErUq8gYLqYGWwvrPw2H7I5hxcd";
                fArr3[1] = i;
                ctaTransAnim = ObjectAnimator.ofFloat(c0693Ix2, strA0A, fArr3);
            }
            throw new RuntimeException();
        }
        int[] iArr = new int[2];
        ...
        duration.addUpdateListener(new C0833Om(this));
        ...
        animatorSet.addListener(new C0834On(this, z));
        animatorSet.start();
    }
    ...
    public final void A0X() {
        AbstractC0784Mp abstractC0784MpA08 = this.A0E.A08();
        if (abstractC0784MpA08 != null) {
            abstractC0784MpA08.setPageDetailsVisible((A0e() || abstractC0784MpA08.A05()) ? false : true);
        }
        this.A0J = false;
    }
    ...
    public final void A0Y() {
        if (this.A0E.A08() != null) {
            ...
            strArr2[0] = "GEB80";
            abstractC0784MpA08.setPageDetailsVisible(false);
        }
        this.A0J = true;
    }
    ...
    private void setUpBrowserControls(TE te) {
        MS.A0J(this.A0B);
        this.A0B = new C0813Ns(this.A0E.A05(), te);
        te.setBrowserNavigationListener(this.A0B.getBrowserNavigationListener());
        MS.A0K(this.A0B);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.weight = 0.1f;
        this.A0B.setListener(new C0940Sp(this));
        this.A0B.setOnTouchListener(new ViewOnTouchListenerC0832Ol(this));
        this.A07.addView(this.A0B, layoutParams);
        MS.A0J(this.A0C);
        this.A0C = new C0814Nt(this.A0E.A05(), null, R.attr.progressBarStyleHorizontal);
