...
import com.facebook.ads.redexgen.X.C02520m;
...
public final class C02520m {
    ...
    public final InterfaceC0703Jh A05;
    public long A00 = 0;
    ...
    public C02520m(InterfaceC0703Jh interfaceC0703Jh, final Activity activity, int i) {
        this.A05 = interfaceC0703Jh;
    ...
    @Nullable
    public static C02520m A00(InterfaceC0703Jh interfaceC0703Jh, @Nullable Activity activity) {
        return A01(interfaceC0703Jh, activity, Build.VERSION.SDK_INT);
    }

    @Nullable
    @VisibleForTesting
    public static C02520m A01(InterfaceC0703Jh interfaceC0703Jh, @Nullable Activity activity, int i) {
        if (activity != null && i >= 14) {
            return new C02520m(interfaceC0703Jh, activity, i);
        }
        return null;
    }

    private void A04(String str, long j, long j2, @Nullable EnumC02450e enumC02450e) {
        HashMap map = new HashMap();
        map.put(A02(9, 10, 8), Long.toString(j));
        map.put(A02(0, 9, 34), Long.toString(j2));
        if (enumC02450e != null) {
            map.put(A02(19, 7, 9), enumC02450e.name());
        }
    ...
    public final void A06(@Nullable EnumC02450e enumC02450e) {
        this.A02 = enumC02450e;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC02450e enumC02450e = EnumC02450e.A03;
        if (A07[2].charAt(6) == '9') {
