...
public final class C0989Un implements IE {
    ...
    public static final C0989Un A04;
    public int A00;
    ...
    static {
        A03();
        A04 = new C0989Un(Collections.emptyMap());
    }

    public C0989Un(Map<String, byte[]> map) {
        Map<String, byte[]> metadata = Collections.unmodifiableMap(map);
        this.A01 = metadata;
    }

    public static C0989Un A00(DataInputStream dataInputStream) throws IOException {
    ...
    public final C0989Un A08(IG ig) {
        Map<String, byte[]> mapA02 = A02(this.A01, ig);
        if (A06(mapA02)) {
            return this;
        }
        return new C0989Un(mapA02);
    }
