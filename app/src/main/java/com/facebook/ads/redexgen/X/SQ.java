...
public abstract class SQ extends FrameLayout implements InterfaceC0786Mr {
    ...
    public final MK A06;
    public final AbstractC0784Mp A07;
    public final InterfaceC0785Mq A08;
    public final NI A09;
    public final C0895Qw A0A;
    public final MF A0B;

    @DoNotStrip
    public final AbstractC0894Qv A0C;
    ...
    public SQ(C1075Xy c1075Xy, NI ni, InterfaceC0703Jh interfaceC0703Jh, AnonymousClass18 anonymousClass18, C7U c7u, InterfaceC0785Mq interfaceC0785Mq) {
        super(c1075Xy);
        ...
        this.A02 = c7u;
        this.A08 = interfaceC0785Mq;
        this.A05 = new C0711Jp(this.A01.A0U(), this.A04);
        this.A0A = new C0895Qw(this, 1, new WeakReference(this.A0C), this.A03);
    ...
    private void A0O() {
        if (this.A01.A0O().A0P()) {
            ...
            C0713Jr.A04(prA0B, this.A05, EnumC0710Jo.A0U);
            addView(prA0B, A0D);
    ...
    public final void A0R(int i, L8 l8) {
        new C0756Ll(i, new ST(this, i, l8)).A07();
    }
