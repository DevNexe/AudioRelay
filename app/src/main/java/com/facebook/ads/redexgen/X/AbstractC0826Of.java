...
public abstract class AbstractC0826Of extends RelativeLayout {
    ...
    public final T1 A05;
    public final C0823Oc A06;
    public final C0830Oj A07;

    public abstract boolean A0c();

    public AbstractC0826Of(C0830Oj c0830Oj, boolean z) {
        C1K c1kA00;
        super(c0830Oj.A05());
        this.A01 = false;
        this.A07 = c0830Oj;
        this.A03 = c0830Oj.A05();
        this.A04 = c0830Oj.A06();
        if (c0830Oj.A00() == 1) {
            c1kA00 = c0830Oj.A04().A0N().A01();
        } else {
            c1kA00 = c0830Oj.A04().A0N().A00();
        }
        this.A00 = c1kA00;
        this.A02 = z;
        this.A05 = new T1(c0830Oj.A05(), c0830Oj.A04().A0T(), this.A00, c0830Oj.A04().A0O().A0F().A06(), c0830Oj.A06(), c0830Oj.A09(), c0830Oj.A0B(), c0830Oj.A07());
        this.A05.setRoundedCornersEnabled(A00());
        this.A05.setViewShowsOverMedia(A0B());
        MS.A0G(AdError.NO_FILL_ERROR_CODE, this.A05);
        this.A06 = new C0823Oc(this.A03, this.A00, this.A02, A01(), A02());
        MS.A0K(this.A06);
    }
    ...
    public C1075Xy getAdContextWrapper() {
        return this.A03;
    }
    ...
    public C0823Oc getTitleDescContainer() {
        return this.A06;
    }
