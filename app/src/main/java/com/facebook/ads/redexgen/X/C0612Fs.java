...
public final class C0612Fs {
    ...
    public final synchronized int A09(AZ az, X2 x2, boolean z, boolean z2, Format format, C0611Fr c0611Fr) {
        if (!A0I()) {
            if (z2) {
                x2.A02(4);
                return -4;
        ...
        c0611Fr.A00 = this.A0C[iA00];
        c0611Fr.A01 = this.A0E[iA00];
        c0611Fr.A02 = this.A0H[iA00];
        this.A03++;
        return -4;
    }
    ...
    public final synchronized void A0G(long j, int i, long j2, int i2, C0544Cn c0544Cn) {
        if (this.A0A) {
            if ((i & 1) == 0) {
                return;
            } else {
        ...
        if (this.A02 == this.A01) {
            ...
            C0544Cn[] c0544CnArr = new C0544Cn[i3];
            ...
            C0544Cn[] c0544CnArr2 = this.A0H;
            int beforeWrap5 = this.A04;
            System.arraycopy(c0544CnArr2, beforeWrap5, c0544CnArr, 0, i4);
            ...
            System.arraycopy(this.A0H, 0, c0544CnArr, i4, i5);
    ...
    public final synchronized boolean A0K(Format format) {
        try {
            ...
            this.A09 = false;
            if (C0695Iz.A0g(format, this.A08)) {
                return false;
            }
            this.A08 = format;
            return true;
