...
public final class C0976Ua implements InterfaceC0702Jg {
    ...
    public final InterfaceC0701Jf A07;
    public final R2 A08;
    public volatile boolean A0C;
    public final Runnable A0A = new C0978Uc(this);
    public final Runnable A09 = new C0977Ub(this);
    ...
    static {
        A07();
        A0F = InterfaceC0702Jg.class.getSimpleName();
    }

    public C0976Ua(C1074Xx c1074Xx, InterfaceC0701Jf interfaceC0701Jf) {
        this.A07 = interfaceC0701Jf;
        this.A06 = c1074Xx;
        this.A04 = (ConnectivityManager) c1074Xx.getSystemService(A03(293, 12, 10));
        this.A08 = RK.A01(c1074Xx);
        this.A03 = JT.A0K(c1074Xx);
        this.A02 = JT.A0J(c1074Xx);
    }

    public static /* synthetic */ int A00(C0976Ua c0976Ua) {
        int i = c0976Ua.A00 + 1;
        c0976Ua.A00 = i;
        return i;
    }
    ...
    public final void A0B() {
        try {
            ...
            this.A06.A03().A8P();
            JSONObject jSONObjectA4H = this.A07.A4H();
            if (jSONObjectA4H == null) {
                this.A06.A03().A8P();
                A05();
                return;
            }
            boolean zA8P = this.A06.A03().A8P();
            String strA03 = A03(309, 6, 45);
            if (zA8P && jSONObjectA4H.has(strA03)) {
                JSONArray jSONArray = jSONObjectA4H.getJSONArray(strA03);
                for (int i = 0; i < i; i++) {
            ...
            A09(jSONObject);
            jSONObjectA4H.put(A03(305, 4, 115), jSONObject);
            RG rg = new RG();
            rg.put(A03(315, 7, 92), jSONObjectA4H.toString());
            R1 r1ADB = this.A08.ADB(this.A06.A03().A6e(), rg.A08());
            String strA5p = r1ADB != null ? r1ADB.A5p() : null;
            if (!TextUtils.isEmpty(strA5p) && r1ADB != null) {
                if (r1ADB.A7a() != 200) {
                    if (this.A06.A03().A8P()) {
                        String str2 = A0F;
                        StringBuilder sb = new StringBuilder();
                        String responseBody = A03(138, 48, 68);
                        sb.append(responseBody);
                        sb.append(r1ADB.A7a());
                        String responseBody2 = A03(3, 1, 78);
                        sb.append(responseBody2);
                        String responseBody3 = sb.toString();
                        Log.e(str2, responseBody3);
                    }
                    int iA7a = r1ADB.A7a();
                    String responseBody4 = A0E[4];
                    if (responseBody4.length() != 29) {
                        String[] strArr = A0E;
                        strArr[1] = "880m74azdbQx5kAj6";
                        strArr[3] = "QSHShLBOeb5hWYBY9";
                        if (iA7a == 413 && JR.A1j(this.A06)) {
                            this.A07.AC2();
                            A05();
                            return;
                        } else {
                            if (jSONObjectA4H.has(strA03)) {
                                this.A07.AAU(jSONObjectA4H.getJSONArray(strA03));
                            }
                            A06();
                            return;
                        }
                ...
                if (!this.A07.AAW(new JSONArray(strA5p))) {
                    if (this.A06.A03().A8P()) {
                        String str3 = A0F;
                        String responseBody5 = A03(186, 54, 24);
                        Log.w(str3, responseBody5);
                    }
                    A06();
                    return;
                }
                if (this.A07.A8a()) {
                    if (this.A06.A03().A8P()) {
                        String str4 = A0F;
                        String responseBody6 = A03(58, 55, 57);
                        Log.i(str4, responseBody6);
                    }
                    A06();
                    return;
                }
            ...
            if (this.A06.A03().A8P()) {
                String str5 = A0F;
                String responseBody7 = A03(113, 25, 112);
                Log.e(str5, responseBody7);
            }
            if (JR.A1a(this.A06) && jSONObjectA4H.has(strA03)) {
                this.A07.AAU(jSONObjectA4H.getJSONArray(strA03));
            }
            A06();
        } catch (Exception e) {
            if (this.A06.A03().A8P()) {
                String str6 = A0F;
                String responseBody8 = A03(23, 35, 54);
                Log.e(str6, responseBody8, e);
            }
            A06();
        }
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0702Jg
