...
public class C5R extends AsyncTask<C5T, Void, Drawable> {
    ...
    public C5R(C1075Xy c1075Xy, C5S c5s, boolean z) {
        this.A01 = c1075Xy;
        this.A00 = c5s;
        this.A02 = z;
    }

    public /* synthetic */ C5R(C1075Xy c1075Xy, C5S c5s, boolean z, C1222bV c1222bV) {
        this(c1075Xy, c5s, z);
    }
            ...
            try {
                if (c5tArr.length >= 1) {
                    ...
                    try {
                        ...
                        this.A01.A06().A8y(A01(0, 7, 42), C04578z.A1V, new AnonymousClass90(th));
                    }
                    if (bitmapA0N != null) {
