...
public final class XD implements InterfaceC0493Ak, EJ, BT, JN, InterfaceC0608Fo, HY, CA {
    ...
    public XD(@Nullable InterfaceC0498Ap interfaceC0498Ap, IN in) {
        this.A00 = interfaceC0498Ap;
    ...
    private B5 A05(@Nullable B4 b4) {
        if (b4 == null) {
            int iA6I = ((InterfaceC0498Ap) IK.A01(this.A00)).A6I();
    ...
    @Override // com.facebook.ads.redexgen.X.BT
    public final void AA5(C0530Bw c0530Bw) {
        B5 b5A00 = A00();
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next().onDecoderDisabled(b5A00, 1, c0530Bw);
        }
    }

    @Override // com.facebook.ads.redexgen.X.BT
    public final void AA6(C0530Bw c0530Bw) {
        B5 b5A02 = A02();
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next().onDecoderEnabled(b5A02, 1, c0530Bw);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0608Fo
    public final void AAZ(int i, @Nullable FY fy, C0607Fn c0607Fn) {
        B5 b5A04 = A04(i, fy);
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next().onDownstreamFormatChanged(b5A04, c0607Fn);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0608Fo
    public final void ABE(int i, @Nullable FY fy, C0606Fm c0606Fm, C0607Fn c0607Fn) {
        A04(i, fy);
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0608Fo
    public final void ABG(int i, @Nullable FY fy, C0606Fm c0606Fm, C0607Fn c0607Fn) {
        A04(i, fy);
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0608Fo
    public final void ABJ(int i, @Nullable FY fy, C0606Fm c0606Fm, C0607Fn c0607Fn, IOException iOException, boolean z) {
        B5 b5A04 = A04(i, fy);
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next().onLoadError(b5A04, c0606Fm, c0607Fn, iOException, z);
        }
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0608Fo
    public final void ABL(int i, @Nullable FY fy, C0606Fm c0606Fm, C0607Fn c0607Fn) {
        A04(i, fy);
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0493Ak
    ...
    public final void ABo(C0490Ah c0490Ah) {
        ...
        for (B6 b6 : this.A04) {
            ...
            b6.onPlaybackParametersChanged(b5A02, c0490Ah);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.JN
    public final void ACh(C0530Bw c0530Bw) {
        B5 b5A00 = A00();
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next().onDecoderDisabled(b5A00, 2, c0530Bw);
        }
    }

    @Override // com.facebook.ads.redexgen.X.JN
    public final void ACi(C0530Bw c0530Bw) {
        B5 b5A02 = A02();
        Iterator<B6> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next().onDecoderEnabled(b5A02, 2, c0530Bw);
        }
    }
