...
public final class V3 implements InterfaceC0650He {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0650He
    public final long ACw(C0654Hi c0654Hi) throws C0656Hl {
        try {
            this.A01 = c0654Hi.A04;
            this.A02 = new RandomAccessFile(c0654Hi.A04.getPath(), A00(0, 1, 72));
            this.A02.seek(c0654Hi.A03);
            this.A00 = c0654Hi.A02 == -1 ? this.A02.length() - c0654Hi.A03 : c0654Hi.A02;
            if (this.A00 >= 0) {
                this.A03 = true;
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0650He
    public final void close() throws C0656Hl {
        this.A01 = null;
        try {
            try {
                if (this.A02 != null) {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0650He
    public final int read(byte[] bArr, int i, int i2) throws C0656Hl {
        if (i2 == 0) {
            return 0;
        }
        long j = this.A00;
