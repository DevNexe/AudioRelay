...
public final class AnonymousClass32 extends AbstractC0522Bo {
    ...
    public final ArrayList<C0624Ge> A0B = new ArrayList<>();
    public C0624Ge A04 = new C0624Ge(0, 4);
    ...
    static {
        ...
        A0I = new int[]{193, RCHTTPStatusCodes.CREATED, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, 192, 194, 199, RCHTTPStatusCodes.SUCCESS, 202, 203, 235, 206, 207, 239, 212, 217, 249, 219, 171, 187};
    ...
    private void A0A(byte b, byte b2) {
        ...
        if (i != this.A04.A04()) {
            ...
            if (i2 != 1 && !this.A04.A0F()) {
                this.A04 = new C0624Ge(this.A02, this.A03);
                this.A0B.add(this.A04);
            }
            this.A04.A0C(i);
        }
    ...
    public final void A0P(C0531Bx c0531Bx) {
        this.A0A.A0b(c0531Bx.A01.array(), c0531Bx.A01.limit());
        boolean z = false;
        boolean zA0E = false;
        while (true) {
