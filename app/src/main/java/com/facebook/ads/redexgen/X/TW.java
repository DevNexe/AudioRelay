...
public abstract class TW extends RelativeLayout implements InterfaceC0786Mr {
    ...
    public final C1328dJ A08;
    public final C1075Xy A09;
    public final InterfaceC0703Jh A0A;
    public final C0711Jp A0B;
    public final AbstractC0784Mp A0C;
    ...
    public TW(C1075Xy c1075Xy, InterfaceC0703Jh interfaceC0703Jh, InterfaceC0785Mq interfaceC0785Mq, C1328dJ c1328dJ) {
        super(c1075Xy);
        this.A04 = false;
        this.A03 = false;
        this.A09 = c1075Xy;
        this.A0A = interfaceC0703Jh;
        this.A07 = interfaceC0785Mq;
        this.A06 = new MF(this);
        this.A08 = c1328dJ;
        this.A0B = new C0711Jp(this.A08.A0U(), this.A0A);
    ...
    private void A0N() {
        ...
        if (A0X() && this.A02 == null) {
            ...
            C0713Jr.A04(this.A02, this.A0B, EnumC0710Jo.A0U);
    ...
    public final void A0S() {
        View view = this.A00;
        if (view == null || !(view instanceof AbstractC0826Of)) {
            return;
        }
        if (A0Y()) {
            ((AbstractC0826Of) this.A00).A0a();
        } else {
            ((AbstractC0826Of) this.A00).A0Z();
        }
    }

    public final void A0T(int i) {
        this.A01 = new C0756Ll(i, new TX(this, i));
        this.A03 = true;
        A0S();
        this.A01.A07();
    }
    ...
    public final void A0V(AnonymousClass59 anonymousClass59) {
        ...
        this.A0C.setToolbarListener(new C0951Ta(this, anonymousClass59));
    }

    public final void A0W(AnonymousClass59 anonymousClass59) {
        AlphaAnimation alphaAnimation = new AlphaAnimation(1.0f, 0.0f);
        alphaAnimation.setDuration(200L);
        alphaAnimation.setAnimationListener(new AnimationAnimationListenerC0792Mx(this, this, anonymousClass59));
    ...
    public void ABj(boolean z) {
        C0756Ll c0756Ll = this.A01;
        if (c0756Ll != null && c0756Ll.A05()) {
            this.A01.A06();
        }
    }
    ...
    public InterfaceC0785Mq getAudienceNetworkListener() {
        return this.A07;
    }
