...
public class GE extends AbstractC1361dr<EnumC02430c> {
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC1361dr
    /* JADX INFO: renamed from: A05, reason: merged with bridge method [inline-methods] */
    public final C0W A04(@Nullable EnumC02430c enumC02430c) {
        String strA02;
        if (enumC02430c != null) {
            strA02 = enumC02430c.A02();
        } else {
