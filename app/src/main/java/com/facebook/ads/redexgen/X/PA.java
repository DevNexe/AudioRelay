...
public final class PA {
    ...
    public final InterfaceC0703Jh A0C;
    public final C0711Jp A0D;
    public final C0844Ox A0E;
    public final SX A0F;
    public final PL A0G;
    public final PM A0H;
    ...
    public PA(C1075Xy c1075Xy, AnonymousClass18 anonymousClass18, InterfaceC0703Jh interfaceC0703Jh, int i) {
        this.A0B = c1075Xy;
        this.A0C = interfaceC0703Jh;
        this.A09 = anonymousClass18;
        this.A08 = i;
        this.A0F = new SX(this, c1075Xy);
        this.A0A = new C7U(this.A0B);
        this.A0D = new C0711Jp(anonymousClass18.A0U(), interfaceC0703Jh);
        this.A0E = new C0844Ox(anonymousClass18.A0Z(), anonymousClass18.A0O().A0D().A08(), i);
        this.A0H = PN.A00(this.A0B, anonymousClass18.A0d(), this.A0A, this.A0D, this.A0E, A0H());
        this.A0G = new PL(this.A0B, this, interfaceC0703Jh, this.A0E, this.A0I, anonymousClass18.A0U());
    }
        ...
        if (this.A06) {
            while (!this.A0J.isEmpty()) {
                ...
                if (p7Poll != null) {
                    ...
                    if (p7Poll.A01) {
                        this.A0D.A02(EnumC0710Jo.A0L, null);
    ...
    private boolean A0I() {
        return JR.A27(this.A0B, C0879Qg.A03());
    }

    public final C0711Jp A0K() {
        return this.A0D;
    }
    ...
    public final C0844Ox A0M() {
        return this.A0E;
    }

    @Nullable
    public final InterfaceC0846Oz A0N() {
        return this.A02;
    }
    ...
    public final void A0W() {
        A0F(new P7(A0A(RCHTTPStatusCodes.NOT_FOUND, 22, 122), new String[]{this.A0I}));
    }
    ...
    public final void A0X() {
        ...
        this.A0D.A02(EnumC0710Jo.A0O, null);
        if (this.A08 == 3) {
            str = this.A0H.A00;
        } else {
            str = this.A0H.A01;
    ...
    public final void A0a(@Nullable InterfaceC0846Oz interfaceC0846Oz) {
        this.A02 = interfaceC0846Oz;
    }
    ...
    public final void A0e(@Nullable C0895Qw c0895Qw) {
        this.A05 = c0895Qw;
    }
    ...
    public final void A0i(Map<String, String> map) {
        ...
        if (map.containsKey(strA0A) && JR.A1J(this.A0B)) {
            try {
                ...
                for (int i = 0; i < i; i++) {
                    ...
                    if (string != null && string2 != null && string3 != null) {
                        SG sg = new SG(this.A09.A0U(), Long.parseLong(string), Long.parseLong(string2), Long.parseLong(string3));
                        sg.A05(Long.parseLong(string4));
                        arrayList.add(sg);
                    }
                }
                String strA04 = SF.A04(arrayList);
                HashMap map2 = new HashMap();
                map2.put(A0A(115, 6, 84), strA04);
                if (strA04 != null) {
                    this.A0C.A9H(this.A09.A0U(), map2);
                }
            } catch (Exception e) {
                this.A0B.A06().A8y(A0A(274, 14, 27), 3600, new AnonymousClass90(e));
            }
        }
        if (map.containsKey(strA0A)) {
            map.remove(strA0A);
        }
        this.A0C.A8x(this.A09.A0U(), new OG(map).A03(this.A05).A05());
    }
