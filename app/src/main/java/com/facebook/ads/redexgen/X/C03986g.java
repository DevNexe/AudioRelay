...
public final class C03986g {
    ...
    public C03986g(int i, int i2, int i3, float[] fArr, float f, float f2, float f3) {
        this.A05 = i;
        this.A03 = i2;
        this.A04 = i3;
        this.A06 = fArr;
    ...
    public final boolean A0B(C03986g c03986g) {
        if (A05() == c03986g.A05() && A03() == c03986g.A03() && A04() == c03986g.A04()) {
            float fAbs = Math.abs(A08()[0] - c03986g.A08()[0]);
            String[] strArr = A08;
            ...
            if (fAbs < C6C.A01() && Math.abs(A08()[1] - c03986g.A08()[1]) < C6C.A01()) {
                float fAbs2 = Math.abs(A02() - c03986g.A02());
                float fA01 = C6C.A01();
                String[] strArr3 = A08;
                ...
                if (fAbs2 < fA01 && Math.abs(A01() - c03986g.A01()) < C6C.A01() && Math.abs(A00() - c03986g.A00()) < C6C.A01()) {
                    return true;
                }
            }
        }
