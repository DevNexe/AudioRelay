...
public class C1245bs implements InterfaceC0785Mq {
    ...
    public C1245bs(AnonymousClass59 anonymousClass59) {
        this.A00 = new WeakReference<>(anonymousClass59);
    }

    private void A00(AnonymousClass59 anonymousClass59) {
        C0855Pi c0855Pi = anonymousClass59.A0C;
        if (c0855Pi != null) {
            anonymousClass59.A06.bringChildToFront(c0855Pi);
        }
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0785Mq
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0785Mq
    public void A3t(String str, C04589a c04589a) {
        if (this.A00.get() != null) {
            this.A00.get().A0F(str, c04589a);
        }
    }
