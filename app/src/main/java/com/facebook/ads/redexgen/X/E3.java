...
public final class E3 implements XH {
    ...
    public final E1 A0E;
    public final C0507Az A0F;
    public final B0 A0G;
    public final HT A0H;
    public final HU A0I;
    public final ArrayDeque<AQ> A0J;
    public final CopyOnWriteArraySet<InterfaceC0493Ak> A0K;
    public final XG[] A0L;
    ...
    public E3(XG[] xgArr, HT ht, InterfaceC0484Ab interfaceC0484Ab, IN in) {
        Log.i(A02(2, 13, 112), A02(33, 5, 52) + Integer.toHexString(System.identityHashCode(this)) + A02(0, 2, 7) + A02(15, 18, 78) + A02(47, 3, 94) + C0695Iz.A04 + A02(46, 1, 86));
        ...
        this.A0I = new HU(new C0504Av[xgArr.length], new HQ[xgArr.length], null);
        this.A0G = new B0();
        this.A0F = new C0507Az();
        this.A07 = C0490Ah.A04;
        this.A0C = new AP(this, Looper.myLooper() != null ? Looper.myLooper() : Looper.getMainLooper());
        this.A06 = new C0489Ag(B1.A01, 0L, TrackGroupArray.A04, this.A0I);
        this.A0J = new ArrayDeque<>();
        this.A0E = new E1(xgArr, ht, this.A0I, interfaceC0484Ab, this.A0A, this.A03, this.A0B, this.A0C, this, in);
    ...
    private C0489Ag A01(boolean z, boolean z2, int i) {
        if (z) {
            this.A01 = 0;
            this.A00 = 0;
            this.A04 = 0L;
        ...
        C0489Ag c0489Ag = new C0489Ag(z2 ? B1.A01 : this.A06.A03, z2 ? null : this.A06.A07, this.A06.A04, this.A06.A02, this.A06.A01, i, false, z2 ? TrackGroupArray.A04 : this.A06.A05, z2 ? this.A0I : this.A06.A06);
        String[] strArr = A0N;
    ...
    private void A04(C0489Ag c0489Ag, int i, boolean z, int timelineChangeReason) {
        int i2;
        C0489Ag c0489AgA04 = c0489Ag;
        this.A02 -= i;
        if (this.A02 == 0) {
            if (c0489AgA04.A02 == -9223372036854775807L) {
                c0489AgA04 = c0489AgA04.A04(c0489AgA04.A04, 0L, c0489AgA04.A01);
            }
            if (!this.A06.A03.A0E() || this.A08) {
                B1 b1 = c0489AgA04.A03;
                String[] strArr = A0N;
            ...
            this.A08 = false;
            this.A09 = false;
            A05(c0489AgA04, z, timelineChangeReason, i2, z2, false);
        }
    }

    private void A05(C0489Ag c0489Ag, boolean z, int i, int i2, boolean z2, boolean z3) {
        boolean z4 = !this.A0J.isEmpty();
        this.A0J.addLast(new AQ(c0489Ag, this.A06, this.A0K, this.A0H, z, i, i2, z2, this.A0A, z3));
        this.A06 = c0489Ag;
        if (z4) {
            return;
        }
    ...
    public final void A09(int i, long j) {
                ...
                if (zA0E || i < b1.A01()) {
                    ...
                    if (A0N[7].length() != 1) {
                        ...
                        if (zA0B) {
                            ...
                            for (InterfaceC0493Ak interfaceC0493Ak : this.A0K) {
                                String[] strArr4 = A0N;
        ...
        throw new C0483Aa(b1, i, j);
    }

    public final void A0A(Message message) {
        int i = message.what;
        if (i == 0) {
            A04((C0489Ag) message.obj, message.arg1, message.arg2 != -1, message.arg2);
            return;
        }
        if (i != 1) {
            String[] strArr = A0N;
            if (strArr[4].length() == strArr[0].length()) {
                ...
                if (i == 2) {
                    ...
                    this.A05 = am;
                    Iterator<InterfaceC0493Ak> it = this.A0K.iterator();
                    while (true) {
            ...
            C0490Ah c0490Ah = (C0490Ah) message.obj;
            if (!this.A07.equals(c0490Ah)) {
                this.A07 = c0490Ah;
                CopyOnWriteArraySet<InterfaceC0493Ak> copyOnWriteArraySet = this.A0K;
                String[] strArr3 = A0N;
                if (strArr3[6].length() == strArr3[2].length()) {
                    String[] strArr4 = A0N;
                    strArr4[1] = "XPkhdR3hZ8JGZkbg";
                    strArr4[3] = "HitM1md97HqEAHyx";
                    Iterator<InterfaceC0493Ak> it2 = copyOnWriteArraySet.iterator();
                    while (it2.hasNext()) {
                        it2.next().ABo(c0490Ah);
                    }
                    return;
                }
            } else {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0498Ap
    public final void A3E(InterfaceC0493Ak interfaceC0493Ak) {
        this.A0K.add(interfaceC0493Ak);
    }

    @Override // com.facebook.ads.redexgen.X.XH
    public final C0501As A4L(InterfaceC0500Ar interfaceC0500Ar) {
        return new C0501As(this.A0E, interfaceC0500Ar, this.A06.A03, A6I(), this.A0D);
    }
    ...
    public final int A5r() {
        ...
        if (jA5s != -9223372036854775807L) {
            ...
            if (jA6R != -9223372036854775807L) {
                ...
                return C0695Iz.A06((int) ((100 * jA5s) / jA6R), 0, 100);
            }
        }
        return 0;
    }
    ...
    @Override // com.facebook.ads.redexgen.X.XH
    public final void ADH(InterfaceC0594Fa interfaceC0594Fa, boolean z, boolean z2) {
        this.A05 = null;
        C0489Ag c0489AgA01 = A01(z, z2, 2);
        this.A08 = true;
        this.A02++;
        this.A0E.A0z(interfaceC0594Fa, z, z2);
        A05(c0489AgA01, false, 4, 1, false, false);
    }
