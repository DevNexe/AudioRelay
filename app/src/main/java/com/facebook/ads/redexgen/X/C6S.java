...
public final class C6S {
    ...
    public final synchronized void A04(Map<Integer, C04106s> map, EnumC04146w enumC04146w) {
        A02();
        C6W c6w = new C6W(this.A05, map);
        for (Map.Entry<Integer, C04106s> entry : map.entrySet()) {
            C04106s value = entry.getValue();
            if (value != null && value.A04(enumC04146w)) {
                int iIntValue = entry.getKey().intValue();
                if (iIntValue != 10800) {
                    switch (iIntValue) {
                        case 10810:
                            this.A03.add(EnumC03976f.A04);
                            break;
                        case 10811:
                            this.A03.add(EnumC03976f.A08);
                            break;
                        case 10812:
                            this.A03.add(EnumC03976f.A0A);
                            break;
                        case 10813:
                            this.A03.add(EnumC03976f.A07);
                            break;
                        case 10814:
                            this.A03.add(EnumC03976f.A0B);
                            break;
                        case 10815:
                            this.A03.add(EnumC03976f.A0C);
                            break;
                        case 10816:
                            this.A03.add(EnumC03976f.A0E);
                            break;
                        case 10817:
                            this.A03.add(EnumC03976f.A09);
                            break;
                        case 10818:
                            this.A03.add(EnumC03976f.A06);
                            break;
                        case 10819:
                            this.A03.add(EnumC03976f.A05);
                            break;
                        case 10820:
                            this.A03.add(EnumC03976f.A0D);
                            break;
                    }
                } else {
                    this.A02 = new C03946c(this.A04, c6w, this.A06);
                    A08.set(true);
                }
            }
        }
        this.A01 = new C03936b(this.A04, c6w, this.A06);
