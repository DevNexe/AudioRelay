...
public class C0884Ql implements MediaController.MediaPlayerControl {
    ...
    public final void pause() {
        if (this.A00.A0F != null) {
            InterfaceC0893Qu interfaceC0893Qu = this.A00.A0F;
            String[] strArr = A01;
            if (strArr[1].length() == strArr[5].length()) {
                throw new RuntimeException();
            }
            A01[3] = "BHfWGVDMvGTMo8ZI3A6S5KtrLH6Ee";
            interfaceC0893Qu.ABR();
        }
    }
