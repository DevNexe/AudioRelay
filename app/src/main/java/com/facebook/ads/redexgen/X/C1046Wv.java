...
public final class C1046Wv implements InterfaceC0542Cl {
    ...
    public C1046Wv(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    private final int A00(long j) {
        return C0695Iz.A0B(this.A04, j, true, true);
    }
    ...
    public final C0541Ck A7O(long j) {
        int iA00 = A00(j);
        C0543Cm c0543Cm = new C0543Cm(this.A04[iA00], this.A03[iA00]);
        if (c0543Cm.A01 >= j || iA00 == this.A00 - 1) {
            return new C0541Ck(c0543Cm);
        }
        return new C0541Ck(c0543Cm, new C0543Cm(this.A04[iA00 + 1], this.A03[iA00 + 1]));
    }
