...
public enum EnumC03815o {
    ...
    EnumC03815o(String str) {
        this.A00 = str;
    }

    @Nullable
    public static EnumC03815o A00(@Nullable String str) {
        for (EnumC03815o enumC03815o : values()) {
            if (enumC03815o.A00.equals(str)) {
                return enumC03815o;
            }
        }
        return null;
