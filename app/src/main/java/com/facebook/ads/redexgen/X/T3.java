...
public final class T3 extends AsyncTask<String, Void, Bitmap[]> implements C8S {
    ...
    public final WeakReference<C1075Xy> A07;
    ...
    public T3(ViewGroup viewGroup, int i, int i2, C1075Xy c1075Xy) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c1075Xy);
        this.A06 = null;
        this.A08 = null;
    ...
    public T3(ViewGroup viewGroup, C1075Xy c1075Xy) {
        this(viewGroup, 12, 16, c1075Xy);
    }

    public T3(ImageView imageView, C1075Xy c1075Xy) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c1075Xy);
    ...
    public T3(OD od, C1075Xy c1075Xy) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c1075Xy);
    ...
    private final Bitmap[] A03(String... strArr) throws Throwable {
        ...
        try {
            ...
            C1075Xy c1075Xy = this.A07.get();
            if (c1075Xy == null) {
                return new Bitmap[]{null, null};
            }
            try {
                bitmapA0N = new C7U(c1075Xy).A0N(str, this.A00, this.A01);
                if (bitmapA0N != null && !this.A03) {
                    bitmapA01 = MZ.A01(c1075Xy, bitmapA0N, this.A04, this.A05);
                }
            } catch (Throwable th) {
                c1075Xy.A06().A8y(A00(0, 7, 16), C04578z.A1V, new AnonymousClass90(th));
            }
