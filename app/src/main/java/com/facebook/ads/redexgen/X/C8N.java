...
public final class C8N extends SQ {
    ...
    public final C0870Px A0A;
    public final QK A0B;
    public final AnonymousClass89 A0C;
    public final N6 A0D;
    public final N4 A0E;
    public final AbstractC0768Lz A0F;
    public final AbstractC0754Lj A0G;
    public final L4 A0H;
    public final L3 A0I;
    public final KS A0J;
    public final C0693Ix A0K;
    ...
    public C8N(C1075Xy c1075Xy, NI ni, InterfaceC0703Jh interfaceC0703Jh, AnonymousClass18 anonymousClass18, C7U c7u, InterfaceC0785Mq interfaceC0785Mq) {
        ...
        this.A0G = new AbstractC0754Lj() { // from class: com.facebook.ads.redexgen.X.9B
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.X.AbstractC04609c
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0F = new AbstractC0768Lz() { // from class: com.facebook.ads.redexgen.X.9A
            @Override // com.facebook.ads.redexgen.X.AbstractC04609c
            public final /* bridge */ /* synthetic */ void A03(C04589a c04589a) {
            }
        };
        ...
        this.A0D = new N6() { // from class: com.facebook.ads.redexgen.X.8v
            ...
            public final void A03(AnonymousClass88 anonymousClass88) {
                C8N c8n = this.A00;
                c8n.A0D(anonymousClass88, c8n.A0B.getState() != EnumC0892Qt.A06, false);
            }
        };
        ...
        if (JR.A1J(super.A03)) {
            this.A0A = new C0870Px(super.A03, super.A04, this.A0B, super.A01.A0U(), null);
        } else {
            this.A0A = null;
        }
        this.A01 = new C0864Pr(super.A03, super.A09, super.A01.A0a(), interfaceC0785Mq);
        this.A0J = new KS(super.A03, super.A05);
        this.A0K = new C0693Ix(super.A03);
        A07();
    ...
    private AbstractC0826Of A00(int i) {
        return C0827Og.A00(new C0829Oi(super.A03, super.A04, super.A08, super.A01, this.A0B, super.A0A, super.A06).A0E(super.A07.getToolbarHeight()).A0H(super.A07).A0D(i).A0F(this.A0J).A0I(this.A0K).A0J(), null, true);
    }
    ...
    private void A07() {
        ...
        if (!TextUtils.isEmpty(super.A01.A0O().A0D().A07())) {
            C04267m c04267m = new C04267m(super.A03);
            this.A0B.A0c(c04267m);
            c04267m.setImage(super.A01.A0O().A0D().A07());
        }
        C04076p c04076p = new C04076p(super.A03, true, super.A05);
        this.A0B.A0c(c04076p);
        this.A0B.A0c(new KT(c04076p, QJ.A03, true));
        this.A0B.A0c(new C04207c(super.A03));
    }
    ...
    public void A0D(AnonymousClass88 anonymousClass88, boolean z, boolean z2) {
        ...
        AbstractC0826Of abstractC0826Of = this.A00;
        if (abstractC0826Of != null) {
            abstractC0826Of.A09(anonymousClass88);
        }
    ...
    public void A0E(AnonymousClass84 anonymousClass84) {
        if (this.A0B.getState() == EnumC0892Qt.A02 && JR.A11(super.A03)) {
    ...
    public void A0F(AnonymousClass84 anonymousClass84) {
        ...
        if (this.A03) {
            int iA02 = super.A01.A0O().A0D().A02() - (iA00 / AdError.NETWORK_ERROR_CODE);
            if (iA02 > 0) {
    ...
    public void A0G(String str) {
        ...
        InterfaceC0785Mq interfaceC0785Mq = super.A08;
        if (A0M[3].charAt(0) == 'z') {
            throw new RuntimeException();
        }
        A0M[3] = "uhCmlX27t5rzSWT78KYVdoY12DutI5Be";
        interfaceC0785Mq.A3s(super.A09.A6Z());
    ...
    public final void A0Q() {
        ...
        AbstractC0826Of abstractC0826Of = this.A00;
        if (abstractC0826Of != null && this.A03) {
            abstractC0826Of.A0Y();
        }
        AbstractC0826Of abstractC0826Of2 = this.A00;
        if (abstractC0826Of2 != null && !this.A05) {
            abstractC0826Of2.A0a();
        }
        A04();
    }
    ...
    public final void A0S(AnonymousClass59 anonymousClass59) {
        ...
        MS.A0H(super.A07);
        AbstractC0826Of abstractC0826Of = this.A00;
        setUpFullscreenMode(abstractC0826Of != null && abstractC0826Of.A0c());
    }

    @Override // com.facebook.ads.redexgen.X.SQ
    public final boolean A0T() {
        AbstractC0826Of abstractC0826Of = this.A00;
        return abstractC0826Of != null && abstractC0826Of.A0d(this.A03);
    }
    ...
    public final void AC8(boolean z) {
        if (this.A0B.A0j() || this.A06 || this.A0B.getState() == EnumC0892Qt.A06 || this.A02 == null) {
            return;
        }
        if (!this.A04 || z) {
            QK qk = this.A0B;
    ...
    @VisibleForTesting
    public void setServerSideRewardHandler(C0864Pr c0864Pr) {
        this.A01 = c0864Pr;
    }
}
