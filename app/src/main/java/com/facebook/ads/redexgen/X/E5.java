...
public final class E5 implements XS {
    ...
    public E5(C1074Xx c1074Xx) {
        this.A01 = c1074Xx;
        this.A02 = new C04398d(c1074Xx);
    }
    ...
    private JSONArray A01(Cursor cursor) throws JSONException {
        ...
        while (cursor.moveToNext()) {
            ...
            jSONObject.put(A00(54, 2, 44), cursor.getString(C1073Xw.A04.A00));
            jSONObject.put(A00(82, 8, 53), cursor.getString(C1073Xw.A09.A00));
            jSONObject.put(A00(90, 4, 94), cursor.getString(C1073Xw.A0A.A00));
            jSONObject.put(A00(78, 4, 109), MJ.A02(cursor.getDouble(C1073Xw.A08.A00)));
            jSONObject.put(A00(66, 12, 6), MJ.A02(cursor.getDouble(C1073Xw.A07.A00)));
            jSONObject.put(A00(56, 10, 20), cursor.getString(C1073Xw.A06.A00));
            String string = cursor.getString(C1073Xw.A03.A00);
            jSONObject.put(A00(50, 4, 78), string != null ? new JSONObject(string) : new JSONObject());
            jSONObject.put(A00(43, 7, 26), cursor.getString(C1073Xw.A02.A00));
    ...
    public static JSONObject A03(Cursor cursor) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        while (cursor.moveToNext()) {
            String string = cursor.getString(C1072Xv.A02.A00);
            String string2 = cursor.getString(C1072Xv.A01.A00);
            String[] strArr = A04;
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC04639f
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC04649g
    public final void AFi(C0700Je c0700Je, AbstractC04619d<String> abstractC04619d) {
        this.A02.A0G(c0700Je.A08(), c0700Je.A05().A00, c0700Je.A06().toString(), c0700Je.A04(), c0700Je.A03(), c0700Je.A07(), c0700Je.A09(), abstractC04619d);
    }
}
