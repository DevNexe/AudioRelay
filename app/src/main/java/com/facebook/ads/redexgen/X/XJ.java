...
public final class XJ implements InterfaceC0670Ia {
    ...
    @Nullable
    public InterfaceC0670Ia A01;
    public final AJ A02;
    public final C0986Uk A03;
    ...
    public XJ(AJ aj, IN in) {
        this.A02 = aj;
        this.A03 = new C0986Uk(in);
    }

    private void A01() {
        this.A03.A02(this.A01.A7H());
        C0490Ah playbackParameters = this.A01.A7E();
    ...
    public final void A09(XG xg) throws AM {
        InterfaceC0670Ia interfaceC0670Ia;
        InterfaceC0670Ia interfaceC0670IaA6w = xg.A6w();
        if (interfaceC0670IaA6w != null && interfaceC0670IaA6w != (interfaceC0670Ia = this.A01)) {
            if (interfaceC0670Ia == null) {
                this.A01 = interfaceC0670IaA6w;
                this.A00 = xg;
    ...
    public final C0490Ah A7E() {
        InterfaceC0670Ia interfaceC0670Ia = this.A01;
        if (interfaceC0670Ia != null) {
            return interfaceC0670Ia.A7E();
        }
        return this.A03.A7E();
    }
    ...
    public final C0490Ah AEf(C0490Ah c0490Ah) {
        InterfaceC0670Ia interfaceC0670Ia = this.A01;
        if (interfaceC0670Ia != null) {
            c0490Ah = interfaceC0670Ia.AEf(c0490Ah);
        }
        this.A03.AEf(c0490Ah);
        this.A02.ABo(c0490Ah);
        return c0490Ah;
    }
}
