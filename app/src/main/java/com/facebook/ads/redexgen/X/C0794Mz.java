...
public final class C0794Mz extends RelativeLayout {
    ...
    public C0794Mz(C1075Xy c1075Xy, int i, int i2, String str, @Nullable String str2, String str3, String str4, Bitmap bitmap) {
        super(c1075Xy);
        this.A05 = new TextView(c1075Xy);
        this.A02 = new Button(c1075Xy);
        this.A01 = new Button(c1075Xy);
        this.A03 = new ImageView(c1075Xy);
        this.A04 = new LinearLayout(c1075Xy);
        if (!TextUtils.isEmpty(str2)) {
            this.A00 = new TextView(c1075Xy);
        }
