...
public class C1308cy implements AnonymousClass12 {
    ...
    public C1308cy(FO fo, Runnable runnable, long j, C9F c9f) {
        this.A04 = fo;
        this.A06 = runnable;
        this.A03 = j;
        this.A05 = c9f;
    ...
    public final void ABa(C1345da c1345da) {
        if (!this.A00) {
            this.A00 = true;
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass12
    public final void ABb(C1345da c1345da) {
        if (c1345da != this.A04.A00) {
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass12
    public final void ABc(C1345da c1345da) {
        if (!this.A01) {
            this.A01 = true;
            FO fo = this.A04;
            C9F c9f = this.A05;
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass12
    public final void ABe(C1345da c1345da, KH kh) {
        if (c1345da != this.A04.A00) {
            return;
        }
        this.A04.A0C().removeCallbacks(this.A06);
        this.A04.A0K(c1345da);
        if (!this.A02) {
            this.A02 = true;
