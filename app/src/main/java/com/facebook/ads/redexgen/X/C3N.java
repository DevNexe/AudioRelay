...
public class C3N {
    ...
    public void A03(ViewParent viewParent, View view) {
        if (viewParent instanceof InterfaceC03082r) {
    ...
    public boolean A07(ViewParent viewParent, View view, float f, float f2) {
        if (viewParent instanceof InterfaceC03082r) {
            return ((InterfaceC03082r) viewParent).onNestedPreFling(view, f, f2);
        }
        String[] strArr = A01;
    ...
    public boolean A08(ViewParent viewParent, View view, float f, float f2, boolean z) {
        if (viewParent instanceof InterfaceC03082r) {
            return ((InterfaceC03082r) viewParent).onNestedFling(view, f, f2, z);
        }
        return false;
    }
    ...
    public boolean A09(ViewParent viewParent, View view, View view2, int i) {
        if (viewParent instanceof InterfaceC03082r) {
            return ((InterfaceC03082r) viewParent).onStartNestedScroll(view, view2, i);
        }
        return false;
    }
}
