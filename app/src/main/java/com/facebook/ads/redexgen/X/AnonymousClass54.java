...
public final class AnonymousClass54 implements AdViewApi {
    ...
    public AnonymousClass54(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        ...
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            this.A0B = C0750Lf.A04(adSize);
            this.A0C = str;
            this.A09 = adViewParentApi;
            this.A08 = adView;
            this.A0A = C5G.A06(context);
            this.A0A.A0D().A2g(AdPlacementType.BANNER.toString(), str);
            C02811p c02811p = new C02811p(str, C0750Lf.A05(this.A0B), AdPlacementType.BANNER, C0750Lf.A04(adSize), 1);
            c02811p.A06(this.A05);
            c02811p.A07(this.A06);
            this.A03 = new FQ(this.A0A, c02811p);
            this.A03.A0M(new C1239bm(this));
            return;
        }
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        String str = this.A06;
        if (str != null && (c0855PiA01 = C0854Ph.A01(this.A0A, str)) != null) {
            ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
            relativeLayout.addView(c0855PiA01, new RelativeLayout.LayoutParams(layoutParams.width, layoutParams.height));
        }
    }
    ...
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        ...
        A03(((C0716Ju) adViewLoadConfig).A00());
    }
