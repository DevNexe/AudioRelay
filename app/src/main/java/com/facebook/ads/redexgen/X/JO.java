...
public class JO implements ServiceConnection {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        this.A00.A08(C04578z.A1q, new AnonymousClass90(A00(0, 17, 51)));
        this.A00.A01 = true;
        ...
        try {
            ...
            this.A00.A07(C04578z.A1p, new AnonymousClass90(e));
        }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        this.A00.A08(C04578z.A1r, new AnonymousClass90(A00(17, 20, 24)));
        try {
            this.A00.A03.unbindService(this);
