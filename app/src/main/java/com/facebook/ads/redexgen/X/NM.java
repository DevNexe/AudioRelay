...
public final class NM extends RelativeLayout {
    ...
    private View A00(NL nl) {
        ...
        imageView.setImageBitmap(C0770Mb.A01(nl.A01));
        ...
        if (nl.A09) {
            ...
            nr.setData(nl.A03, EnumC0769Ma.CHECKMARK);
            nr.setSelected(true);
    ...
    private View A01(NL nl) {
        ...
        if (nl.A0A) {
            ...
            imageView.setImageBitmap(C0770Mb.A01(EnumC0769Ma.CROSS));
    ...
    private View getFooterView() {
        ImageView imageView = new ImageView(getContext());
        imageView.setImageBitmap(C0770Mb.A01(EnumC0769Ma.SETTINGS));
