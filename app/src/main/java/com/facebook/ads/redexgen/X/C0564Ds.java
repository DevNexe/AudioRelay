...
@TargetApi(16)
public final class C0564Ds implements XH, InterfaceC0497Ao, InterfaceC0495Am {
    ...
    public final CopyOnWriteArraySet<InterfaceC0621Gb> A0K;
    ...
    public C0564Ds(InterfaceC0505Aw interfaceC0505Aw, HT ht, InterfaceC0484Ab interfaceC0484Ab, @Nullable CM<C1047Ww> cm) {
        this(interfaceC0505Aw, ht, interfaceC0484Ab, cm, new B2());
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.CM != com.facebook.ads.internal.exoplayer2.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.drm.FrameworkMediaCrypto> */
    public C0564Ds(InterfaceC0505Aw interfaceC0505Aw, HT ht, InterfaceC0484Ab interfaceC0484Ab, @Nullable CM<C1047Ww> cm, B2 b2) {
        this(interfaceC0505Aw, ht, interfaceC0484Ab, cm, b2, IN.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.CM != com.facebook.ads.internal.exoplayer2.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.drm.FrameworkMediaCrypto> */
    public C0564Ds(InterfaceC0505Aw interfaceC0505Aw, HT ht, InterfaceC0484Ab interfaceC0484Ab, @Nullable CM<C1047Ww> cm, B2 b2, IN in) {
        ...
        XF xf = this.A0G;
        this.A0N = interfaceC0505Aw.A4R(handler, xf, xf, xf, xf, cm);
        this.A00 = 1.0f;
        this.A01 = 0;
        this.A08 = BD.A04;
        this.A02 = 1;
        this.A0C = Collections.emptyList();
        this.A0F = A02(this.A0N, ht, interfaceC0484Ab, in);
        this.A0H = b2.A00(this.A0F, in);
        A3E(this.A0H);
        this.A0L.add(this.A0H);
        this.A0I.add(this.A0H);
        A0I(this.A0H);
        if (cm instanceof C1049Wy) {
            ((C1049Wy) cm).A04(this.A0E, this.A0H);
        }
    }

    private final XH A02(XG[] xgArr, HT ht, InterfaceC0484Ab interfaceC0484Ab, IN in) {
        return new E3(xgArr, ht, interfaceC0484Ab, in);
    }
    ...
    public final void A0P(InterfaceC0594Fa interfaceC0594Fa) {
        ADH(interfaceC0594Fa, true, true);
    }
    ...
    public final void ADH(InterfaceC0594Fa interfaceC0594Fa, boolean z, boolean z2) {
        InterfaceC0594Fa interfaceC0594Fa2 = this.A0B;
        if (interfaceC0594Fa2 != interfaceC0594Fa) {
            if (interfaceC0594Fa2 != null) {
                interfaceC0594Fa2.ADv(this.A0H);
                this.A0H.A07();
            }
            interfaceC0594Fa.A3C(this.A0E, this.A0H);
            this.A0B = interfaceC0594Fa;
        }
        this.A0F.ADH(interfaceC0594Fa, z, z2);
    }
    ...
    public final void ADm() {
        ...
        InterfaceC0594Fa interfaceC0594Fa = this.A0B;
        if (interfaceC0594Fa != null) {
            interfaceC0594Fa.ADv(this.A0H);
        }
        this.A0C = Collections.emptyList();
    }
