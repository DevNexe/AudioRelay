...
public final class C0672Ic {
    ...
    public static final ArrayList<C0671Ib> A02;
    ...
    /* JADX WARN: Code duplicated, block: B:45:0x00e2 A[ADDED_TO_REGION, ORIG_RETURN, RETURN] */
    /* JADX WARN: Code duplicated, block: B:47:0x00e4 A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:4:0x000d  */
    /* JADX WARN: Code duplicated, block: B:6:0x0010  */
    /* JADX WARN: Code duplicated, block: B:7:0x0012 A[ADDED_TO_REGION] */
    public static int A00(String str) {
        byte b;
        switch (str.hashCode()) {
            case -2123537834:
                if (str.equals(A04(350, 14, 97))) {
                    b = 2;
                } else {
                    b = -1;
                }
            ...
            case 187078296:
                ...
                String[] strArr = A01;
                strArr[6] = "0eXxISGGieMpdQ4uO0AxftUHijwpXHnB";
                strArr[4] = "g5XptsZXXNPOgmrh2BU7roq8hVemUiIo";
            ...
            case 1556697186:
                String[] strArr2 = A01;
                if (strArr2[0].charAt(29) != strArr2[5].charAt(29)) {
                    A01[2] = "OPE";
                    ...
                    A01[3] = "a1N7zF475xlkbKQc5myGLiKsj3F9Ls34";
                    if (str.equals(A04(399, 7, 74))) {
                        b = 5;
                    } else {
                        b = -1;
                    }
    ...
    public static int A02(String str) {
        ...
        for (int i = 0; i < size; i++) {
            C0671Ib c0671Ib = A02.get(i);
            if (str.equals(c0671Ib.A02)) {
                int i2 = c0671Ib.A00;
                if (A01[3].charAt(8) != '5') {
                    throw new RuntimeException();
                }
    ...
    public static String A05(@Nullable String str) {
        ...
        if (strTrim.startsWith(A04(453, 4, 90)) || strTrim.startsWith(A04(457, 4, 49))) {
            return A04(523, 9, 95);
        }
        boolean zStartsWith = strTrim.startsWith(A04(493, 4, 74));
        if (A01[3].charAt(8) != '5') {
            throw new RuntimeException();
        }
        A01[2] = "9aL";
        if (zStartsWith || strTrim.startsWith(A04(497, 4, 23))) {
            return A04(532, 10, 103);
        }
        if (strTrim.startsWith(A04(641, 3, 88)) || strTrim.startsWith(A04(634, 4, 102))) {
            return A04(605, 19, 78);
        }
        if (strTrim.startsWith(A04(638, 3, 33)) || strTrim.startsWith(A04(630, 4, 115))) {
            return A04(586, 19, 115);
        }
        if (strTrim.startsWith(A04(501, 4, 1))) {
            String objectTypeString = null;
            if (strTrim.startsWith(A04(505, 5, 63))) {
                String strSubstring = strTrim.substring(5);
                if (strSubstring.length() >= 2) {
                    try {
                        objectTypeString = A03(Integer.parseInt(C0695Iz.A0N(strSubstring.substring(0, 2)), 16));
        ...
        if (strTrim.startsWith(A04(19, 4, 38)) || strTrim.startsWith(A04(461, 4, 84))) {
            return A04(331, 9, 33);
        }
        if (strTrim.startsWith(A04(489, 4, 91)) || strTrim.startsWith(A04(465, 4, 79))) {
            return A04(340, 10, 12);
        }
        if (strTrim.startsWith(A04(485, 4, 68))) {
            return A04(350, 14, 97);
        }
        if (strTrim.startsWith(A04(469, 4, 99)) || strTrim.startsWith(A04(473, 4, 116))) {
            return A04(412, 13, 90);
        }
        if (A01[2].length() != 3) {
            A01[2] = "43U";
            if (!strTrim.startsWith(A04(477, 4, 8))) {
                if (!strTrim.startsWith(A04(481, 4, 90))) {
                    if (strTrim.startsWith(A04(510, 4, 37))) {
                        return A04(389, 10, 83);
                    }
                    if (strTrim.startsWith(A04(624, 6, 0))) {
