...
public class Configuration {
    ...
    private void setOptionalFields(JSONObject jSONObject, boolean z) {
        ...
        this._maximumConnectedEvents = jSONObject.optInt("mce", RCHTTPStatusCodes.ERROR);
    ...
    public Configuration(String str, IExperiments iExperiments) {
        this();
        this._configUrl = str;
        this._configurationRequestFactory = new ConfigurationRequestFactory(this, new DeviceInfoReaderBuilder(new ConfigurationReader(), PrivacyConfigStorage.getInstance()));
