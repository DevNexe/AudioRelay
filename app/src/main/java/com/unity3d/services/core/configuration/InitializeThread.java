...
public class InitializeThread extends Thread {
    ...
    public static class InitializeStateConfig extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            return (this._configuration.getExperiments() == null || !this._configuration.getExperiments().isTwoStageInitializationEnabled()) ? executeLegacy(this._configuration) : executeWithLoader();
        }
        ...
        public InitializeState executeWithLoader() {
            ...
            IConfigurationLoader configurationLoader = new ConfigurationLoader(new ConfigurationRequestFactory(this._configuration, new DeviceInfoReaderBuilder(new ConfigurationReader(), privacyConfigStorage)));
            if (this._configuration.getExperiments().isPrivacyRequestEnabled()) {
                configurationLoader = new PrivacyConfigurationLoader(configurationLoader, new ConfigurationRequestFactory(this._configuration, new DeviceInfoReaderPrivacyBuilder(new ConfigurationReader(), privacyConfigStorage)), privacyConfigStorage);
            }
