...
public class GMAInitializer {
    ...
    public boolean initSuccessful(Object obj) {
        ...
        if (obj2 != null) {
            if (this._adapterStatusBridge.isGMAInitialized(obj2)) {
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.GMA, t91.INIT_SUCCESS, new Object[0]);
                return true;
            }
            WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.GMA, t91.INIT_ERROR, new Object[0]);
        }
        return false;
    }
    ...
    public void initializeGMA() {
        if (isInitialized()) {
            this._gmaEventSender.send(t91.ALREADY_INITIALIZED, new Object[0]);
        } else {
