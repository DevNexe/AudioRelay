...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final Bt7j<String, Integer> y;
    public final Bundle w;
    public MediaMetadata x;

    public class QnHx implements Parcelable.Creator<MediaMetadataCompat> {
    ...
    static {
        Bt7j<String, Integer> bt7j = new Bt7j<>();
        y = bt7j;
        ...
        bt7j.put("android.media.metadata.BT_FOLDER_TYPE", 0);
        bt7j.put("android.media.metadata.MEDIA_URI", 1);
        bt7j.put("android.media.metadata.ADVERTISEMENT", 0);
        bt7j.put("android.media.metadata.DOWNLOAD_STATUS", 0);
        CREATOR = new QnHx();
    }
