...
public class MediaBrowserCompat$MediaItem implements Parcelable {
    public static final Parcelable.Creator<MediaBrowserCompat$MediaItem> CREATOR = new QnHx();
    public final int w;
    public final MediaDescriptionCompat x;

    public class QnHx implements Parcelable.Creator<MediaBrowserCompat$MediaItem> {
    ...
    public final String toString() {
        return "MediaItem{mFlags=" + this.w + ", mDescription=" + this.x + '}';
    }
