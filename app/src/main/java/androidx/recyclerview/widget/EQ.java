...
public final class EQ extends AnimatorListenerAdapter {
    ...
    public EQ(FJCM fjcm, FJCM.QnHx qnHx, ViewPropertyAnimator viewPropertyAnimator, View view) {
        this.z = fjcm;
        this.w = qnHx;
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        RecyclerView.qc qcVar = qnHx.b;
        FJCM fjcm = this.z;
        fjcm.c(qcVar);
        fjcm.r.remove(qnHx.b);
        fjcm.i();
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public final void onAnimationStart(Animator animator) {
        RecyclerView.qc qcVar = this.w.b;
        this.z.getClass();
    }
}
