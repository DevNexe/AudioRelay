...
public final class gy2 extends cx1 implements a91<sz1, Integer, g30, Integer, sd5> {
    ...
    public gy2(j70 j70Var, a91<? super iy2, ? super Integer, ? super g30, ? super Integer, sd5> a91Var, jy2 jy2Var, int i) {
        super(4);
        this.w = j70Var;
        this.x = a91Var;
        this.y = jy2Var;
    ...
    public final sd5 I(sz1 sz1Var, Integer num, g30 g30Var, Integer num2) {
        ...
        if ((i2 & 731) == 146 && g30Var2.t()) {
            ...
            e40.CQf cQf = e40.a;
            pg2 pg2VarL = gm4.l(sz1Var2.a(new c30(wo1.a, new nm2(this.w, null)), 1.0f), null, 3);
            g30Var2.e(733328855);
