...
public final class ux5 extends a16 {
    ...
    public ux5(zzau zzauVar, Context context, zzq zzqVar, String str, zzbvf zzbvfVar) {
        this.f = zzauVar;
        this.b = context;
        this.c = zzqVar;
        this.d = str;
    ...
    public final Object b(zzcc zzccVar) {
        return zzccVar.zze(new ObjectWrapper(this.b), this.c, this.d, this.e, ModuleDescriptor.MODULE_VERSION);
    }
