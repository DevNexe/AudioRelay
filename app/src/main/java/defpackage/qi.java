...
public final class qi extends cx1 implements x81<g30, Integer, sd5> {
    ...
    public qi(ay2 ay2Var, y81<? super wu3, ? super g30, ? super Integer, sd5> y81Var, int i) {
        super(2);
        this.w = ay2Var;
        this.x = y81Var;
        this.y = i;
    ...
    public final sd5 invoke(g30 g30Var, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && g30Var2.t()) {
            ...
            float f2 = oi.c;
            wo1.QnHx qnHx = wo1.a;
            pg2 pg2VarY = new ee5(f, f2).y(new cy2(this.w));
            CZ9P.CQf cQf = CZ9P.e;
            da.CQf cQf2 = One.QnHx.k;
            int i = ((this.y >> 18) & 7168) | 432;
            g30Var2.e(693286680);
            rb2 rb2VarA = uu3.a(cQf, cQf2, g30Var2);
