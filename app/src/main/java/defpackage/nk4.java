...
public final class nk4<K, V> {
    ...
    public final int a(int i, Object obj) {
        ...
        if (i2 < 0 || ur1.a(obj, this.b[i2 << 1])) {
            return i2;
        }
        int i7 = i2 + 1;
        while (i7 < i3 && this.a[i7] == i) {
            if (ur1.a(obj, this.b[i7 << 1])) {
                return i7;
            }
            i7++;
        }
        for (int i8 = i2 - 1; i8 >= 0 && this.a[i8] == i; i8--) {
            if (ur1.a(obj, this.b[i8 << 1])) {
                return i8;
            }
        }
        return ~i7;
    ...
    public final boolean equals(Object obj) {
        ...
        try {
            ...
            for (int i5 = 0; i5 < i4; i5++) {
                ...
                int iB = obj5 == null ? nk4Var.b() : nk4Var.a(obj5.hashCode(), obj5);
                Object obj7 = iB >= 0 ? nk4Var.b[(iB << 1) + 1] : null;
                if (obj6 == null) {
                    if (obj7 == null) {
                        if (!((obj5 == null ? nk4Var.b() : nk4Var.a(obj5.hashCode(), obj5)) >= 0)) {
                        }
                    }
                    return false;
                }
