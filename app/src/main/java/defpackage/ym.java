...
public final class ym implements pa3, ba, qf6 {
    public static ej1 E;
    public static final py4 w = new py4("RESUME_TOKEN");
    public static final py4 x = new py4("COMPLETING_ALREADY");
    public static final py4 y = new py4("COMPLETING_WAITING_CHILDREN");
    public static final py4 z = new py4("COMPLETING_RETRY");
    public static final py4 A = new py4("TOO_LATE_TO_CANCEL");
    public static final py4 B = new py4("SEALED");
    public static final rr0 C = new rr0(false);
    public static final rr0 D = new rr0(true);
    public static final ym F = new ym();
    public static final ym G = new ym();
    public static final /* synthetic */ ym H = new ym();
    public static final int[] I = {0, 3, 6, 9, 12, 16, 19, 22, 25, 28};
    public static final int[] J = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};
    public static final int[] K = {67108863, 33554431};
    public static final int[] L = {26, 25};

    public static final gi0 a(u7.QnHx qnHx) {
        String str = qnHx.a;
        if (str == null) {
            str = qnHx.c + "-vm";
        }
        ...
        po1<?, ?, ?> po1Var = qnHx.e;
        f(po1Var, "inputHandler");
        return new gi0(obj, eo1Var, null, arrayList, po1Var, qnHx.f, qnHx.g, qnHx.h, qnHx.i, str2, qnHx.j.invoke(str2));
    }

    public static EdgeEffect b(Context context) {
        return Build.VERSION.SDK_INT >= 31 ? JGd.a.a(context, null) : new EdgeEffect(context);
    }

    public static float c(EdgeEffect edgeEffect) {
        if (Build.VERSION.SDK_INT >= 31) {
            return JGd.a.b(edgeEffect);
        }
        return 0.0f;
    }

    public static final boolean d(fz1[] fz1VarArr, int i) {
        return fz1VarArr[i] != null;
    }

    public static void e(EdgeEffect edgeEffect, float f) {
        if (Build.VERSION.SDK_INT >= 31) {
            JGd.a.c(edgeEffect, f, 0.0f);
        } else {
    ...
    public static final void f(Object obj, String str) {
        if (obj == null) {
            throw new IllegalStateException(str.concat(" required").toString());
        }
    }

    public static final Object g(Object obj) {
        pj1 pj1Var;
        qj1 qj1Var = obj instanceof qj1 ? (qj1) obj : null;
        return (qj1Var == null || (pj1Var = qj1Var.a) == null) ? obj : pj1Var;
    }

    public static void h(u7.QnHx qnHx, Object obj, eo1 eo1Var, String str) {
        qnHx.b = obj;
        qnHx.c = eo1Var;
        qnHx.getClass();
        qnHx.a = str;
    ...
    public static void m(long[] jArr, long[] jArr2) {
        ...
        long j9 = j3 * jArr2[4];
        long j10 = jArr2[4];
        long j11 = (jArr2[5] * j2) + (j4 * j10) + (j6 * j8);
        long j12 = (jArr2[6] * j2) + (j6 * j10) + (j8 * j8);
        long j13 = jArr2[5];
        long j14 = ((j4 + j4) * j13) + j12;
        long j15 = jArr2[6];
        long j16 = (jArr2[7] * j2) + (j4 * j15) + (j6 * j13) + (j8 * j10);
        long j17 = jArr2[8];
        long j18 = jArr2[7];
        long j19 = (j8 * j13) + (j4 * j18);
        long j20 = j19 + j19 + (j17 * j2) + (j6 * j15);
        long j21 = jArr2[8];
        long j22 = (j2 * jArr2[9]) + (j4 * j21) + (j6 * j18) + (j8 * j15) + (j10 * j13);
        long j23 = jArr2[9];
        long j24 = (j4 * j23) + (j8 * j18);
        long j25 = j24 + j24 + (j6 * j21) + (j10 * j15) + (j13 * j13);
        long j26 = (j6 * j23) + (j8 * j21) + (j10 * j18) + (j13 * j15);
        long j27 = (j8 * j23) + (j13 * j18);
        long j28 = j27 + j27 + (j10 * j21);
        long j29 = (j10 * j23) + (j13 * j21) + (j15 * j18);
        long j30 = ((j13 + j13) * j23) + (j15 * j21) + (j18 * j18);
        long j31 = (j15 * j23) + (j18 * j21);
        long[] jArr3 = {j * j, jArr2[1] * j3, j5 + j5, j7 + j7, j9 + (j4 * 4 * j8) + (j6 * j6), j11 + j11, j14 + j14, j16 + j16, j20 + j20 + (j10 * j10), j22 + j22, j25 + j25, j26 + j26, j28 + j28 + (j15 * j15), j29 + j29, j30 + j30, j31 + j31, (j18 * 4 * j23) + (j21 * j21), (j21 + j21) * j23, (j23 + j23) * j23};
        l(jArr3);
        k(jArr3);
    ...
    public static byte[] p(long[] jArr) {
        ...
        while (true) {
            ...
            while (i9 < 9) {
                ...
                int i10 = i9 & 1;
                int i11 = iArr[i10];
                jArrCopyOf[i9] = ((long) iArr2[i10]) & j4;
                i9++;
        ...
        for (int i20 = 0; i20 < 10; i20++) {
            jArrCopyOf[i20] = jArrCopyOf[i20] << J[i20];
        }
    ...
    public Object zza() {
        List list = lg6.a;
        return Integer.valueOf((int) b67.x.zza().zzA());
    }
}
