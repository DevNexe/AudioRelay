...
public final class ux0 {
    ...
    public final pg3<sc1> b;
    public final jp3 c = new jp3();

    public ux0(Context context, pg3<sc1> pg3Var) {
        this.a = context;
        this.b = pg3Var;
    }
    ...
    public static void b(HttpURLConnection httpURLConnection, String str, String str2, String str3) {
        ...
        objArr[0] = str2;
        objArr[1] = str3;
        objArr[2] = TextUtils.isEmpty(str) ? "" : b70.a(", ", str);
    ...
    public static long d(String str) {
        oa3.a("Invalid Expiration Timestamp.", d.matcher(str).matches());
    ...
    public static r3 e(HttpURLConnection httpURLConnection) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (strNextName.equals(MediationMetaData.KEY_NAME)) {
                ...
                i4Var = new i4(strNextString, lValueOf.longValue(), 0);
        ...
        jsonReader.close();
        inputStream.close();
        return new r3(strNextString2, strNextString3, strNextString4, i4Var, 1);
    }

    public static i4 f(HttpURLConnection httpURLConnection) throws IOException {
        InputStream inputStream = httpURLConnection.getInputStream();
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, e));
        Long lValueOf = 0L;
        jsonReader.beginObject();
        ...
        String str = lValueOf == null ? " tokenExpirationTimestamp" : "";
        if (str.isEmpty()) {
            return new i4(strNextString, lValueOf.longValue(), 1);
        }
        throw new IllegalStateException("Missing required properties:".concat(str));
    }
    ...
    public final HttpURLConnection c(URL url, String str) {
        ...
        try {
            ...
            sc1 sc1Var = this.b.get();
            if (sc1Var != null) {
                try {
                    httpURLConnection.addRequestProperty("x-firebase-client", (String) k15.a(sc1Var.a()));
