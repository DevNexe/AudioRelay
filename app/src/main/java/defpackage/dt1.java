...
@za4(with = et1.class)
public final class dt1 extends vt1 implements List<vt1>, jv1, j$.util.List {
    public static final QnHx Companion = new QnHx();
    public final List<vt1> w;

    public static final class QnHx {
        public final rv1<dt1> serializer() {
            return et1.a;
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public dt1(List<? extends vt1> list) {
        this.w = list;
    }
    ...
    @Override // java.util.List, j$.util.List
    public final boolean addAll(int i, Collection<? extends vt1> collection) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    @Override // java.util.List, java.util.Collection, j$.util.List, j$.util.Collection
    public final boolean addAll(Collection<? extends vt1> collection) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean contains(Object obj) {
        ...
        return this.w.contains((vt1) obj);
    }
    ...
    public final Iterator<vt1> iterator() {
    ...
    public final int lastIndexOf(Object obj) {
        ...
        return this.w.lastIndexOf((vt1) obj);
    }

    @Override // java.util.List, j$.util.List
    public final ListIterator<vt1> listIterator() {
        return this.w.listIterator();
    }

    @Override // java.util.List, j$.util.List
    public final ListIterator<vt1> listIterator(int i) {
    ...
    public final void replaceAll(UnaryOperator<vt1> unaryOperator) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    @Override // java.util.List
    public final /* synthetic */ void replaceAll(java.util.function.UnaryOperator<vt1> unaryOperator) {
    ...
    @Override // java.util.List, j$.util.List
    public final void sort(Comparator<? super vt1> comparator) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    @Override // java.util.List, j$.util.List
    public final List<vt1> subList(int i, int i2) {
