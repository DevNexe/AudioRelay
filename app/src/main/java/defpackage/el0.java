...
public final class el0 extends lPt3Fixed implements roZB {
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final mw0t build() {
            ...
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(el0VarF);
        }
    ...
    public enum F1 implements SjP.QnHx {
        USER_REQUESTED(0),
        NEED_PREMIUM_FOR_MULTI(1),
        NEED_PREMIUM_FOR_UNLIMITED_DURATION(2),
        UNRECOGNIZED(-1);
    ...
    public class QnHx extends com.google.protobuf.F1<el0> {
                ...
                try {
                    try {
                        try {
                            ...
                            invalidProtocolBufferExceptionA.w = el0Var;
                            throw invalidProtocolBufferExceptionA;
                        }
                    } catch (IOException e3) {
                        InvalidProtocolBufferException invalidProtocolBufferException = new InvalidProtocolBufferException(e3);
                        invalidProtocolBufferException.w = el0Var;
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((u40.a(tb5.e, 779, 37, 1, 53) + this.z) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
    ...
    public final int j() {
        ...
        int iJ = this.y.j() + (this.z != F1.USER_REQUESTED.b() ? 0 + CodedOutputStream.Z0(1, this.z) : 0);
        this.x = iJ;
        return iJ;
    }
