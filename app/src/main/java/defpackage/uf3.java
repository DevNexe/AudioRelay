...
public final class uf3 extends lPt3Fixed implements roZB {
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final void R(uf3 uf3Var) {
            if (uf3Var == uf3.C) {
                return;
            }
            boolean z = uf3Var.z;
        ...
        public final mw0t build() {
            ...
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(uf3VarF);
        }
    ...
    public class QnHx extends F1<uf3> {
                ...
                try {
                    try {
                        try {
                            ...
                            invalidProtocolBufferExceptionA.w = uf3Var;
                            throw invalidProtocolBufferExceptionA;
                        } catch (IOException e2) {
                            InvalidProtocolBufferException invalidProtocolBufferException = new InvalidProtocolBufferException(e2);
                            invalidProtocolBufferException.w = uf3Var;
    ...
    public final boolean equals(Object obj) {
        ...
        uf3 uf3Var = (uf3) obj;
        return this.z == uf3Var.z && this.A == uf3Var.A && this.y.equals(uf3Var.y);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((((((SjP.a(this.z) + u40.a(wb5.A, 779, 37, 1, 53)) * 37) + 2) * 53) + this.A) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
