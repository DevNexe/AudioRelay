...
public final class vt6 extends ys6 implements RandomAccess, ou6 {
    public float[] x;
    public int y;

    static {
        new vt6(0, new float[0]).zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        collection.getClass();
        if (!(collection instanceof vt6)) {
            return super.addAll(collection);
        }
        vt6 vt6Var = (vt6) collection;
        int i = vt6Var.y;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(vt6Var.x, 0, this.x, this.y, vt6Var.y);
        this.y = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final /* bridge */ /* synthetic */ zzgow zzd(int i) {
        ...
        return new vt6(this.y, Arrays.copyOf(this.x, i));
    }

    public vt6(int i, float[] fArr) {
        this.x = fArr;
        this.y = i;
    }
