...
public final class m65 {
    ...
    public static void a(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, Th.W, i, i2);
    ...
    public static void c(Context context, int[] iArr, String str) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            if (!typedArrayObtainStyledAttributes.hasValue(i)) {
                typedArrayObtainStyledAttributes.recycle();
                if (z) {
                    throw new IllegalArgumentException(fc2.a("The style on this component requires your app theme to be ", str, " (or a descendant)."));
                }
            }
        }
        typedArrayObtainStyledAttributes.recycle();
