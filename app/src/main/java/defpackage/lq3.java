...
public final class lq3 extends lPt3Fixed implements roZB {
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final lPt3Fixed.YKK I() {
            lPt3Fixed.YKK ykk = wb5.r;
            ykk.c(lq3.class, CQf.class);
            return ykk;
        }
        ...
        public final void R(lq3 lq3Var) {
            if (lq3Var == lq3.B) {
                return;
            }
            boolean z = lq3Var.z;
        ...
        public final mw0t build() {
            ...
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(lq3VarF);
        }
    ...
    public class QnHx extends F1<lq3> {
                ...
                try {
                    try {
                        try {
                            ...
                            invalidProtocolBufferExceptionA.w = lq3Var;
                            throw invalidProtocolBufferExceptionA;
                        }
                    } catch (IOException e3) {
                        InvalidProtocolBufferException invalidProtocolBufferException = new InvalidProtocolBufferException(e3);
                        invalidProtocolBufferException.w = lq3Var;
    ...
    public final boolean equals(Object obj) {
        ...
        lq3 lq3Var = (lq3) obj;
        return this.z == lq3Var.z && this.y.equals(lq3Var.y);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((SjP.a(this.z) + u40.a(wb5.q, 779, 37, 1, 53)) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
