...
public final class lo5 extends ko5 {
    public static Method D;

    public lo5(Drawable drawable) {
        super(drawable);
        if (D == null) {
            try {
    ...
    @Override // defpackage.ko5, android.graphics.drawable.Drawable
    ...
    public lo5(mo5 mo5Var, Resources resources) {
        super(mo5Var, resources);
        if (D == null) {
            try {
                D = Drawable.class.getDeclaredMethod("isProjected", new Class[0]);
            } catch (Exception e) {
