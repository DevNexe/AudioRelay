...
@if0(c = "androidx.compose.material.DefaultButtonElevation$elevation$1", f = "Button.kt", l = {506}, m = "invokeSuspend")
public final class dg0 extends px4 implements x81<ua0, z80<? super sd5>, Object> {
    public int A;
    ...
    public dg0(wp1 wp1Var, wp4<vp1> wp4Var, z80<? super dg0> z80Var) {
        super(2, z80Var);
        this.B = wp1Var;
        this.C = wp4Var;
    }
    ...
    public final z80<sd5> a(Object obj, z80<?> z80Var) {
        return new dg0(this.B, this.C, z80Var);
    }
    ...
    public final Object invoke(ua0 ua0Var, z80<? super sd5> z80Var) {
        return ((dg0) a(ua0Var, z80Var)).i(sd5.a);
    }
}
