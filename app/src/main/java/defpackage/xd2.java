...
public final class xd2 extends lPt3Fixed implements roZB {
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final lPt3Fixed.YKK I() {
            lPt3Fixed.YKK ykk = wb5.p;
            ykk.c(xd2.class, CQf.class);
            return ykk;
        }
        ...
        public final mw0t build() {
            ...
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(xd2VarF);
        }
    ...
    public class QnHx extends F1<xd2> {
                ...
                try {
                    try {
                        try {
                            ...
                            invalidProtocolBufferExceptionA.w = xd2Var;
                            throw invalidProtocolBufferExceptionA;
                        }
                    } catch (IOException e3) {
                        InvalidProtocolBufferException invalidProtocolBufferException = new InvalidProtocolBufferException(e3);
                        invalidProtocolBufferException.w = xd2Var;
    ...
    public final boolean equals(Object obj) {
        ...
        xd2 xd2Var = (xd2) obj;
        return this.z == xd2Var.z && this.y.equals(xd2Var.y);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((SjP.a(this.z) + u40.a(wb5.o, 779, 37, 1, 53)) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
