...
public final class yf3 extends lPt3Fixed implements roZB {
    public static final yf3 D = new yf3();
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final void R(yf3 yf3Var) {
            if (yf3Var == yf3.D) {
                return;
            }
            int i = yf3Var.z;
        ...
        public final mw0t build() {
            ...
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(yf3VarF);
        }
    ...
    public class QnHx extends F1<yf3> {
    ...
    public final boolean equals(Object obj) {
        ...
        yf3 yf3Var = (yf3) obj;
        return this.z == yf3Var.z && this.A == yf3Var.A && this.B == yf3Var.B && this.y.equals(yf3Var.y);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((((((((((u40.a(tb5.M, 779, 37, 1, 53) + this.z) * 37) + 2) * 53) + this.A) * 37) + 3) * 53) + this.B) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
