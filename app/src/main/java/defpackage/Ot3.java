...
public final class Ot3 extends cx1 implements x81<g30, Integer, sd5> {
    public final /* synthetic */ y81<wu3, g30, Integer, sd5> w;
    public final /* synthetic */ int x;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public Ot3(y81<? super wu3, ? super g30, ? super Integer, sd5> y81Var, int i) {
        super(2);
        this.w = y81Var;
        this.x = i;
    }
    ...
    public final sd5 invoke(g30 g30Var, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && g30Var2.t()) {
            ...
            int i = (this.x & 7168) | 438;
            g30Var2.e(693286680);
            rb2 rb2VarA = uu3.a(f1, cQf, g30Var2);
            ...
            if (((i2 >> 9) & 14 & 11) == 2 && g30Var2.t()) {
                ...
                this.w.invoke(xu3.a, g30Var2, Integer.valueOf(((i >> 6) & 112) | 6));
            }
            ex0.d(g30Var2);
        }
        return sd5.a;
