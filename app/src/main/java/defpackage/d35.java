...
public final class d35 extends cx1 implements x81<g30, Integer, sd5> {
    public final /* synthetic */ ri2<cm4> w;
    ...
    public d35(ri2<cm4> ri2Var, ay2 ay2Var, x81<? super g30, ? super Integer, sd5> x81Var, int i) {
        super(2);
        this.w = ri2Var;
        this.x = ay2Var;
        this.y = x81Var;
    ...
    public final sd5 invoke(g30 g30Var, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && g30Var2.t()) {
            ...
            wo1.QnHx qnHx = wo1.a;
            ly1 ly1Var = new ly1("border");
            long j = this.w.getValue().a;
            float f = iw2.a;
            pg2 pg2VarY = ly1Var.y(new so0(new jw2(j, this.x)));
            g30Var2.e(733328855);
            rb2 rb2VarC = fe.c(One.QnHx.a, true, g30Var2);
            ...
            g30Var2.e(1029492925);
            x81<g30, Integer, sd5> x81Var = this.y;
            if (x81Var != null) {
                x81Var.invoke(g30Var2, Integer.valueOf((this.z >> 12) & 14));
            }
            g30Var2.G();
            g30Var2.G();
            g30Var2.G();
