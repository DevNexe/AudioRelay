...
public final class lc6 implements zzctv {
    public final zzcdu a;

    public lc6(zzcdu zzcduVar) {
        this.a = zzcduVar;
    }
    ...
    public final void zza(JSONObject jSONObject) {
        this.a.zzb(jSONObject.optBoolean("npa_reset") ? -1 : jSONObject.optBoolean("npa"), jSONObject.optLong("timestamp"));
    }
}
