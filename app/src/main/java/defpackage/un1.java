...
public final class un1 extends InputConnectionWrapper {
    public final /* synthetic */ vn1 a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public un1(InputConnection inputConnection, sn1 sn1Var) {
            ...
            try {
                ...
                try {
                    ...
                    if (uri != null && clipDescription != null) {
                        zA = ((sn1) vn1Var).a(new bo1(uri, clipDescription, uri2), i, bundle2);
                    }
