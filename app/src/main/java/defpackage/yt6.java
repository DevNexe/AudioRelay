...
public final class yt6 extends ys6 implements RandomAccess, zzgos, ou6 {
    public static final yt6 z;
    public int[] x;
    public int y;

    static {
        yt6 yt6Var = new yt6(new int[0], 0);
        z = yt6Var;
        yt6Var.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        collection.getClass();
        if (!(collection instanceof yt6)) {
            return super.addAll(collection);
        }
        yt6 yt6Var = (yt6) collection;
        int i = yt6Var.y;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(yt6Var.x, 0, this.x, this.y, yt6Var.y);
        this.y = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final zzgos zzd(int i) {
        if (i >= this.y) {
            return new yt6(Arrays.copyOf(this.x, i), this.y);
        }
