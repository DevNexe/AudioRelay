...
public final class sf3 extends lPt3Fixed implements roZB {
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final lPt3Fixed.YKK I() {
            lPt3Fixed.YKK ykk = wb5.t;
            ykk.c(sf3.class, CQf.class);
            return ykk;
        }
        ...
        public final mw0t build() {
            ...
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(sf3VarF);
        }
    ...
    public class QnHx extends F1<sf3> {
                ...
                try {
                    try {
                        try {
                            ...
                            invalidProtocolBufferExceptionA.w = sf3Var;
                            throw invalidProtocolBufferExceptionA;
                        }
                    } catch (IOException e3) {
                        InvalidProtocolBufferException invalidProtocolBufferException = new InvalidProtocolBufferException(e3);
                        invalidProtocolBufferException.w = sf3Var;
    ...
    public final boolean equals(Object obj) {
        ...
        sf3 sf3Var = (sf3) obj;
        return this.z == sf3Var.z && this.y.equals(sf3Var.y);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((SjP.a(this.z) + u40.a(wb5.s, 779, 37, 1, 53)) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
