...
public final class xt4 extends lPt3Fixed implements roZB {
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final void R(xt4 xt4Var) {
            if (xt4Var == xt4.B) {
                return;
            }
            if (!xt4Var.S().isEmpty()) {
        ...
        public final mw0t build() {
            ...
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(xt4VarF);
        }
    ...
    public class QnHx extends F1<xt4> {
                ...
                try {
                    try {
                        try {
                            ...
                            invalidProtocolBufferExceptionA.w = xt4Var;
                            throw invalidProtocolBufferExceptionA;
                        }
                    } catch (IOException e3) {
                        InvalidProtocolBufferException invalidProtocolBufferException = new InvalidProtocolBufferException(e3);
                        invalidProtocolBufferException.w = xt4Var;
    ...
    public final boolean equals(Object obj) {
        ...
        xt4 xt4Var = (xt4) obj;
        return S().equals(xt4Var.S()) && this.y.equals(xt4Var.y);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((S().hashCode() + u40.a(tb5.C, 779, 37, 1, 53)) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
