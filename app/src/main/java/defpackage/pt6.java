...
public final class pt6 extends ys6 implements RandomAccess, ou6 {
    public double[] x;
    public int y;

    static {
        new pt6(new double[0], 0).zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        collection.getClass();
        if (!(collection instanceof pt6)) {
            return super.addAll(collection);
        }
        pt6 pt6Var = (pt6) collection;
        int i = pt6Var.y;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(pt6Var.x, 0, this.x, this.y, pt6Var.y);
        this.y = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final int hashCode() {
        int iZzc = 1;
        for (int i = 0; i < this.y; i++) {
            iZzc = (iZzc * 31) + zzgox.zzc(Double.doubleToLongBits(this.x[i]));
        }
        return iZzc;
    }
    ...
    public final /* bridge */ /* synthetic */ zzgow zzd(int i) {
        if (i >= this.y) {
            return new pt6(Arrays.copyOf(this.x, i), this.y);
        }
        throw new IllegalArgumentException();
    }

    public pt6(double[] dArr, int i) {
        this.x = dArr;
        this.y = i;
    }
