...
public final class op4<K, V> extends np4<K, V, V> {
    public op4(yp4<K, V> yp4Var) {
        super(yp4Var);
    }
    ...
    public final boolean containsAll(Collection<? extends Object> collection) {
        ...
        while (it.hasNext()) {
            if (!this.w.containsValue(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public final Iterator iterator() {
        ...
        return new vs4(yp4Var, ((mj1) yp4Var.c().c.entrySet()).iterator());
    }
    ...
    public final boolean removeAll(Collection<? extends Object> collection) {
        ...
        do {
            ...
            while (true) {
                ...
                if (setH1.contains(entry.getValue())) {
