...
@if0(c = "androidx.compose.foundation.selection.ToggleableKt$toggleableImpl$1$gestures$1", f = "Toggleable.kt", l = {270}, m = "invokeSuspend")
public final class m85 extends px4 implements x81<l93, z80<? super sd5>, Object> {
    public int A;
    ...
    @if0(c = "androidx.compose.foundation.selection.ToggleableKt$toggleableImpl$1$gestures$1$1", f = "Toggleable.kt", l = {273}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public m85(boolean z, ci2 ci2Var, ri2<qd3> ri2Var, is4<? extends h81<Boolean>> is4Var, is4<? extends h81<sd5>> is4Var2, z80<? super m85> z80Var) {
        super(2, z80Var);
        this.C = z;
        this.D = ci2Var;
        this.E = ri2Var;
    ...
    public final z80<sd5> a(Object obj, z80<?> z80Var) {
        m85 m85Var = new m85(this.C, this.D, this.E, this.F, this.G, z80Var);
        m85Var.B = obj;
        return m85Var;
    }
    ...
    public final Object invoke(l93 l93Var, z80<? super sd5> z80Var) {
        return ((m85) a(l93Var, z80Var)).i(sd5.a);
    }
}
