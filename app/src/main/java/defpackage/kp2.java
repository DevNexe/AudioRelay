...
public final class kp2 extends lPt3Fixed implements roZB {
    ...
    public static final class CQf extends lPt3Fixed.CQf<CQf> implements roZB {
        ...
        public final mw0t build() {
            kp2 kp2VarF = f();
            if (kp2VarF.isInitialized()) {
                return kp2VarF;
            }
            throw com.google.protobuf.QnHx.AbstractC0099QnHx.C(kp2VarF);
        }
    ...
    public class QnHx extends F1<kp2> {
                ...
                try {
                    try {
                        try {
                            ...
                            invalidProtocolBufferExceptionA.w = kp2Var;
                            throw invalidProtocolBufferExceptionA;
                        }
                    } catch (IOException e3) {
                        InvalidProtocolBufferException invalidProtocolBufferException = new InvalidProtocolBufferException(e3);
                        invalidProtocolBufferException.w = kp2Var;
    ...
    public final boolean equals(Object obj) {
        ...
        kp2 kp2Var = (kp2) obj;
        return this.z == kp2Var.z && this.y.equals(kp2Var.y);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = this.y.hashCode() + ((SjP.b(this.z) + u40.a(tb5.A, 779, 37, 1, 53)) * 29);
        this.w = iHashCode;
        return iHashCode;
    }
